...
// node_modules/@storybook/components/dist/formatter-GCLXO5IP.mjs
    ...
    var xe = (e, r) => () => (r || e((r = { exports: {} }).exports, r), r.exports), pt = xe((t0, pu) => {
      ...
      var FD = Object.create, _r = Object.defineProperty, AD = Object.getOwnPropertyDescriptor, Gn = Object.getOwnPropertyNames, SD = Object.getPrototypeOf, xD = Object.prototype.hasOwnProperty, ht = (e, r) => function() {
        ...
        r.prototype = { diff: function(n, u) {
          ...
          function w() {
            for (var S = -1 * c; S <= c; S += 2) {
              var N = void 0, I = E[S - 1], P = E[S + 1], $ = (P ? P.newPos : 0) - S;
              I && (E[S - 1] = void 0);
              var f = I && I.newPos + 1 < y, T = P && 0 <= $ && $ < g;
              if (!f && !T) {
                E[S] = void 0;
                continue;
              }
              if (!f || T && I.newPos < P.newPos ? (N = s(P), p.pushComponent(N.components, void 0, true)) : (N = I, N.newPos++, p.pushComponent(N.components, true, void 0)), $ = p.extractCommon(N, u, n, S), N.newPos + 1 >= y && $ + 1 >= g)
        ...
        var D = { type: "line-suffix-boundary" }, E = { type: "break-parent" }, _ = { type: "trim" }, w = { type: "line", hard: true }, F = { type: "line", hard: true, literal: true }, S = { type: "line" }, N = { type: "line", soft: true }, I = t([w, E]), P = t([F, E]), $ = { type: "cursor", placeholder: Symbol("cursor") };
        function f(v, o) {
          let h = [];
        ...
        function T(v, o, h) {
          let C = v;
          if (o > 0) {
            for (let x = 0; x < Math.floor(o / h); ++x)
              C = s(C);
        ...
        r.exports = { concat: t, join: f, line: S, softline: N, hardline: I, literalline: P, group: n, conditionalGroup: p, fill: d, lineSuffix: c, lineSuffixBoundary: D, cursor: $, breakParent: E, ifBreak: y, trim: _, indent: s, indentIfBreak: g, align: a, addAlignmentToDoc: T, markAsRoot: i, dedentToRoot: u, dedent: l, hardlineWithoutBreakParent: w, literallineWithoutBreakParent: F, label: m };
      ...
      var La, jD = ht({ "node_modules/string-width/index.js"() {
        ...
        function p(o, h) {
          ...
          function b(B) {
            ...
            if (B.type === "if-break") {
              let k = B.breakContents && x(B.breakContents), M = B.flatContents && x(B.flatContents);
              return h(Object.assign(Object.assign({}, B), {}, { breakContents: k, flatContents: M }));
            }
            if (B.type === "group" && B.expandedStates) {
              let k = B.expandedStates.map(x), M = k[0];
        ...
        function D(o) {
          ...
          function x(B) {
            if (B.type === "break-parent" && c(C), B.type === "group") {
              if (C.push(B), h.has(B))
                return false;
              h.add(B);
            }
        ...
        function N(o) {
          ...
          for (let C of u(o)) {
            if (!C)
              continue;
            let [x, ...b] = n(C) ? u(C) : [C];
            typeof x == "string" && typeof t(h) == "string" ? h[h.length - 1] += x : h.push(x), h.push(...b);
          }
        ...
        function P(o) {
          ...
          for (; C.length > 0; ) {
            ...
            if (x) {
              ...
              if (h.length > 0 && typeof t(h) == "string" && typeof x == "string") {
                h[h.length - 1] += x;
                continue;
              }
              h.push(x);
...
`)).parts;
        ...
        r.exports = { isConcat: n, getDocParts: u, willBreak: g, traverseDoc: l, findInDoc: d, mapDoc: p, propagateBreaks: D, removeLines: _, stripTrailingHardline: S, normalizeParts: P, normalizeDoc: $, cleanDoc: I, replaceTextEndOfLine: T, replaceEndOfLine: f, canBreak: v };
        ...
        function _(N, I, P) {
          let $ = I.type === "dedent" ? N.queue.slice(0, -1) : [...N.queue, I], f = "", T = 0, m = 0, v = 0;
          for (let k of $)
            switch (k.type) {
              case "indent":
          ...
          return b(), Object.assign(Object.assign({}, N), {}, { value: f, length: T, queue: $ });
          function o(k) {
            f += "	".repeat(k), T += P.tabWidth * k;
          }
          function h(k) {
            f += " ".repeat(k), T += k;
          }
            ...
            if (typeof h == "string")
              ...
              switch (h.type) {
                ...
                case "group": {
                  if (f && h.break)
                    return false;
                  let C = h.break ? y : o, x = h.expandedStates && C === y ? s(h.expandedStates) : h.contents;
                  m.push({ mode: C, doc: x });
                  break;
                }
                case "if-break": {
                  let x = (h.groupId ? d[h.groupId] || g : o) === y ? h.breakContents : h.flatContents;
                  x && m.push({ mode: o, doc: x });
                  break;
                }
                case "line":
                  if (o === y || h.hard)
        ...
        function S(N, I) {
          d = {};
          let P = I.printWidth, $ = t(I.endOfLine), f = 0, T = [{ ind: c(), mode: y, doc: N }], m = [], v = false, o = [];
          for (; T.length > 0; ) {
            let { ind: C, mode: x, doc: b } = T.pop();
            if (typeof b == "string") {
              let B = $ !== `
` ? b.replace(/\n/g, $) : b;
              m.push(B), f += a(B);
              ...
              switch (b.type) {
                case "cursor":
                  ...
                  break;
                case "indent":
                  T.push({ ind: D(C, I), mode: x, doc: b.contents });
                  break;
                case "align":
                  T.push({ ind: E(C, b.n, I), mode: x, doc: b.contents });
                  break;
                case "trim":
                  f -= w(m);
                  break;
                case "group":
                  switch (x) {
                    case g:
                      if (!v) {
                        T.push({ ind: C, mode: b.break ? y : g, doc: b.contents });
                        break;
                      }
                    case y: {
                      v = false;
                      let B = { ind: C, mode: g, doc: b.contents }, k = P - f, M = o.length > 0;
                      if (!b.break && F(B, T, k, M))
                        T.push(B);
                      else if (b.expandedStates) {
                        let R = s(b.expandedStates);
                        if (b.break) {
                          T.push({ ind: C, mode: y, doc: R });
                          break;
                        } else
                        ...
                        T.push({ ind: C, mode: y, doc: b.contents });
                      break;
                    }
                  }
                ...
                case "fill": {
                  ...
                  if (k.length === 0)
                    break;
                  let [M, R] = k, q = { ind: C, mode: g, doc: M }, J = { ind: C, mode: y, doc: M }, L = F(q, [], B, o.length > 0, true);
                  if (k.length === 1) {
                    L ? T.push(q) : T.push(J);
                    break;
                  }
                  let Q = { ind: C, mode: g, doc: R }, V = { ind: C, mode: y, doc: R };
                  if (k.length === 2) {
                    L ? T.push(Q, q) : T.push(V, J);
                    break;
                  }
                  k.splice(0, 2);
                  let j = { ind: C, mode: x, doc: n(k) }, Y = k[0];
                  F({ ind: C, mode: g, doc: [M, R, Y] }, [], B, o.length > 0, true) ? T.push(j, Q, q) : L ? T.push(j, V, q) : T.push(j, V, J);
                  break;
                }
                case "if-break":
                case "indent-if-break": {
                  let B = b.groupId ? d[b.groupId] : x;
                  if (B === y) {
                    let k = b.type === "if-break" ? b.breakContents : b.negate ? b.contents : i(b.contents);
                    k && T.push({ ind: C, mode: x, doc: k });
                  }
                  if (B === g) {
                ...
                case "line-suffix":
                  o.push({ ind: C, mode: x, doc: b.contents });
                  break;
                case "line-suffix-boundary":
                  o.length > 0 && T.push({ ind: C, mode: x, doc: { type: "line", hard: true } });
                  break;
                case "line":
                  switch (x) {
                    case g:
                    ...
                    case y:
                      if (o.length > 0) {
                        T.push({ ind: C, mode: x, doc: b }, ...o.reverse()), o.length = 0;
                        break;
                      }
                      b.literal ? C.root ? (m.push($, C.root.value), f = C.root.length) : (m.push($), f = 0) : (f -= w(m), m.push($ + C.value), f = C.length);
                      break;
                  }
                  break;
                case "label":
                  T.push({ ind: C, mode: x, doc: b.contents });
                  break;
                default:
              }
          ...
          if (h !== -1) {
            let C = m.indexOf(u.placeholder, h + 1), x = m.slice(0, h).join(""), b = m.slice(h + 1, C).join(""), B = m.slice(C + 1).join("");
            return { formatted: x + b + B, cursorNodeStart: x.length, cursorNodeText: b };
          }
          return { formatted: m.join("") };
        }
        r.exports = { printDocToString: S };
      ...
      var $D = ht({ "node_modules/escape-string-regexp/index.js"() {
        ...
        var n = Object.prototype.hasOwnProperty, u = function(F, S) {
          return n.call(F, S);
        };
        function i(F, S) {
          for (var N in S)
        ...
        function c(F, S, N) {
          ...
          var $ = "(\\r\\n|\\r|\\n).{0," + I + "}", f = new RegExp($, "g");
          S && (F = F.slice(1));
          var T = N.newline, m = N.trimLeadingNewline, v = N.trimTrailingNewline, o = typeof T == "string", h = F.length, C = F.map(function(x, b) {
            return x = x.replace(f, "$1"), b === 0 && m && (x = x.replace(l, "")), b === h - 1 && v && (x = x.replace(p, "")), o && (x = x.replace(/\r\n|\n|\r/g, function(B) {
              return T;
            })), x;
          });
          return C;
        ...
        function _(F) {
          ...
          function I($) {
            for (var f = [], T = 1; T < arguments.length; T++)
              f[T - 1] = arguments[T];
            if (E($)) {
              var m = $, v = (f[0] === I || f[0] === w) && g.test(m[0]) && d.test(m[1]), o = v ? N : S, h = o.get(m);
    ...
    `, cliCategory: u }, tabWidth: { type: "int", category: l, default: 2, description: "Number of spaces per indentation level.", range: { start: 0, end: Number.POSITIVE_INFINITY, step: 1 } }, useTabs: { since: "1.0.0", category: l, type: "boolean", default: false, description: "Indent with tabs instead of spaces." }, embeddedLanguageFormatting: { since: "2.1.0", category: l, type: "choice", default: [{ since: "2.1.0", value: "auto" }], description: "Control how Prettier formats quoted code embedded in the file.", choices: [{ value: "auto", description: "Format embedded code if Prettier can automatically identify it." }, { value: "off", description: "Never automatically format embedded code." }] } };
        ...
        function u() {
          let { plugins: l = [], showUnreleased: p = false, showDeprecated: d = false, showInternal: y = false } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, g = a.split("-", 1)[0], c = l.flatMap((F) => F.languages || []).filter(E), D = s(Object.assign({}, ...l.map((F) => {
            let { options: S } = F;
            return S;
          }), n), "name").filter((F) => E(F) && _(F)).sort((F, S) => F.name === S.name ? 0 : F.name < S.name ? -1 : 1).map(w).map((F) => {
            ...
            let S = Object.fromEntries(l.filter((N) => N.defaultOptions && N.defaultOptions[F.name] !== void 0).map((N) => [N.name, N.defaultOptions[F.name]]));
            return Object.assign(Object.assign({}, F), {}, { pluginDefaults: S });
          });
          return { languages: c, options: D };
          function E(F) {
          ...
          function w(F) {
            if (y)
              return F;
            let { cliName: S, cliCategory: N, cliDescription: I } = F;
            return Hn(F, hD);
          }
        }
        function i(l, p, d) {
...
`);
        ...
        function v(V, j) {
          let Y = { quote: '"', regex: /"/g, escaped: "&quot;" }, ie = { quote: "'", regex: /'/g, escaped: "&apos;" }, ee = j === "'" ? ie : Y, le = ee === ie ? Y : ie, W = ee;
          if (V.includes(ee.quote) || V.includes(le.quote)) {
            let K = (V.match(ee.regex) || []).length, de = (V.match(le.regex) || []).length;
            W = K > de ? le : ee;
          }
          return W;
        }
        function o(V, j) {
          let Y = V.slice(1, -1), ie = j.parser === "json" || j.parser === "json5" && j.quoteProps === "preserve" && !j.singleQuote ? '"' : j.__isInHtmlAttribute ? "'" : v(Y, j.singleQuote ? "'" : '"').quote;
          return h(Y, ie, !(j.parser === "css" || j.parser === "less" || j.parser === "scss" || j.__embeddedInHtml));
        }
        function h(V, j, Y) {
          let ie = j === '"' ? "'" : '"', ee = /\\(.)|(["'])/gs, le = V.replace(ee, (W, K, de) => K === ie ? K : de === j ? "\\" + de : de || (Y && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(K) ? K : "\\" + K));
          return j + le + j;
        }
        function C(V) {
          return V.toLowerCase().replace(/^([+-]?[\d.]+e)(?:\+|(-))?0*(\d)/, "$1$2$3").replace(/^([+-]?[\d.]+)e[+-]?0+$/, "$1").replace(/^([+-])?\./, "$10.").replace(/(\.\d+?)0+(?=e|$)/, "$1").replace(/\.(?=e|$)/, "");
      ...
      var Br, Nr, Et = ht({ "node_modules/tslib/tslib.es6.js"() {
        ...
        var s = class {
          ...
          _applyNormalization(a, n) {
            ...
            for (let p of i) {
              ...
              let c = (w) => {
                let { from: F, to: S } = w;
                u.push(typeof S == "string" ? { [S]: F } : { [S.key]: S.value });
              }, D = (w) => {
                let { value: F, redirectTo: S } = w, N = t.normalizeDeprecatedResult(d.deprecated(F, this._utils), y, true);
                if (N !== false)
                  if (N === true)
                    this._hasDeprecationWarned(p) || this._utils.logger.warn(this._deprecatedHandler(p, S, this._utils));
                  else
                    for (let { value: I } of N) {
                      let P = { key: p, value: I };
                      if (!this._hasDeprecationWarned(P)) {
                        let $ = typeof S == "string" ? { key: S, value: I } : S;
          ...
          return class extends t.ChoiceSchema {
            ...
            preprocess(_, w) {
              if (typeof _ == "string" && _.length > 0 && !this._flags.includes(_)) {
                let F = this._flags.find((S) => D(S, _) < 3);
                if (F)
        ...
        function i(g, c) {
          let { logger: D = false, isCLI: E = false, passThrough: _ = false, colorsModule: w = null, levenshteinDistance: F = null } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, S = _ ? Array.isArray(_) ? (T, m) => _.includes(T) ? { [T]: m } : void 0 : (T, m) => ({ [T]: m }) : (T, m, v) => {
            let o = v.schemas, { _: h } = o, C = Hn(o, vD);
            return t.levenUnknownHandler(T, m, Object.assign(Object.assign({}, v), {}, { schemas: C }));
          }, N = E ? a : t.apiDescriptor, I = l(c, { isCLI: E, colorsModule: w, levenshteinDistance: F }), P = new t.Normalizer(I, { logger: D, unknown: S, descriptor: N }), $ = D !== false;
          $ && u && (P._hasDeprecationWarned = u);
          let f = P.normalize(g);
          return $ && (u = P._hasDeprecationWarned), E && f["plugin-search"] === false && (f["plugin-search-dir"] = false), f;
        }
        function l(g, c) {
        ...
        function p(g, c) {
          ...
          switch (g.type) {
            case "int":
              N = t.IntegerSchema, D && (S.preprocess = Number);
              break;
            case "string":
              N = t.StringSchema;
              break;
            case "choice":
              N = t.ChoiceSchema, S.choices = g.choices.map((P) => typeof P == "object" && P.redirect ? Object.assign(Object.assign({}, P), {}, { redirect: { to: { key: g.name, value: P.redirect } } }) : P);
              break;
            case "boolean":
              N = t.BooleanSchema;
              break;
            case "flag":
              N = n({ colorsModule: _, levenshteinDistance: w }), S.flags = E.flatMap((P) => [P.alias, P.description && P.name, P.oppositeDescription && `no-${P.name}`].filter(Boolean));
              break;
            case "path":
              N = t.StringSchema;
              break;
          ...
          if (g.exception ? S.validate = (P, $, f) => g.exception(P) || $.validate(P, f) : S.validate = (P, $, f) => P === void 0 || $.validate(P, f), g.redirect && (I.redirect = (P) => P ? { to: { key: g.redirect.option, value: g.redirect.value } } : void 0), g.deprecated && (I.deprecated = true), D && !g.array) {
            let P = S.preprocess || (($) => $);
            S.preprocess = ($, f, T) => f.preprocess(P(Array.isArray($) ? s($) : $), T);
          }
          return g.array ? t.ArraySchema.create(Object.assign(Object.assign(Object.assign({}, D ? { preprocess: (P) => Array.isArray(P) ? P : [P] } : {}), I), {}, { valueSchema: N.create(S) })) : N.create(Object.assign(Object.assign({}, S), I));
        }
        function d(g, c, D) {
          return i(g, c, D);
        }
        ...
        var a = /\r\n|[\n\r\u2028\u2029]/;
        function n(l, p, d) {
          let y = Object.assign({ column: 0, line: -1 }, l.start), g = Object.assign({}, y, l.end), { linesAbove: c = 2, linesBelow: D = 3 } = d || {}, E = y.line, _ = y.column, w = g.line, F = g.column, S = Math.max(E - (c + 1), 0), N = Math.min(p.length, w + D);
          E === -1 && (S = 0), w === -1 && (N = p.length);
          let I = w - E, P = {};
          if (I)
            for (let $ = 0; $ <= I; $++) {
              let f = $ + E;
          ...
          return { start: S, end: N, markerLines: P };
        }
        function u(l, p) {
          let d = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, y = (d.highlightCode || d.forceColor) && (0, r.shouldHighlight)(d), g = (0, r.getChalk)(d), c = s(g), D = ($, f) => y ? $(f) : f, E = l.split(a), { start: _, end: w, markerLines: F } = n(p, E, d), S = p.start && typeof p.start.column == "number", N = String(w).length, P = (y ? (0, r.default)(l, d) : l).split(a, w).slice(_, w).map(($, f) => {
            let T = _ + 1 + f, v = ` ${` ${T}`.slice(-N)} |`, o = F[T], h = !F[T + 1];
            if (o) {
              let C = "";
              if (Array.isArray(o)) {
                let x = $.slice(0, Math.max(o[0] - 1, 0)).replace(/[^\t]/g, " "), b = o[1] || 1;
                C = [`
 `, D(c.gutter, v.replace(/\d/g, " ")), " ", x, D(c.marker, "^").repeat(b)].join(""), h && d.message && (C += " " + D(c.message, d.message));
              }
              return [D(c.marker, ">"), D(c.gutter, v), $.length > 0 ? ` ${$}` : "", C].join("");
            } else
              return ` ${D(c.gutter, v)}${$.length > 0 ? ` ${$}` : ""}`;
          }).join(`
`);
...
${P}`), y ? g.reset(P) : P;
        ...
        function y(g, c) {
          ...
          try {
            ...
            let { loc: F } = w;
            if (F) {
              let { codeFrameColumns: S } = Mm();
              throw w.codeFrame = S(g, F, { highlightCode: true }), w.message += `
` + w.codeFrame, w;
            }
            throw w;
          }
        ...
        function l(y) {
          ...
          let F = Object.fromEntries(D.filter((N) => N.pluginDefaults && N.pluginDefaults[w.name] !== void 0).map((N) => [N.name, N.pluginDefaults[w.name]])), S = Object.assign(Object.assign({}, E), F);
        ...
        "use strict";
        ne();
        var t = Zt(), { builders: { line: s, hardline: a, breakParent: n, indent: u, lineSuffix: i, join: l, cursor: p } } = qe(), { hasNewline: d, skipNewline: y, skipSpaces: g, isPreviousLineEmpty: c, addLeadingComment: D, addDanglingComment: E, addTrailingComment: _ } = Ue(), w = /* @__PURE__ */ new WeakMap();
        function F(k, M, R) {
          if (!k)
            return;
        ...
        function S(k, M, R, q) {
          let { locStart: J, locEnd: L } = R, Q = J(M), V = L(M), j = F(k, R), Y, ie, ee = 0, le = j.length;
          for (; ee < le; ) {
            let W = ee + le >> 1, K = j[W], de = J(K), ue = L(K);
            if (de <= Q && V <= ue)
              return S(K, M, R, K);
            if (ue <= Q) {
              Y = K, ee = W + 1;
          ...
          if (q && q.type === "TemplateLiteral") {
            let { quasis: W } = q, K = v(W, M, R);
            Y && v(W, Y, R) !== K && (Y = null), ie && v(W, ie, R) !== K && (ie = null);
          }
        ...
        function I(k, M, R, q) {
          if (!Array.isArray(k))
            return;
          let J = [], { locStart: L, locEnd: Q, printer: { handleComments: V = {} } } = q, { avoidAstMutation: j, ownLine: Y = N, endOfLine: ie = N, remaining: ee = N } = V, le = k.map((W, K) => Object.assign(Object.assign({}, S(M, W, q)), {}, { comment: W, text: R, options: q, ast: M, isLastComment: k.length - 1 === K }));
          for (let [W, K] of le.entries()) {
            let { comment: de, precedingNode: ue, enclosingNode: Fe, followingNode: z, text: U, options: Z, ast: se, isLastComment: De } = K;
            ...
            let ge;
            if (j ? ge = [K] : (de.enclosingNode = Fe, de.precedingNode = ue, de.followingNode = z, ge = [de, U, Z, se, De]), $(U, Z, le, W))
              de.placement = "ownLine", Y(...ge) || (z ? D(z, de) : ue ? _(ue, de) : E(Fe || se, de));
            else if (f(U, Z, le, W))
              de.placement = "endOfLine", ie(...ge) || (ue ? _(ue, de) : z ? D(z, de) : E(Fe || se, de));
            else if (de.placement = "remaining", !ee(...ge))
              if (ue && z) {
                let he = J.length;
                he > 0 && J[he - 1].followingNode !== z && T(J, U, Z), J.push(K);
              } else
                ue ? _(ue, de) : z ? D(z, de) : E(Fe || se, de);
          }
          if (T(J, R, q), !j)
            for (let W of k)
        ...
        function T(k, M, R) {
          ...
          for (Y = q; Y > 0; --Y) {
            let { comment: ie, precedingNode: ee, followingNode: le } = k[Y - 1];
            t.strictEqual(ee, J), t.strictEqual(le, L);
          ...
          for (let [ie, { comment: ee }] of k.entries())
            ie < Y ? _(J, ee) : D(L, ee);
          for (let ie of [J, L])
            ie.comments && ie.comments.length > 1 && ie.comments.sort((ee, le) => R.locStart(ee) - R.locStart(le));
          k.length = 0;
        }
        function m(k, M) {
          let R = k.getValue();
        ...
        function o(k, M) {
          ...
          if (J.isBlockComment && J.isBlockComment(R)) {
            let ie = d(L, V(R)) ? d(L, Q(R), { backwards: true }) ? a : s : " ";
            q.push(ie);
          } else
            q.push(a);
          let Y = y(L, g(L, V(R)));
        ...
        function x(k, M, R) {
          ...
          return k.each(() => {
            ...
            Y ? Q.push(o(k, M)) : ie && V.push(h(k, M));
          }, "comments"), L && (Q.unshift(p), V.push(p)), { leading: Q, trailing: V };
        }
        function b(k, M, R, q) {
          let { leading: J, trailing: L } = x(k, R, q);
          return !J && !L ? M : [J, M, L];
        }
        function B(k) {
          if (k)
        ...
        r.exports = { attach: I, printComments: b, printCommentsSeparately: x, printDanglingComments: C, getSortedChildNodes: F, ensureAllCommentsPrinted: B };
        ...
        function l(y, g) {
          ...
          function F(N, I) {
            return N === void 0 || N === _ ? S(I) : Array.isArray(N) ? _.call(() => S(I), ...N) : _.call(() => S(I), N);
          }
          function S(N) {
        ...
        function p(y, g) {
          let { originalText: c, [Symbol.for("comments")]: D, locStart: E, locEnd: _ } = g, w = E(y), F = _(y), S = /* @__PURE__ */ new Set();
          for (let N of D)
            E(N) >= w && _(N) <= F && (N.printed = true, S.add(N));
          return { doc: c.slice(w, F), printedComments: S };
        }
        function d(y, g, c, D) {
        ...
        function i(D, E, _) {
          let { locStart: w, locEnd: F } = _, S = D.node, N = E.node;
          if (S === N)
            return { startNode: S, endNode: N };
          let I = w(D.node);
          for (let $ of u(E.parentNodes))
            if (w($) >= I)
              N = $;
            else
              break;
        ...
        function l(D, E, _, w) {
          let F = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [], S = arguments.length > 5 ? arguments[5] : void 0, { locStart: N, locEnd: I } = _, P = N(D), $ = I(D);
          if (!(E > $ || E < P || S === "rangeEnd" && E === P || S === "rangeStart" && E === $)) {
            for (let f of s.getSortedChildNodes(D, _)) {
              let T = l(f, E, _, w, [D, ...F], S);
              if (T)
                return T;
            }
            if (!w || w(D, F[0]))
        ...
        function c(D, E, _) {
          let { rangeStart: w, rangeEnd: F, locStart: S, locEnd: N } = E;
          t.ok(F > w);
          let I = D.slice(w, F).search(/\S/), P = I === -1;
          if (!P)
            for (w += I; F > w && !/\S/.test(D[F - 1]); --F)
              ;
          let $ = l(_, w, E, (v, o) => g(E, v, o), [], "rangeStart"), f = P ? $ : l(_, F, E, (v) => g(E, v), [], "rangeEnd");
          if (!$ || !f)
          ...
          if (a(E)) {
            ...
            ({ startNode: T, endNode: m } = i($, f, E));
          return { rangeStart: Math.min(S(T), S(m)), rangeEnd: Math.max(N(T), N(m)) };
        }
        r.exports = { calculateRange: c, findNodeAtOffset: l };
      } }), Gm = te({ "src/main/core.js"(e, r) {
        "use strict";
        ne();
        var { diffArrays: t } = BD(), { printer: { printDocToString: s }, debug: { printDocToDebug: a } } = qe(), { getAlignmentSize: n } = Ue(), { guessEndOfLine: u, convertEndOfLineToChars: i, countEndOfLineChars: l, normalizeEndOfLine: p } = Jn(), d = uo().normalize, y = Rm(), g = et(), c = tu(), D = Wm(), E = Hm(), _ = "\uFEFF", w = Symbol("cursor");
        function F(m, v, o) {
          let h = v.comments;
        ...
        function S(m, v) {
          ...
          let x = F(C, h, v), b = D(h, v, o), B = s(b, v);
          if (g.ensureAllCommentsPrinted(x), o > 0) {
            let k = B.formatted.trim();
            B.cursorNodeStart !== void 0 && (B.cursorNodeStart -= B.formatted.indexOf(k)), B.formatted = k + i(v.endOfLine);
          }
          if (v.cursorOffset >= 0) {
            let k, M, R, q, J;
            if (v.cursorNode && B.cursorNodeText ? (k = v.locStart(v.cursorNode), M = C.slice(k, v.locEnd(v.cursorNode)), R = v.cursorOffset - k, q = B.cursorNodeStart, J = B.cursorNodeText) : (k = 0, M = C, R = v.cursorOffset, q = 0, J = B.formatted), M === J)
              return { formatted: B.formatted, cursorOffset: q + R, comments: x };
            let L = [...M];
            L.splice(R, 0, w);
            let Q = [...J], V = t(L, Q), j = q;
            for (let Y of V)
              if (Y.removed) {
                ...
                j += Y.count;
            return { formatted: B.formatted, cursorOffset: j, comments: x };
          }
          return { formatted: B.formatted, cursorOffset: -1, comments: x };
        }
        function N(m, v) {
          let { ast: o, text: h } = c.parse(m, v), { rangeStart: C, rangeEnd: x } = E.calculateRange(h, v, o), b = h.slice(C, x), B = Math.min(C, h.lastIndexOf(`
`, C) + 1), k = h.slice(B, C).match(/^\s*/)[0], M = n(k, v.tabWidth), R = S(b, Object.assign(Object.assign({}, v), {}, { rangeStart: 0, rangeEnd: Number.POSITIVE_INFINITY, cursorOffset: v.cursorOffset > C && v.cursorOffset <= x ? v.cursorOffset - C : -1, endOfLine: "lf" }), M), q = R.formatted.trimEnd(), { cursorOffset: J } = v;
          J > x ? J += q.length - b.length : R.cursorOffset >= 0 && (J = R.cursorOffset + C);
          let L = h.slice(0, C) + q + h.slice(x);
          if (v.endOfLine !== "lf") {
            let Q = i(v.endOfLine);
            J >= 0 && Q === `\r
` && (J += l(L.slice(0, J), `
`)), L = L.replace(/\n/g, Q);
        ...
        function $(m, v) {
          let { cursorOffset: o, rangeStart: h, rangeEnd: C, endOfLine: x } = P(m, v), b = m.charAt(0) === _;
          if (b && (m = m.slice(1), o--, h--, C--), x === "auto" && (x = u(m)), m.includes("\r")) {
            let B = (k) => l(m.slice(0, Math.max(k, 0)), `\r
`);
            o -= B(o), h -= B(h), C -= B(C), m = p(m);
          }
          return { hasBOM: b, text: m, options: P(m, Object.assign(Object.assign({}, v), {}, { cursorOffset: o, rangeStart: h, rangeEnd: C, endOfLine: x })) };
        }
        function f(m, v) {
        ...
        function T(m, v) {
          let { hasBOM: o, text: h, options: C } = $(m, d(v));
          if (C.rangeStart >= C.rangeEnd && h !== "" || C.requirePragma && !f(h, C))
            return { formatted: m, cursorOffset: v.cursorOffset, comments: [] };
          let x;
          return C.rangeStart > 0 || C.rangeEnd < h.length ? x = N(h, C) : (!C.requirePragma && C.insertPragma && C.printer.insertPragma && !f(h, C) && (h = C.printer.insertPragma(h)), x = S(h, C)), o && (x.formatted = _ + x.formatted, x.cursorOffset >= 0 && x.cursorOffset++), x;
        }
        r.exports = { formatWithCursor: T, parse(m, v, o) {
          let { text: h, options: C } = $(m, d(v)), x = c.parse(h, C);
          return o && (x.ast = y(x.ast, C)), x;
        }, formatAST(m, v) {
          v = d(v);
          let o = D(m, v);
          return s(o, v);
        }, formatDoc(m, v) {
          return T(a(m), Object.assign(Object.assign({}, v), {}, { parser: "__js_expression" })).formatted;
        }, printToDoc(m, v) {
          v = d(v);
        ...
        "use strict";
        ne();
        var { getMaxContinuousCount: t, getStringWidth: s, getAlignmentSize: a, getIndentSize: n, skip: u, skipWhitespace: i, skipSpaces: l, skipNewline: p, skipToLineEnd: d, skipEverythingButNewLine: y, skipInlineComment: g, skipTrailingComment: c, hasNewline: D, hasNewlineInRange: E, hasSpaces: _, isNextLineEmpty: w, isNextLineEmptyAfterIndex: F, isPreviousLineEmpty: S, getNextNonSpaceNonCommentCharacterIndex: N, makeString: I, addLeadingComment: P, addDanglingComment: $, addTrailingComment: f } = Ue();
        r.exports = { getMaxContinuousCount: t, getStringWidth: s, getAlignmentSize: a, getIndentSize: n, skip: u, skipWhitespace: i, skipSpaces: l, skipNewline: p, skipToLineEnd: d, skipEverythingButNewLine: y, skipInlineComment: g, skipTrailingComment: c, hasNewline: D, hasNewlineInRange: E, hasSpaces: _, isNextLineEmpty: w, isNextLineEmptyAfterIndex: F, isPreviousLineEmpty: S, getNextNonSpaceNonCommentCharacterIndex: N, makeString: I, addLeadingComment: P, addDanglingComment: $, addTrailingComment: f };
        ...
        ne(), function() {
          ...
          function c(F) {
            ...
            var S = String.fromCharCode(Math.floor((F - 65536) / 1024) + 55296), N = String.fromCharCode((F - 65536) % 1024 + 56320);
            return S + N;
          }
        ...
        ne(), function() {
          ...
          function y(D) {
            ...
            if (D.length === 0)
              return false;
            for (S = t.isIdentifierStartES6, E = 0, _ = D.length; E < _; ++E) {
      ...
      } }), Ot = te({ "src/language-js/utils/is-block-comment.js"(e, r) {
        "use strict";
        ne();
        ...
        function S(O, me) {
          if (!O || typeof O != "object")
            return false;
          if (Array.isArray(O))
            return O.some((He) => S(He, me));
          let _e = me(O);
          return typeof _e == "boolean" ? _e : Object.values(O).some((He) => S(He, me));
        }
        function N(O) {
        ...
        var f = $(["Line", "CommentLine", "SingleLine", "HashbangComment", "HTMLOpen", "HTMLClose"]), T = $(["ExportDefaultDeclaration", "ExportDefaultSpecifier", "DeclareExportDeclaration", "ExportNamedDeclaration", "ExportAllDeclaration"]);
        function m(O) {
          let me = O.getParentNode();
          return O.getName() === "declaration" && T(me) ? me : null;
        }
        var v = $(["BooleanLiteral", "DirectiveLiteral", "Literal", "NullLiteral", "NumericLiteral", "BigIntLiteral", "DecimalLiteral", "RegExpLiteral", "StringLiteral", "TemplateLiteral", "TSTypeLiteral", "JSXText"]);
        function o(O) {
        ...
        var x = $(["ObjectTypeAnnotation", "TSTypeLiteral", "TSMappedType"]), b = $(["FunctionExpression", "ArrowFunctionExpression"]);
        function B(O) {
        ...
        function U(O, me) {
          let _e = p(me), He = n(O, d(me));
          return He !== false && O.slice(_e, _e + 2) === "/*" && O.slice(He, He + 2) === "*/";
        }
        function Z(O, me) {
          return M(me) ? Oe(me) : Me(me, Te.Leading, (_e) => a(O, d(_e)));
        }
        function se(O, me) {
          return me.parser !== "json" && C(O.key) && oe(O.key).slice(1, -1) === O.key.value && (t(O.key.value) && !(me.parser === "babel-ts" && O.type === "ClassProperty" || me.parser === "typescript" && O.type === "PropertyDefinition") || De(O.key.value) && String(Number(O.key.value)) === O.key.value && (me.parser === "babel" || me.parser === "acorn" || me.parser === "espree" || me.parser === "meriyah" || me.parser === "__babel_estree"));
        }
        function De(O) {
          return /^(?:\d+|\d+\.\d+)$/.test(O);
        }
...
`)) && O.expressions.every(_e);
        ...
        function pe(O, me) {
          switch (O.type) {
            ...
            case "OptionalMemberExpression":
              return pe(O.object, me);
            case "TaggedTemplateExpression":
              return O.tag.type === "FunctionExpression" ? false : pe(O.tag, me);
            case "CallExpression":
            case "OptionalCallExpression":
              return O.callee.type === "FunctionExpression" ? false : pe(O.callee, me);
            case "ConditionalExpression":
              return pe(O.test, me);
            case "UpdateExpression":
              return !O.prefix && pe(O.argument, me);
            case "BindExpression":
              return O.object && pe(O.object, me);
            case "SequenceExpression":
              return pe(O.expressions[0], me);
            case "TSSatisfiesExpression":
            case "TSAsExpression":
            case "TSNonNullExpression":
              return pe(O.expression, me);
            default:
              return me(O);
          }
        }
        var Ae = { "==": true, "!=": true, "===": true, "!==": true }, Ce = { "*": true, "/": true, "%": true }, fe = { ">>": true, ">>>": true, "<<": true };
        function A(O, me) {
          return !(re(me) !== re(O) || O === "**" || Ae[O] && Ae[me] || me === "%" && Ce[O] || O === "%" && Ce[me] || me !== O && Ce[me] && Ce[O] || fe[O] && fe[me]);
        }
        ...
        var Te = { Leading: 1 << 1, Trailing: 1 << 2, Dangling: 1 << 3, Block: 1 << 4, Line: 1 << 5, PrettierIgnore: 1 << 6, First: 1 << 7, Last: 1 << 8 }, je = (O, me) => {
          if (typeof O == "function" && (me = O, O = 0), O || me)
            return (_e, He, Ge) => !(O & Te.Leading && !_e.leading || O & Te.Trailing && !_e.trailing || O & Te.Dangling && (_e.leading || _e.trailing) || O & Te.Block && !g(_e) || O & Te.Line && !f(_e) || O & Te.First && He !== 0 || O & Te.Last && He !== Ge.length - 1 || O & Te.PrettierIgnore && !Ie(_e) || me && !me(_e));
        };
        function Me(O, me, _e) {
        ...
        function I(v, o, h) {
          ...
          let B = [], k = v.map(o, b), M = w(C);
          return M && (k = k.map((R) => c(R, Object.assign(Object.assign({}, h), {}, { printWidth: Number.POSITIVE_INFINITY })).formatted)), B.push(y, "`"), v.each((R) => {
            let q = R.getName();
            if (B.push(o()), q < k.length) {
              let { tabWidth: J } = h, L = R.getValue(), Q = a(L.value.raw, J), V = k[q];
              if (!M) {
                let Y = C[b][q];
                (F(Y) || S(Y) || Y.type === "ConditionalExpression" || Y.type === "SequenceExpression" || N(Y) || E(Y)) && (V = [p([i, V]), i]);
              }
...
`) ? d(Number.NEGATIVE_INFINITY, V) : g(V, Q, J);
        ...
        function P(v, o, h) {
          let C = v.getNode(), x = C.quasis[0].value.raw.trim().split(/\s*\|\s*/);
          if (x.length > 1 || x.some((b) => b.length > 0)) {
            o.__inJestEach = true;
            let b = v.map(h, "expressions");
...
`) && (Q.hasLineBreak = true), C.quasis[L].value.raw.includes(`
`) && M.push({ hasLineBreak: false, cells: [] });
            }
            let R = Math.max(x.length, ...M.map((L) => L.cells.length)), q = Array.from({ length: R }).fill(0), J = [{ cells: x }, ...M.filter((L) => L.cells.length > 0)];
            for (let { cells: L } of J.filter((Q) => !Q.hasLineBreak))
              for (let [Q, V] of L.entries())
                q[Q] = Math.max(q[Q], s(V));
            return B.push(y, "`", p([u, n(u, J.map((L) => n(" | ", L.cells.map((Q, V) => L.hasLineBreak ? Q : Q + " ".repeat(q[V] - s(Q))))))]), u, "`"), B;
          }
        }
        function $(v, o) {
        ...
        function f(v, o) {
          return v.map((h) => $(h, o), "expressions");
        }
        function T(v, o) {
        ...
        r.exports = { printTemplateLiteral: I, printTemplateExpressions: f, escapeTemplateCharacters: T, uncookTemplateElementValue: m };
        ...
        function d(c, D, E) {
          let _ = c.getValue(), w = _.quasis.map((P) => P.value.raw), F = 0, S = w.reduce((P, $, f) => f === 0 ? $ : P + "@prettier-placeholder-" + F++ + "-id" + $, ""), N = E(S, { parser: "scss" }, { stripTrailingHardline: true }), I = p(c, D);
          return y(N, _, I);
        }
        function y(c, D, E) {
        ...
        function g(c, D) {
          if (!t(D))
            return c;
          let E = 0, _ = u(l(c), (w) => typeof w != "string" || !w.includes("@prettier-placeholder") ? w : w.split(/@prettier-placeholder-(\d+)-id/).map((F, S) => S % 2 === 0 ? i(F) : (E++, D[F])));
        ...
        function i(p, d, y) {
          ...
          let D = u(p, d), E = [];
          for (let _ = 0; _ < c; _++) {
            let w = g.quasis[_], F = _ === 0, S = _ === c - 1, N = w.value.cooked, I = N.split(`
`), P = I.length, $ = D[_], f = P > 2 && I[0].trim() === "" && I[1].trim() === "", T = P > 2 && I[P - 1].trim() === "" && I[P - 2].trim() === "", m = I.every((o) => /^\s*(?:#[^\n\r]*)?$/.test(o));
            if (!S && /#[^\n\r]*$/.test(I[P - 1]))
              return null;
            let v = null;
            m ? v = l(I) : v = y(N, { parser: "graphql" }, { stripTrailingHardline: true }), v ? (v = n(v, false), !F && f && E.push(""), E.push(v), !S && T && E.push("")) : !F && !S && f && E.push(""), $ && E.push($);
          }
          return ["`", t([a, s(a, E)]), a, "`"];
        }
        function l(p) {
        ...
        function d(y, g, c, D, E) {
          ...
          p = p + 1 >>> 0;
          let S = (h) => `PRETTIER_HTML_PLACEHOLDER_${h}_${F}_IN_JS`, N = w.quasis.map((h, C, x) => C === x.length - 1 ? h.value.cooked : h.value.cooked + S(C)).join(""), I = i(y, g);
          if (I.length === 0 && N.trim().length === 0)
            return "``";
          let P = new RegExp(S("(\\d+)"), "g"), $ = 0, f = c(N, { parser: _, __onHtmlRoot(h) {
            $ = h.children.length;
          } }, { stripTrailingHardline: true }), T = u(f, (h) => {
            if (typeof h != "string")
              return h;
            let C = [], x = h.split(P);
            for (let b = 0; b < x.length; b++) {
              let B = x[b];
              if (b % 2 === 0) {
                B && (B = l(B), D.__embeddedInHtml && (B = B.replace(/<\/(script)\b/gi, "<\\/$1")), C.push(B));
                continue;
              }
              let k = Number(B);
              C.push(I[k]);
          ...
          return n(o ? ["`", t([o, n(T)]), o, "`"] : ["`", m, $ > 1 ? t(n(T)) : n(T), v, "`"]);
        }
        r.exports = d;
        ...
        function d(f, T, m, v) {
          ...
          if (h) {
            ...
            if (h === "graphql")
              return i(f, T, m);
            if (h === "html" || h === "angular")
              return l(f, T, m, v, { parser: h });
          }
        }
        function y(f) {
          let T = f.getValue(), m = f.getParentNode();
          return m && m.type === "TaggedTemplateExpression" && T.quasis.length === 1 && m.tag.type === "Identifier" && (m.tag.name === "md" || m.tag.name === "markdown");
        }
        function g(f) {
          let T = f.getValue(), m = f.getParentNode(), v = f.getParentNode(1);
          return v && T.quasis && m.type === "JSXExpressionContainer" && v.type === "JSXElement" && v.openingElement.name.name === "style" && v.openingElement.attributes.some((o) => o.name.name === "jsx") || m && m.type === "TaggedTemplateExpression" && m.tag.type === "Identifier" && m.tag.name === "css" || m && m.type === "TaggedTemplateExpression" && m.tag.type === "MemberExpression" && m.tag.object.name === "css" && (m.tag.property.name === "global" || m.tag.property.name === "resolve");
        }
        function c(f) {
          return f.match((T) => T.type === "TemplateLiteral", (T, m) => T.type === "ArrayExpression" && m === "elements", (T, m) => a(T) && T.key.type === "Identifier" && T.key.name === "styles" && m === "value", ...E);
        }
        function D(f) {
          return f.match((T) => T.type === "TemplateLiteral", (T, m) => a(T) && T.key.type === "Identifier" && T.key.name === "template" && m === "value", ...E);
        }
        var E = [(f, T) => f.type === "ObjectExpression" && T === "properties", (f, T) => f.type === "CallExpression" && f.callee.type === "Identifier" && f.callee.name === "Component" && T === "arguments", (f, T) => f.type === "Decorator" && T === "expression"];
        function _(f) {
          ...
          switch (m.type) {
            case "MemberExpression":
              return F(m.object) || S(m);
            case "CallExpression":
              return F(m.callee) || m.callee.type === "MemberExpression" && (m.callee.object.type === "MemberExpression" && (F(m.callee.object.object) || S(m.callee.object)) || m.callee.object.type === "CallExpression" && F(m.callee.object.callee));
            case "Identifier":
              return m.name === "css";
            default:
              return false;
        ...
        function w(f) {
          let T = f.getParentNode(), m = f.getParentNode(1);
        ...
        function P(f) {
          return I(f.getValue(), "HTML") || f.match((T) => T.type === "TemplateLiteral", (T, m) => T.type === "TaggedTemplateExpression" && T.tag.type === "Identifier" && T.tag.name === "html" && m === "quasi");
        }
        function $(f) {
          let { quasis: T } = f;
          return T.some((m) => {
...
`;
        ...
        function D(S) {
          let N = S.match(u);
          return N && N[0] ? S.substring(N[0].length) : S;
        }
        function E(S) {
          return _(S).pragmas;
        }
        function _(S) {
          let N = (0, t().default)(S) || r().EOL;
          S = S.replace(n, "").replace(a, "").replace(y, "$1");
          let I = "";
          for (; I !== S; )
            I = S, S = S.replace(p, `${N}$1 $2${N}`);
          S = S.replace(l, "").trimRight();
          let P = /* @__PURE__ */ Object.create(null), $ = S.replace(d, "").replace(l, "").trimRight(), f;
          for (; f = d.exec(S); ) {
            let T = f[2].replace(i, "");
            typeof P[f[1]] == "string" || Array.isArray(P[f[1]]) ? P[f[1]] = g.concat(P[f[1]], T) : P[f[1]] = T;
          }
          return { comments: $, pragmas: P };
        }
        function w(S) {
          let { comments: N = "", pragmas: I = {} } = S, P = (0, t().default)(N) || r().EOL, $ = "/**", f = " *", T = " */", m = Object.keys(I), v = m.map((h) => F(h, I[h])).reduce((h, C) => h.concat(C), []).map((h) => `${f} ${h}${P}`).join("");
          if (!N) {
            if (m.length === 0)
              return "";
          ...
          return $ + P + (N ? o : "") + (N && m.length ? f + P : "") + v + T;
        }
        function F(S, N) {
          return g.concat(N).map((I) => `@${S} ${I}`.trim());
        }
...
`) + _;
        ...
        function k(fe, A) {
          fe.type === "BlockStatement" ? B(fe, A) : i(fe, A);
        }
        function M(fe) {
          let { comment: A, followingNode: G } = fe;
          return G && Ae(A) ? (i(G, A), true) : false;
        }
        function R(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ee } = fe;
          ...
          return ye.type === "BlockStatement" ? (B(ye, A), true) : ye.type === "IfStatement" ? (k(ye.consequent, A), true) : re.consequent === ye ? (i(ye, A), true) : false;
        }
        function q(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ee } = fe;
          return (re == null ? void 0 : re.type) !== "WhileStatement" || !ye ? false : n(Ee, A, o) === ")" ? (l(G, A), true) : ye.type === "BlockStatement" ? (B(ye, A), true) : re.body === ye ? (i(ye, A), true) : false;
        }
        function J(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye } = fe;
          return (re == null ? void 0 : re.type) !== "TryStatement" && (re == null ? void 0 : re.type) !== "CatchClause" || !ye ? false : re.type === "CatchClause" && G ? (l(G, A), true) : ye.type === "BlockStatement" ? (B(ye, A), true) : ye.type === "TryStatement" ? (k(ye.finalizer, A), true) : ye.type === "CatchClause" ? (k(ye.body, A), true) : false;
        }
        function L(fe) {
          let { comment: A, enclosingNode: G, followingNode: re } = fe;
          return I(G) && (re == null ? void 0 : re.type) === "Identifier" ? (i(G, A), true) : false;
        }
        function Q(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ee } = fe, Be = G && !u(Ee, o(G), v(A));
          return (!G || !Be) && ((re == null ? void 0 : re.type) === "ConditionalExpression" || (re == null ? void 0 : re.type) === "TSConditionalType") && ye ? (i(ye, A), true) : false;
        }
        function V(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re } = fe;
        ...
        function Y(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye } = fe;
          if (j.has(re == null ? void 0 : re.type)) {
            if (y(re.decorators) && !(ye && ye.type === "Decorator"))
              return l(t(re.decorators), A), true;
            if (re.body && ye === re.body)
              return B(re.body, A), true;
            if (ye) {
              if (re.superClass && ye === re.superClass && G && (G === re.id || G === re.typeParameters))
                return l(G, A), true;
              for (let Ee of ["implements", "extends", "mixins"])
                if (re[Ee] && ye === re[Ee][0])
                  return G && (G === re.id || G === re.typeParameters || G === re.superClass) ? l(G, A) : p(re, A, Ee), true;
            }
          }
          return false;
        }
        var ie = /* @__PURE__ */ new Set(["ClassMethod", "ClassProperty", "PropertyDefinition", "TSAbstractPropertyDefinition", "TSAbstractMethodDefinition", "TSDeclareMethod", "MethodDefinition", "ClassAccessorProperty", "AccessorProperty", "TSAbstractAccessorProperty"]);
        function ee(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, text: ye } = fe;
          return re && G && n(ye, A, o) === "(" && (re.type === "Property" || re.type === "TSDeclareMethod" || re.type === "TSAbstractMethodDefinition") && G.type === "Identifier" && re.key === G && n(ye, G, o) !== ":" || (G == null ? void 0 : G.type) === "Decorator" && ie.has(re == null ? void 0 : re.type) ? (l(G, A), true) : false;
        }
        var le = /* @__PURE__ */ new Set(["FunctionDeclaration", "FunctionExpression", "ClassMethod", "MethodDefinition", "ObjectMethod"]);
        function W(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, text: ye } = fe;
          return n(ye, A, o) !== "(" ? false : G && le.has(re == null ? void 0 : re.type) ? (l(G, A), true) : false;
        }
        function K(fe) {
          let { comment: A, enclosingNode: G, text: re } = fe;
        ...
        function de(fe) {
          let { comment: A, enclosingNode: G, text: re } = fe;
          return n(re, A, o) !== ")" ? false : G && (X(G) && g(G).length === 0 || F(G) && S(G).length === 0) ? (p(G, A), true) : ((G == null ? void 0 : G.type) === "MethodDefinition" || (G == null ? void 0 : G.type) === "TSAbstractMethodDefinition") && g(G.value).length === 0 ? (p(G.value, A), true) : false;
        }
        function ue(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye, text: Ee } = fe;
          if ((G == null ? void 0 : G.type) === "FunctionTypeParam" && (re == null ? void 0 : re.type) === "FunctionTypeAnnotation" && (ye == null ? void 0 : ye.type) !== "FunctionTypeParam" || ((G == null ? void 0 : G.type) === "Identifier" || (G == null ? void 0 : G.type) === "AssignmentPattern") && re && X(re) && n(Ee, A, o) === ")")
            return l(G, A), true;
        ...
        function Fe(fe) {
          let { comment: A, enclosingNode: G } = fe;
        ...
        function U(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re } = fe;
          return N(re) && G && re.callee === G && re.arguments.length > 0 ? (i(re.arguments[0], A), true) : false;
        }
        function Z(fe) {
          let { comment: A, precedingNode: G, enclosingNode: re, followingNode: ye } = fe;
        ...
        function De(fe) {
          let { comment: A, enclosingNode: G, followingNode: re, ast: ye, isLastComment: Ee } = fe;
          return ye && ye.body && ye.body.length === 0 ? (Ee ? p(ye, A) : i(ye, A), true) : (G == null ? void 0 : G.type) === "Program" && (G == null ? void 0 : G.body.length) === 0 && !y(G.directives) ? (Ee ? p(G, A) : i(G, A), true) : (re == null ? void 0 : re.type) === "Program" && (re == null ? void 0 : re.body.length) === 0 && (G == null ? void 0 : G.type) === "ModuleExpression" ? (p(re, A), true) : false;
        }
        function ge(fe) {
          let { comment: A, enclosingNode: G } = fe;
        ...
        function he(fe) {
          ...
          if ((re == null ? void 0 : re.type) === "ImportSpecifier" || (re == null ? void 0 : re.type) === "ExportSpecifier")
            return i(re, A), true;
          let Ee = (G == null ? void 0 : G.type) === "ImportSpecifier" && (re == null ? void 0 : re.type) === "ImportDeclaration", Be = (G == null ? void 0 : G.type) === "ExportSpecifier" && (re == null ? void 0 : re.type) === "ExportNamedDeclaration";
          return (Ee || Be) && s(ye, o(A)) ? (l(G, A), true) : false;
        }
        function we(fe) {
          let { comment: A, enclosingNode: G } = fe;
          return (G == null ? void 0 : G.type) === "AssignmentPattern" ? (i(G, A), true) : false;
        }
        var ke = /* @__PURE__ */ new Set(["VariableDeclarator", "AssignmentExpression", "TypeAlias", "TSTypeAliasDeclaration"]), Re = /* @__PURE__ */ new Set(["ObjectExpression", "ArrayExpression", "TemplateLiteral", "TaggedTemplateExpression", "ObjectTypeAnnotation", "TSTypeLiteral"]);
        function Ne(fe) {
          let { comment: A, enclosingNode: G, followingNode: re } = fe;
          return ke.has(G == null ? void 0 : G.type) && re && (Re.has(re.type) || h(A)) ? (i(re, A), true) : false;
        }
        function Pe(fe) {
          let { comment: A, enclosingNode: G, followingNode: re, text: ye } = fe;
        ...
        function ce(fe) {
          let { comment: A, enclosingNode: G, followingNode: re } = fe;
          return !G || G.type !== "SwitchCase" || G.test || !re || re !== G.consequent[0] ? false : (re.type === "BlockStatement" && $(A) ? B(re, A) : p(G, A), true);
        }
        function X(fe) {
        ...
        function pe(fe, A) {
          if ((A.parser === "typescript" || A.parser === "flow" || A.parser === "acorn" || A.parser === "espree" || A.parser === "meriyah" || A.parser === "__babel_estree") && fe.type === "MethodDefinition" && fe.value && fe.value.type === "FunctionExpression" && g(fe.value).length === 0 && !fe.value.returnType && !y(fe.value.typeParameters) && fe.value.body)
        ...
        function Ce(fe) {
          let A = fe.getValue(), G = fe.getParentNode(), re = (ye) => _(f(ye, T.Leading)) || _(f(ye, T.Trailing));
          return (A && (D(A) || E(A) || N(G) && re(A)) || G && (G.type === "JSXSpreadAttribute" || G.type === "JSXSpreadChild" || G.type === "UnionTypeAnnotation" || G.type === "TSUnionType" || (G.type === "ClassDeclaration" || G.type === "ClassExpression") && G.superClass === A)) && (!w(fe) || G.type === "UnionTypeAnnotation" || G.type === "TSUnionType");
        }
        r.exports = { handleOwnLineComment: C, handleEndOfLineComment: x, handleRemainingComment: b, isTypeCastComment: Ae, getCommentChildNodes: pe, willPrintOwnComments: Ce };
        ...
        function w(f, T) {
          ...
          if (T.__isInHtmlInterpolation && !T.bracketSpacing && I(o) && P(f))
            return true;
          if (F(o))
            return false;
          if (T.parser !== "flow" && u(f.getValue()))
            return true;
          if (o.type === "Identifier") {
            ...
            if (o.name === "let") {
              var h;
              let x = (h = f.findAncestor((b) => b.type === "ForOfStatement")) === null || h === void 0 ? void 0 : h.left;
              if (x && d(x, (b) => b === o))
                return true;
            }
            if (v === "object" && o.name === "let" && m.type === "MemberExpression" && m.computed && !m.optional) {
              let x = f.findAncestor((B) => B.type === "ExpressionStatement" || B.type === "ForStatement" || B.type === "ForInStatement"), b = x ? x.type === "ExpressionStatement" ? x.expression : x.type === "ForStatement" ? x.init : x.left : void 0;
              if (b && d(b, (B) => B === o))
                return true;
            }
            return false;
          ...
          if (o.type === "ObjectExpression" || o.type === "FunctionExpression" || o.type === "ClassExpression" || o.type === "DoExpression") {
            var C;
            let x = (C = f.findAncestor((b) => b.type === "ExpressionStatement")) === null || C === void 0 ? void 0 : C.expression;
            if (x && d(x, (b) => b === o))
              return true;
          }
          switch (m.type) {
            ...
            case "ExportDefaultDeclaration":
              return $(f, T) || o.type === "SequenceExpression";
            case "Decorator": {
              if (v === "expression") {
                let x = false, b = false, B = o;
                for (; B; )
                  switch (B.type) {
                    case "MemberExpression":
                      b = true, B = B.object;
            ...
            case "ArrowFunctionExpression": {
              if (v === "body" && o.type !== "SequenceExpression" && d(o, (x) => x.type === "ObjectExpression"))
                return true;
              break;
            }
          }
          switch (o.type) {
            ...
            case "BinaryExpression": {
              if (m.type === "UpdateExpression" || o.operator === "in" && S(f))
                return true;
              if (o.operator === "|>" && o.extra && o.extra.parenthesized) {
                let x = f.getParentNode(1);
            ...
            case "LogicalExpression":
              switch (m.type) {
                ...
                case "BinaryExpression": {
                  let { operator: x, type: b } = o;
                  if (!x && b !== "TSTypeAssertion")
                    return true;
                  let B = g(x), k = m.operator, M = g(k);
                  return M > B || v === "right" && M === B || M === B && !y(k, x) ? true : M < B && x === "%" ? k === "+" || k === "-" : !!p(k);
                }
                default:
                  return false;
              }
            ...
            case "TSConstructorType":
              if (v === "extendsType" && m.type === "TSConditionalType") {
                let x = (o.returnType || o.typeAnnotation).typeAnnotation;
                if (x.type === "TSInferType" && x.typeParameter.constraint)
                  return true;
              }
            ...
            case "FunctionTypeAnnotation": {
              let x = m.type === "NullableTypeAnnotation" ? f.getParentNode(1) : m;
              return x.type === "UnionTypeAnnotation" || x.type === "IntersectionTypeAnnotation" || x.type === "ArrayTypeAnnotation" || v === "objectType" && (x.type === "IndexedAccessType" || x.type === "OptionalIndexedAccessType") || x.type === "NullableTypeAnnotation" || m.type === "FunctionTypeParam" && m.name === null && a(o).some((b) => b.typeAnnotation && b.typeAnnotation.type === "NullableTypeAnnotation");
            }
            ...
            case "AssignmentExpression": {
              let x = f.getParentNode(1);
              return v === "body" && m.type === "ArrowFunctionExpression" ? true : v === "key" && (m.type === "ClassProperty" || m.type === "PropertyDefinition") && m.computed || (v === "init" || v === "update") && m.type === "ForStatement" ? false : m.type === "ExpressionStatement" ? o.left.type === "ObjectPattern" : !(v === "key" && m.type === "TSPropertySignature" || m.type === "AssignmentExpression" || m.type === "SequenceExpression" && x && x.type === "ForStatement" && (x.init === m || x.update === m) || v === "value" && m.type === "Property" && x && x.type === "ObjectPattern" && x.properties.includes(m) || m.type === "NGChainedExpression");
            }
            case "ConditionalExpression":
              switch (m.type) {
                case "TaggedTemplateExpression":
            ...
            case "OptionalCallExpression": {
              let x = f.getParentNode(1);
              if (v === "object" && m.type === "MemberExpression" || v === "callee" && (m.type === "CallExpression" || m.type === "NewExpression") || m.type === "TSNonNullExpression" && x.type === "MemberExpression" && x.object === m)
                return true;
            }
            case "CallExpression":
            case "MemberExpression":
        ...
        function S(f) {
          let T = 0, m = f.getValue();
          for (; m; ) {
            let v = f.getParentNode(T++);
        ...
        function N(f) {
          return l(f, (T) => T.type === "ObjectTypeAnnotation" && l(T, (m) => m.type === "FunctionTypeAnnotation" || void 0) || void 0);
        }
        function I(f) {
          switch (f.type) {
            case "ObjectExpression":
        ...
        function P(f) {
          let T = f.getValue(), m = f.getParentNode(), v = f.getName();
          switch (m.type) {
            case "NGPipeExpression":
              if (typeof v == "number" && m.arguments[v] === T && m.arguments.length - 1 === v)
        ...
        function $(f, T) {
          ...
          return m.type === "FunctionExpression" || m.type === "ClassExpression" ? v.type === "ExportDefaultDeclaration" || !w(f, T) : !i(m) || v.type !== "ExportDefaultDeclaration" && w(f, T) ? false : f.call((o) => $(o, T), ...n(f, m));
        }
        r.exports = w;
        ...
        r.exports = t;
      } }), cd = te({ "src/language-js/print/html-binding.js"(e, r) {
        "use strict";
        ne();
        ...
        "use strict";
        ne();
        var { printComments: t } = et(), { getLast: s } = Ue(), { builders: { join: a, line: n, softline: u, group: i, indent: l, align: p, indentIfBreak: d }, utils: { cleanDoc: y, getDocParts: g, isConcat: c } } = qe(), { hasLeadingOwnLineComment: D, isBinaryish: E, isJsxNode: _, shouldFlatten: w, hasComment: F, CommentCheckFlags: S, isCallExpression: N, isMemberExpression: I, isObjectProperty: P, isEnabledHackPipeline: $ } = Ke(), f = 0;
        function T(o, h, C) {
          let x = o.getValue(), b = o.getParentNode(), B = o.getParentNode(1), k = x !== b.body && (b.type === "IfStatement" || b.type === "WhileStatement" || b.type === "SwitchStatement" || b.type === "DoWhileStatement"), M = $(h) && x.operator === "|>", R = m(o, C, h, false, k);
          if (k)
            return R;
          if (M)
            return i(R);
          if (N(b) && b.callee === x || b.type === "UnaryExpression" || I(b) && !b.computed)
            return i([l([u, ...R]), u]);
          let q = b.type === "ReturnStatement" || b.type === "ThrowStatement" || b.type === "JSXExpressionContainer" && B.type === "JSXAttribute" || x.operator !== "|" && b.type === "JsExpressionRoot" || x.type !== "NGPipeExpression" && (b.type === "NGRoot" && h.parser === "__ng_binding" || b.type === "NGMicrosyntaxExpression" && B.type === "NGMicrosyntax" && B.body.length === 1) || x === b.body && b.type === "ArrowFunctionExpression" || x !== b.body && b.type === "ForStatement" || b.type === "ConditionalExpression" && B.type !== "ReturnStatement" && B.type !== "ThrowStatement" && !N(B) || b.type === "TemplateLiteral", J = b.type === "AssignmentExpression" || b.type === "VariableDeclarator" || b.type === "ClassProperty" || b.type === "PropertyDefinition" || b.type === "TSAbstractPropertyDefinition" || b.type === "ClassPrivateProperty" || P(b), L = E(x.left) && w(x.operator, x.left.operator);
          if (q || v(x) && !L || !v(x) && J)
            return i(R);
          if (R.length === 0)
            return "";
          let Q = _(x.right), V = R.findIndex((W) => typeof W != "string" && !Array.isArray(W) && W.type === "group"), j = R.slice(0, V === -1 ? 1 : V + 1), Y = R.slice(j.length, Q ? -1 : void 0), ie = Symbol("logicalChain-" + ++f), ee = i([...j, l(Y)], { id: ie });
          if (!Q)
            return ee;
          let le = s(R);
          return i([ee, d(le, { groupId: ie })]);
        }
        function m(o, h, C, x, b) {
          let B = o.getValue();
          if (!E(B))
            return [i(h())];
          let k = [];
          w(B.operator, B.left.operator) ? k = o.call((Y) => m(Y, h, C, true, b), "left") : k.push(i(h("left")));
          let M = v(B), R = (B.operator === "|>" || B.type === "NGPipeExpression" || B.operator === "|" && C.parser === "__vue_expression") && !D(C.originalText, B.right), q = B.type === "NGPipeExpression" ? "|" : B.operator, J = B.type === "NGPipeExpression" && B.arguments.length > 0 ? i(l([n, ": ", a([n, ": "], o.map(h, "arguments").map((Y) => p(2, i(Y))))])) : "", L;
          if (M)
            L = [q, " ", h("right"), J];
          else {
            let ie = $(C) && q === "|>" ? o.call((ee) => m(ee, h, C, true, b), "right") : h("right");
            L = [R ? n : "", q, R ? " " : n, ie, J];
          }
          let Q = o.getParentNode(), V = F(B.left, S.Trailing | S.Line), j = V || !(b && B.type === "LogicalExpression") && Q.type !== B.type && B.left.type !== B.type && B.right.type !== B.type;
          if (k.push(R ? "" : " ", j ? i(L, { shouldBreak: V }) : L), x && F(B)) {
            let Y = y(t(o, k, C));
        ...
        r.exports = { printBinaryishExpression: T, shouldInlineLogicalExpression: v };
      } }), pd = te({ "src/language-js/print/angular.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), fd = te({ "src/language-js/print/jsx.js"(e, r) {
        "use strict";
        ne();
        var { printComments: t, printDanglingComments: s, printCommentsSeparately: a } = et(), { builders: { line: n, hardline: u, softline: i, group: l, indent: p, conditionalGroup: d, fill: y, ifBreak: g, lineSuffixBoundary: c, join: D }, utils: { willBreak: E } } = qe(), { getLast: _, getPreferredQuote: w } = Ue(), { isJsxNode: F, rawText: S, isCallExpression: N, isStringLiteral: I, isBinaryish: P, hasComment: $, CommentCheckFlags: f, hasNodeIgnoreComment: T } = Ke(), m = qt(), { willPrintOwnComments: v } = Eo(), o = (U) => U === "" || U === n || U === u || U === i;
        function h(U, Z, se) {
          let De = U.getValue();
          if (De.type === "JSXElement" && de(De))
            return [se("openingElement"), se("closingElement")];
          let ge = De.type === "JSXElement" ? se("openingElement") : se("openingFragment"), he = De.type === "JSXElement" ? se("closingElement") : se("closingFragment");
          if (De.children.length === 1 && De.children[0].type === "JSXExpressionContainer" && (De.children[0].expression.type === "TemplateLiteral" || De.children[0].expression.type === "TaggedTemplateExpression"))
            return [ge, ...U.map(se, "children"), he];
          De.children = De.children.map((A) => Fe(A) ? { type: "JSXText", value: " ", raw: " " } : A);
          let we = De.children.some(F), ke = De.children.filter((A) => A.type === "JSXExpressionContainer").length > 1, Re = De.type === "JSXElement" && De.openingElement.attributes.length > 1, Ne = E(ge) || we || Re || ke, Pe = U.getParentNode().rootMarker === "mdx", oe = Z.singleQuote ? "{' '}" : '{" "}', H = Pe ? " " : g([oe, i], " "), ce = De.openingElement && De.openingElement.name && De.openingElement.name.name === "fbt", X = C(U, Z, se, H, ce), pe = De.children.some((A) => ue(A));
          for (let A = X.length - 2; A >= 0; A--) {
            let G = X[A] === "" && X[A + 1] === "", re = X[A] === u && X[A + 1] === "" && X[A + 2] === u, ye = (X[A] === i || X[A] === u) && X[A + 1] === "" && X[A + 2] === H, Ee = X[A] === H && X[A + 1] === "" && (X[A + 2] === i || X[A + 2] === u), Be = X[A] === H && X[A + 1] === "" && X[A + 2] === H, ve = X[A] === i && X[A + 1] === "" && X[A + 2] === u || X[A] === u && X[A + 1] === "" && X[A + 2] === i;
            re && pe || G || ye || Be || ve ? X.splice(A, 2) : Ee && X.splice(A + 1, 2);
          }
          ...
          let Ce = pe ? y(Ae) : l(Ae, { shouldBreak: true });
          if (Pe)
            return Ce;
          let fe = l([ge, p([u, Ce]), u, he]);
          return Ne ? fe : d([l([ge, ...X, he]), fe]);
        }
        function C(U, Z, se, De, ge) {
          let he = [];
            ...
            if (Ne.type === "JSXText") {
              ...
              if (ue(Ne)) {
                ...
                if (_(oe) === "" && (oe.pop(), H = oe.pop()), oe.length === 0)
                  return;
                for (let [ce, X] of oe.entries())
                  ce % 2 === 1 ? he.push(n) : he.push(X);
                if (H !== void 0)
                  if (/\n/.test(H)) {
                    let ce = Re[ke + 1];
                    he.push(b(ge, _(he), Ne, ce));
                  } else
                    he.push(De);
                else {
                  let ce = Re[ke + 1];
                  he.push(x(ge, _(he), Ne, ce));
                }
              } else
                /\n/.test(Pe) ? Pe.match(/\n/g).length > 1 && he.push("", u) : he.push("", De);
            } else {
              let Pe = se();
              he.push(Pe);
              let oe = Re[ke + 1];
              if (oe && ue(oe)) {
                let ce = K(S(oe)).split(le)[0];
                he.push(x(ge, ce, Ne, oe));
              } else
                he.push(u);
            }
          }, "children"), he;
        }
        function x(U, Z, se, De) {
          return U ? "" : se.type === "JSXElement" && !se.closingElement || De && De.type === "JSXElement" && !De.closingElement ? Z.length === 1 ? i : u : i;
        }
        function b(U, Z, se, De) {
          return U ? u : Z.length === 1 ? se.type === "JSXElement" && !se.closingElement || De && De.type === "JSXElement" && !De.closingElement ? u : i : u;
        }
        function B(U, Z, se) {
          let De = U.getParentNode();
          if (!De || { ArrayExpression: true, JSXAttribute: true, JSXElement: true, JSXExpressionContainer: true, JSXFragment: true, ExpressionStatement: true, CallExpression: true, OptionalCallExpression: true, ConditionalExpression: true, JsExpressionRoot: true }[De.type])
            return Z;
          let he = U.match(void 0, (ke) => ke.type === "ArrowFunctionExpression", N, (ke) => ke.type === "JSXExpressionContainer"), we = m(U, se);
          return l([we ? "" : g("("), p([i, Z]), i, we ? "" : g(")")], { shouldBreak: he });
        }
        function k(U, Z, se) {
          let De = U.getValue(), ge = [];
          if (ge.push(se("name")), De.value) {
            let he;
            if (I(De.value)) {
              let ke = S(De.value).slice(1, -1).replace(/&apos;/g, "'").replace(/&quot;/g, '"'), { escaped: Re, quote: Ne, regex: Pe } = w(ke, Z.jsxSingleQuote ? "'" : '"');
              ke = ke.replace(Pe, Re);
        ...
        function M(U, Z, se) {
          let De = U.getValue(), ge = (he, we) => he.type === "JSXEmptyExpression" || !$(he) && (he.type === "ArrayExpression" || he.type === "ObjectExpression" || he.type === "ArrowFunctionExpression" || he.type === "AwaitExpression" && (ge(he.argument, he) || he.argument.type === "JSXElement") || N(he) || he.type === "FunctionExpression" || he.type === "TemplateLiteral" || he.type === "TaggedTemplateExpression" || he.type === "DoExpression" || F(we) && (he.type === "ConditionalExpression" || P(he)));
          return ge(De.expression, U.getParentNode(0)) ? l(["{", se("expression"), c, "}"]) : l(["{", p([i, se("expression")]), i, c, "}"]);
        }
        function R(U, Z, se) {
          let De = U.getValue(), ge = De.name && $(De.name) || De.typeParameters && $(De.typeParameters);
          if (De.selfClosing && De.attributes.length === 0 && !ge)
            return ["<", se("name"), se("typeParameters"), " />"];
          if (De.attributes && De.attributes.length === 1 && De.attributes[0].value && I(De.attributes[0].value) && !De.attributes[0].value.value.includes(`
`) && !ge && !$(De.attributes[0]))
            return l(["<", se("name"), se("typeParameters"), " ", ...U.map(se, "attributes"), De.selfClosing ? " />" : ">"]);
          let he = De.attributes && De.attributes.some((ke) => ke.value && I(ke.value) && ke.value.value.includes(`
`)), we = Z.singleAttributePerLine && De.attributes.length > 1 ? u : n;
          return l(["<", se("name"), se("typeParameters"), p(U.map(() => [we, se()], "attributes")), ...q(De, Z, ge)], { shouldBreak: he });
        }
        function q(U, Z, se) {
          return U.selfClosing ? [n, "/>"] : J(U, Z, se) ? [">"] : [i, ">"];
        }
        function J(U, Z, se) {
          let De = U.attributes.length > 0 && $(_(U.attributes), f.Trailing);
          return U.attributes.length === 0 && !se || (Z.bracketSameLine || Z.jsxBracketSameLine) && (!se || U.attributes.length > 0) && !De;
        }
        function L(U, Z, se) {
          let De = U.getValue(), ge = [];
          ge.push("</");
          let he = se("name");
          return $(De.name, f.Leading | f.Line) ? ge.push(p([u, he]), u) : $(De.name, f.Leading | f.Block) ? ge.push(" ", he) : ge.push(he), ge.push(">"), ge;
        }
        function Q(U, Z) {
          let se = U.getValue(), De = $(se), ge = $(se, f.Line), he = se.type === "JSXOpeningFragment";
          return [he ? "<" : "</", p([ge ? u : De && !he ? " " : "", s(U, Z, true)]), ge ? u : "", ">"];
        }
        function V(U, Z, se) {
          let De = t(U, h(U, Z, se), Z);
          return B(U, De, Z);
        }
        function j(U, Z) {
          let se = U.getValue(), De = $(se, f.Line);
          return [s(U, Z, !De), De ? u : ""];
        }
        function Y(U, Z, se) {
          let De = U.getValue();
          return ["{", U.call((ge) => {
            let he = ["...", se()], we = ge.getValue();
            return !$(we) || !v(ge) ? he : [p([i, t(ge, he, Z)]), i];
          }, De.type === "JSXSpreadAttribute" ? "argument" : "expression"), "}"];
        }
        function ie(U, Z, se) {
          let De = U.getValue();
          if (De.type.startsWith("JSX"))
            switch (De.type) {
              case "JSXAttribute":
                return k(U, Z, se);
              case "JSXIdentifier":
              ...
              case "JSXNamespacedName":
                return D(":", [se("namespace"), se("name")]);
              case "JSXMemberExpression":
                return D(".", [se("object"), se("property")]);
              case "JSXSpreadAttribute":
                return Y(U, Z, se);
              case "JSXSpreadChild":
                return Y(U, Z, se);
              ...
              default:
                throw new Error(`Unknown JSX node type: ${JSON.stringify(De.type)}.`);
            }
        }
        var ee = ` 
\r	`, le = new RegExp("([" + ee + "]+)"), W = new RegExp("[^" + ee + "]"), K = (U) => U.replace(new RegExp("(?:^" + le.source + "|" + le.source + "$)"), "");
        function de(U) {
        ...
        function ue(U) {
          return U.type === "JSXText" && (W.test(S(U)) || !/\n/.test(S(U)));
        }
        function Fe(U) {
        ...
        function z(U) {
          ...
          if (!se || !Z || !F(Z) || !F(se))
            return false;
          let De = se.children.indexOf(Z), ge = null;
          for (let he = De; he > 0; he--) {
        ...
        function p(_, w, F) {
          let S = _.getValue();
          return S.typeArguments ? F("typeArguments") : S.typeParameters ? F("typeParameters") : "";
        }
        function d(_, w, F) {
          let S = _.getValue();
          if (!S.typeAnnotation)
            return "";
          let N = _.getParentNode(), I = N.type === "DeclareFunction" && N.id === S;
          return u(w.originalText, S.typeAnnotation) ? [" /*: ", F("typeAnnotation"), " */"] : [I ? "" : ": ", F("typeAnnotation")];
        }
        function y(_, w, F) {
          return ["::", F("callee")];
        }
        function g(_, w, F) {
          let S = _.getValue();
          return t(S.modifiers) ? [a(" ", _.map(F, "modifiers")), " "] : "";
        }
        function c(_, w, F) {
        ...
        "use strict";
        ne();
        var { printDanglingComments: t } = et(), { builders: { line: s, softline: a, hardline: n, group: u, indent: i, ifBreak: l, fill: p } } = qe(), { getLast: d, hasNewline: y } = Ue(), { shouldPrintComma: g, hasComment: c, CommentCheckFlags: D, isNextLineEmpty: E, isNumericLiteral: _, isSignedNumericLiteral: w } = Ke(), { locStart: F } = ut(), { printOptionalToken: S, printTypeAnnotation: N } = ct();
        function I(T, m, v) {
          let o = T.getValue(), h = [], C = o.type === "TupleExpression" ? "#[" : "[", x = "]";
          if (o.elements.length === 0)
            c(o, D.Dangling) ? h.push(u([C, t(T, m), a, x])) : h.push(C, x);
          else {
            let b = d(o.elements), B = !(b && b.type === "RestElement"), k = b === null, M = Symbol("array"), R = !m.__inJestEach && o.elements.length > 1 && o.elements.every((L, Q, V) => {
              let j = L && L.type;
            ...
            h.push(u([C, i([a, q ? f(T, m, v, J) : [$(T, m, "elements", v), J], t(T, m, true)]), a, x], { shouldBreak: R, id: M }));
          }
          return h.push(S(T), N(T, m, v)), h;
        }
        function P(T, m) {
          return T.elements.length > 1 && T.elements.every((v) => v && (_(v) || w(v) && !c(v.argument)) && !c(v, D.Trailing | D.Line, (o) => !y(m.originalText, F(o), { backwards: true })));
        }
        function $(T, m, v, o) {
          let h = [], C = [];
          return T.each((x) => {
            h.push(C, u(o())), C = [",", s], x.getValue() && E(x.getValue(), m) && C.push(a);
          }, v), h;
        }
        function f(T, m, v, o) {
          let h = [];
          return T.each((C, x, b) => {
            let B = x === b.length - 1;
            h.push([v(), B ? o : ","]), B || h.push(E(C.getValue(), m) ? [n, n] : c(b[x + 1], D.Leading | D.Line) ? n : s);
          }, "elements"), p(h);
        }
        ...
        function C(q, J, L) {
          ...
          let Y = false, ie = false, ee = j.length - 1, le = [];
          c(q, (z, U) => {
            let Z = z.getNode(), se = [L()];
            U === ee || (D(Z, J) ? (U === 0 && (ie = true), Y = true, se.push(",", N, N)) : se.push(",", S)), le.push(se);
          });
          let W = !(V || Q.callee && Q.callee.type === "Import") && y(J, "all") ? "," : "";
          function K() {
            return P(["(", $([S, ...le]), W, S, ")"], { shouldBreak: true });
          }
          if (Y || q.getParentNode().type !== "Decorator" && l(j))
            return K();
          let de = B(j), ue = b(j, J);
          if (de || ue) {
            if (de ? le.slice(1).some(v) : le.slice(0, -1).some(v))
              return K();
            let z = [];
            try {
              q.try(() => {
                c(q, (U, Z) => {
                  de && Z === 0 && (z = [[L([], { expandFirstArg: true }), le.length > 1 ? "," : "", ie ? N : S, ie ? N : ""], ...le.slice(1)]), ue && Z === ee && (z = [...le.slice(0, -1), L([], { expandLastArg: true })]);
                });
              });
            } catch (U) {
              if (U instanceof o)
            ...
            return [le.some(v) ? m : "", f([["(", ...z, ")"], de ? ["(", P(z[0], { shouldBreak: true }), ...z.slice(1), ")"] : ["(", ...le.slice(0, -1), P(s(z), { shouldBreak: true }), ")"], K()])];
          }
          let Fe = ["(", $([I, ...le]), T(W), I, ")"];
          return d(q) ? Fe : P(Fe, { shouldBreak: le.some(v) || Y });
        }
        function x(q) {
          let J = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
          return q.type === "ObjectExpression" && (q.properties.length > 0 || u(q)) || q.type === "ArrayExpression" && (q.elements.length > 0 || u(q)) || q.type === "TSTypeAssertion" && x(q.expression) || F(q) && x(q.expression) || q.type === "FunctionExpression" || q.type === "ArrowFunctionExpression" && (!q.returnType || !q.returnType.typeAnnotation || q.returnType.typeAnnotation.type !== "TSTypeReference" || M(q.body)) && (q.body.type === "BlockStatement" || q.body.type === "ArrowFunctionExpression" && x(q.body, true) || q.body.type === "ObjectExpression" || q.body.type === "ArrayExpression" || !J && (E(q.body) || q.body.type === "ConditionalExpression") || p(q.body)) || q.type === "DoExpression" || q.type === "ModuleExpression";
        }
        function b(q, J) {
          let L = s(q), Q = a(q);
          return !u(L, i.Leading) && !u(L, i.Trailing) && x(L) && (!Q || Q.type !== L.type) && (q.length !== 2 || Q.type !== "ArrowFunctionExpression" || L.type !== "ArrayExpression") && !(q.length > 1 && L.type === "ArrayExpression" && h(L, J));
        }
        function B(q) {
          if (q.length !== 2)
            return false;
          let [J, L] = q;
          return J.type === "ModuleExpression" && R(L) ? true : !u(J) && (J.type === "FunctionExpression" || J.type === "ArrowFunctionExpression" && J.body.type === "BlockStatement") && L.type !== "FunctionExpression" && L.type !== "ArrowFunctionExpression" && L.type !== "ConditionalExpression" && !x(L);
        }
        function k(q) {
        ...
        function d(g, c, D) {
          ...
          let S = D("object"), N = y(g, c, D), I = w && (w.type === "NewExpression" || w.type === "BindExpression" || w.type === "AssignmentExpression" && w.left.type !== "Identifier") || E.computed || E.object.type === "Identifier" && E.property.type === "Identifier" && !i(_) || (_.type === "AssignmentExpression" || _.type === "VariableDeclarator") && (l(E.object) && E.object.arguments.length > 0 || E.object.type === "TSNonNullExpression" && l(E.object.expression) && E.object.expression.arguments.length > 0 || S.label === "member-chain");
          return n(S.label === "member-chain" ? "member-chain" : "member", [S, I ? N : s(a([t, N]))]);
        }
        function y(g, c, D) {
      ...
      } }), Dd = te({ "src/language-js/print/member-chain.js"(e, r) {
        "use strict";
        ne();
        var { printComments: t } = et(), { getLast: s, isNextLineEmptyAfterIndex: a, getNextNonSpaceNonCommentCharacterIndex: n } = Ue(), u = qt(), { isCallExpression: i, isMemberExpression: l, isFunctionOrArrowExpression: p, isLongCurriedCallExpression: d, isMemberish: y, isNumericLiteral: g, isSimpleCallArgument: c, hasComment: D, CommentCheckFlags: E, isNextLineEmpty: _ } = Ke(), { locEnd: w } = ut(), { builders: { join: F, hardline: S, group: N, indent: I, conditionalGroup: P, breakParent: $, label: f }, utils: { willBreak: T } } = qe(), m = Ao(), { printMemberLookup: v } = So(), { printOptionalToken: o, printFunctionTypeParameters: h, printBindExpressionCallee: C } = ct();
        function x(b, B, k) {
          ...
          function L(Ne) {
            let Pe = Ne.getValue();
            i(Pe) && (y(Pe.callee) || i(Pe.callee)) ? (q.unshift({ node: Pe, printed: [t(Ne, [o(Ne), h(Ne, B, k), m(Ne, B, k)], B), J(Pe) ? S : ""] }), Ne.call((oe) => L(oe), "callee")) : y(Pe) ? (q.unshift({ node: Pe, needsParens: u(Ne, B), printed: t(Ne, l(Pe) ? v(Ne, B, k) : C(Ne, B, k), B) }), Ne.call((oe) => L(oe), "object")) : Pe.type === "TSNonNullExpression" ? (q.unshift({ node: Pe, printed: t(Ne, "!", B) }), Ne.call((oe) => L(oe), "expression")) : q.unshift({ node: Pe, printed: k() });
          }
          let Q = b.getValue();
          q.unshift({ node: Q, printed: [o(b), h(b, B, k), m(b, B, k)] }), Q.callee && b.call((Ne) => L(Ne), "callee");
          let V = [], j = [q[0]], Y = 1;
          ...
          for (; Y < q.length; ++Y) {
            ...
            (i(q[Y].node) || q[Y].node.type === "ImportExpression") && (ie = true), j.push(q[Y]), D(q[Y].node, E.Trailing) && (V.push(j), j = [], ie = false);
          }
          j.length > 0 && V.push(j);
          function ee(Ne) {
          ...
          function W(Ne) {
            ...
            if (Ne[0].length === 1) {
              let H = Ne[0][0].node;
              return H.type === "ThisExpression" || H.type === "Identifier" && (ee(H.name) || R && le(H.name) || Pe);
            }
            let oe = s(Ne[0]).node;
            return l(oe) && oe.property.type === "Identifier" && (ee(oe.property.name) || Pe);
          }
          let K = V.length >= 2 && !D(V[1][0].node) && W(V);
          function de(Ne) {
            let Pe = Ne.map((oe) => oe.printed);
            return Ne.length > 0 && s(Ne).needsParens ? ["(", ...Pe, ")"] : Pe;
          }
          function ue(Ne) {
            return Ne.length === 0 ? "" : I(N([S, F(S, Ne.map(de))]));
          }
          let Fe = V.map(de), z = Fe, U = K ? 3 : 2, Z = V.flat(), se = Z.slice(1, -1).some((Ne) => D(Ne.node, E.Leading)) || Z.slice(0, -1).some((Ne) => D(Ne.node, E.Trailing)) || V[U] && D(V[U][0].node, E.Leading);
          if (V.length <= U && !se)
            return d(b) ? z : N(z);
          let De = s(V[K ? 1 : 0]).node, ge = !i(De) && J(De), he = [de(V[0]), K ? V.slice(1, 2).map(de) : "", ge ? S : "", ue(V.slice(K ? 2 : 1))], we = q.map((Ne) => {
            let { node: Pe } = Ne;
            return Pe;
          }).filter(i);
          function ke() {
          ...
          let Re;
          return se || we.length > 2 && we.some((Ne) => !Ne.arguments.every((Pe) => c(Pe, 0))) || Fe.slice(0, -1).some(T) || ke() ? Re = N(he) : Re = [T(z) || ge ? $ : "", P([z, he])], f("member-chain", Re);
        }
        r.exports = x;
      } }), xo = te({ "src/language-js/print/call-expression.js"(e, r) {
        "use strict";
        ne();
        var { builders: { join: t, group: s } } = qe(), a = qt(), { getCallArguments: n, hasFlowAnnotationComment: u, isCallExpression: i, isMemberish: l, isStringLiteral: p, isTemplateOnItsOwnLine: d, isTestCall: y, iterateCallArgumentsPath: g } = Ke(), c = Dd(), D = Ao(), { printOptionalToken: E, printFunctionTypeParameters: _ } = ct();
        function w(S, N, I) {
          let P = S.getValue(), $ = S.getParentNode(), f = P.type === "NewExpression", T = P.type === "ImportExpression", m = E(S), v = n(P);
          if (v.length > 0 && (!T && !f && F(P, $) || v.length === 1 && d(v[0], N.originalText) || !f && y(P, $))) {
            let C = [];
            return g(S, () => {
              C.push(I());
            }), [f ? "new " : "", I("callee"), m, _(S, N, I), "(", t(", ", C), ")"];
          }
          let o = (N.parser === "babel" || N.parser === "babel-flow") && P.callee && P.callee.type === "Identifier" && u(P.callee.trailingComments);
          if (o && (P.callee.trailingComments[0].printed = true), !T && !f && l(P.callee) && !S.call((C) => a(C, N), "callee"))
            return c(S, N, I);
          let h = [f ? "new " : "", T ? "import" : I("callee"), m, o ? `/*:: ${P.callee.trailingComments[0].value.slice(2).trim()} */` : "", _(S, N, I), D(S, N, I)];
        ...
        function h(W, K, de, ue, Fe) {
          ...
          if (x(z) || k(z) || q(z) || J(z) && y(ue))
            return "break-lhs";
          let ge = ie(z, ue, K);
          return W.call(() => C(W, K, de, ge), Fe) ? "break-after-operator" : ge || U.type === "TemplateLiteral" || U.type === "TaggedTemplateExpression" || U.type === "BooleanLiteral" || _(U) || U.type === "ClassExpression" ? "never-break-after-operator" : "fluid";
        }
        function C(W, K, de, ue) {
          let Fe = W.getValue();
          if (c(Fe) && !f(Fe))
            return true;
          switch (Fe.type) {
...
`) : E(W);
        ...
        r.exports = { printVariableDeclarator: o, printAssignmentExpression: v, printAssignment: m, isArrowFunctionVariableDeclarator: J };
        ...
        function m(C, x, b, B, k) {
          let M = C.getValue(), R = g(M), q = k ? T(C, b, x) : "";
          if (R.length === 0)
            return [q, "(", s(C, b, true, (ie) => t(b.originalText, ie, $) === ")"), ")"];
          let J = C.getParentNode(), L = E(J), Q = v(M), V = [];
          if (c(C, (ie, ee) => {
            let le = ee === R.length - 1;
            le && M.rest && V.push("..."), V.push(x()), !le && (V.push(","), L || Q ? V.push(" ") : P(R[ee], b) ? V.push(n, n) : V.push(a));
          }), B) {
            if (y(q) || y(V))
              throw new f();
            return i([d(q), "(", d(V), ")"]);
        ...
        function o(C) {
          let x;
          return C.returnType ? (x = C.returnType, x.typeAnnotation && (x = x.typeAnnotation)) : C.typeAnnotation && (x = C.typeAnnotation), x;
        }
        function h(C, x) {
          let b = o(C);
          if (!b)
            return false;
          let B = C.typeParameters && C.typeParameters.params;
          if (B) {
            if (B.length > 1)
              return false;
            if (B.length === 1) {
        ...
        "use strict";
        ne();
        var { printComments: t, printDanglingComments: s } = et(), { isNonEmptyArray: a } = Ue(), { builders: { group: n, join: u, line: i, softline: l, indent: p, align: d, ifBreak: y } } = qe(), g = qt(), { locStart: c } = ut(), { isSimpleType: D, isObjectType: E, hasLeadingOwnLineComment: _, isObjectTypePropertyAFunction: w, shouldPrintComma: F } = Ke(), { printAssignment: S } = tr(), { printFunctionParameters: N, shouldGroupFunctionParameters: I } = Lr(), { printArrayItems: P } = er();
        function $(b) {
          if (D(b) || E(b))
            return true;
        ...
        function T(b, B, k) {
          ...
          return [S(b, B, k, q, " =", J), M];
        }
        function m(b, B, k) {
          let M = b.getValue(), R = b.map(k, "types"), q = [], J = false;
          for (let L = 0; L < R.length; ++L)
            L === 0 ? q.push(R[L]) : E(M.types[L - 1]) && E(M.types[L]) ? q.push([" & ", J ? p(R[L]) : R[L]]) : !E(M.types[L - 1]) && !E(M.types[L]) ? q.push(p([" &", i, R[L]])) : (L > 1 && (J = true), q.push(" & ", L > 1 ? p(R[L]) : R[L]));
          return n(q);
        }
        function v(b, B, k) {
          ...
          if (J)
            return u(" | ", L);
          let Q = q && !_(B.originalText, M), V = [y([Q ? i : "", "| "]), u([i, "| "], L)];
        ...
        function o(b, B, k) {
          ...
          let Y = N(b, k, B, false, true), ie = M.returnType || M.predicate || M.typeAnnotation ? [Q ? " => " : ": ", k("returnType"), k("predicate"), k("typeAnnotation")] : "", ee = I(M, ie);
        ...
        function h(b, B, k) {
          ...
          return n(["[", p([L, P(b, B, R, k)]), y(J && F(B, "all") ? "," : ""), s(b, B, true), L, "]"]);
        }
        function C(b, B, k) {
        ...
        function I(f, T, m, v) {
          ...
          if (!Array.isArray(o[v]))
            return m(v);
          let h = f.getNode(2), C = h && d(h), x = f.match((k) => !(k[v].length === 1 && _(k[v][0])), void 0, (k, M) => M === "typeAnnotation", (k) => k.type === "Identifier", S);
          if (o[v].length === 0 || !x && (C || o[v].length === 1 && (o[v][0].type === "NullableTypeAnnotation" || F(o[v][0]))))
            return ["<", s(", ", f.map(m, v)), P(f, T), ">"];
          let B = o.type === "TSTypeParameterInstantiation" ? "" : E(o).length === 1 && c(T) && !o[v][0].constraint && f.getParentNode().type === "ArrowFunctionExpression" ? "," : D(T, "all") ? p(",") : "";
          return i(["<", l([u, s([",", a], f.map(m, v))]), B, u, ">"], { id: N(o) });
        }
        function P(f, T) {
          let m = f.getValue();
          if (!y(m, g.Dangling))
            return "";
          let v = !y(m, g.Line), o = t(f, T, v);
          return v ? o : [o, n];
        }
        function $(f, T, m) {
        ...
        r.exports = { printTypeParameter: $, printTypeParameters: I, getTypeParametersGroupId: N };
        ...
        function g(D, E, _) {
          ...
          if (w.computed)
            return ["[", _("key"), "]"];
          let F = D.getParentNode(), { key: S } = w;
          if (E.quoteProps === "consistent" && !y.has(F)) {
            let N = (F.properties || F.body || F.members).some((I) => !I.computed && I.key && i(I.key) && !l(I, E));
            y.set(F, N);
          }
          if ((S.type === "Identifier" || n(S) && u(a(p(S))) && String(S.value) === a(p(S)) && !(E.parser === "typescript" || E.parser === "babel-ts")) && (E.parser === "json" || E.quoteProps === "consistent" && y.get(F))) {
            let N = s(JSON.stringify(S.type === "Identifier" ? S.name : S.value.toString()), E);
            return D.call((I) => t(I, N, E), "key");
          }
          return l(w, E) && (E.quoteProps === "as-needed" || E.quoteProps === "consistent" && !y.get(F)) ? D.call((N) => t(N, /^\d/.test(S.value) ? a(S.value) : S.value, E), "key") : _("key");
        }
        function c(D, E, _) {
        ...
        "use strict";
        ne();
        var t = Zt(), { printDanglingComments: s, printCommentsSeparately: a } = et(), n = lt(), { getNextNonSpaceNonCommentCharacterIndex: u } = Ue(), { builders: { line: i, softline: l, group: p, indent: d, ifBreak: y, hardline: g, join: c, indentIfBreak: D }, utils: { removeLines: E, willBreak: _ } } = qe(), { ArgExpansionBailout: w } = Qt(), { getFunctionParameters: F, hasLeadingOwnLineComment: S, isFlowAnnotationComment: N, isJsxNode: I, isTemplateOnItsOwnLine: P, shouldPrintComma: $, startsWithNoLookaheadToken: f, isBinaryish: T, isLineComment: m, hasComment: v, getComments: o, CommentCheckFlags: h, isCallLikeExpression: C, isCallExpression: x, getCallArguments: b, hasNakedLeftSide: B, getLeftSide: k } = Ke(), { locEnd: M } = ut(), { printFunctionParameters: R, shouldGroupFunctionParameters: q } = Lr(), { printPropertyKey: J } = rr(), { printFunctionTypeParameters: L } = ct();
        function Q(U, Z, se, De) {
          let ge = U.getValue(), he = false;
          if ((ge.type === "FunctionDeclaration" || ge.type === "FunctionExpression") && De && De.expandLastArg) {
            let Pe = U.getParentNode();
            x(Pe) && b(Pe).length > 1 && (he = true);
          }
          let we = [];
        ...
        function V(U, Z, se) {
          let De = U.getNode(), { kind: ge } = De, he = De.value || De, we = [];
          return !ge || ge === "init" || ge === "method" || ge === "constructor" ? he.async && we.push("async ") : (t.ok(ge === "get" || ge === "set"), we.push(ge, " ")), he.generator && we.push("*"), we.push(J(U, Z, se), De.optional || De.key.optional ? "?" : ""), De === he ? we.push(j(U, Z, se)) : he.type === "FunctionExpression" ? we.push(U.call((ke) => j(ke, Z, se), "value")) : we.push(se("value")), we;
        }
        function j(U, Z, se) {
          let De = U.getNode(), ge = R(U, se, Z), he = K(U, se, Z), we = q(De, he), ke = [L(U, Z, se), p([we ? p(ge) : ge, he])];
          return De.body ? ke.push(" ", se("body")) : ke.push(Z.semi ? ";" : ""), ke;
        }
        function Y(U, Z, se, De) {
          let ge = U.getValue(), he = [];
          if (ge.async && he.push("async "), W(U, Z))
            he.push(se(["params", 0]));
          else {
            let ke = De && (De.expandLastArg || De.expandFirstArg), Re = K(U, se, Z);
            if (ke) {
              if (_(Re))
                throw new w();
              Re = p(E(Re));
        ...
        function ie(U, Z, se, De, ge, he) {
          let we = U.getName(), ke = U.getParentNode(), Re = C(ke) && we === "callee", Ne = Boolean(Z && Z.assignmentLayout), Pe = he.body.type !== "BlockStatement" && he.body.type !== "ObjectExpression" && he.body.type !== "SequenceExpression", oe = Re && Pe || Z && Z.assignmentLayout === "chain-tail-arrow-chain", H = Symbol("arrow-chain");
          return he.body.type === "SequenceExpression" && (ge = p(["(", d([l, ge]), l, ")"])), p([p(d([Re || Ne ? l : "", p(c([" =>", i], se), { shouldBreak: De })]), { id: H, shouldBreak: oe }), " =>", D(Pe ? d([i, ge]) : [" ", ge], { groupId: H }), Re ? y(l, "", { groupId: H }) : ""]);
        }
        function ee(U, Z, se, De) {
          ...
          if (function H() {
            ...
            if (he.length === 0)
              ...
              let { leading: X, trailing: pe } = a(U, Z);
              he.push([X, ce]), we.unshift(pe);
            }
            ke = ke || ge.returnType && F(ge).length > 0 || ge.typeParameters || F(ge).some((X) => X.type !== "Identifier"), ge.body.type !== "ArrowFunctionExpression" || De && De.expandLastArg ? we.unshift(se("body", De)) : (ge = ge.body, U.call(H, "body"));
          }(), he.length > 1)
            return ie(U, De, he, ke, we, ge);
          let Re = he;
          if (Re.push(" =>"), !S(Z.originalText, ge.body) && (ge.body.type === "ArrayExpression" || ge.body.type === "ObjectExpression" || ge.body.type === "BlockStatement" || I(ge.body) || P(ge.body, Z.originalText) || ge.body.type === "ArrowFunctionExpression" || ge.body.type === "DoExpression"))
            return p([...Re, " ", we]);
          if (ge.body.type === "SequenceExpression")
            return p([...Re, p([" (", d([l, we]), l, ")"])]);
          let Ne = (De && De.expandLastArg || U.getParentNode().type === "JSXExpressionContainer") && !v(ge), Pe = De && De.expandLastArg && $(Z, "all"), oe = ge.body.type === "ConditionalExpression" && !f(ge.body, (H) => H.type === "ObjectExpression");
          return p([...Re, p([d([i, oe ? y("", "(") : "", we, oe ? y("", ")") : ""]), Ne ? [y(Pe ? "," : ""), l] : ""])]);
        }
        function le(U) {
          let Z = F(U);
          return Z.length === 1 && !U.typeParameters && !v(U, h.Dangling) && Z[0].type === "Identifier" && !Z[0].typeAnnotation && !v(Z[0]) && !Z[0].optional && !U.predicate && !U.returnType;
        }
        function W(U, Z) {
        ...
        function K(U, Z, se) {
          let De = U.getValue(), ge = Z("returnType");
          if (De.returnType && N(se.originalText, De.returnType))
            return [" /*: ", ge, " */"];
          let he = [ge];
          return De.returnType && De.returnType.typeAnnotation && he.unshift(": "), De.predicate && he.push(De.returnType ? " " : ": ", Z("predicate")), he;
        }
        function de(U, Z, se) {
          let De = U.getValue(), ge = Z.semi ? ";" : "", he = [];
          De.argument && (z(Z, De.argument) ? he.push([" (", d([g, se("argument")]), g, ")"]) : T(De.argument) || De.argument.type === "SequenceExpression" ? he.push(p([y(" (", " "), d([l, se("argument")]), l, y(")")])) : he.push(" ", se("argument")));
          let we = o(De), ke = n(we), Re = ke && m(ke);
          return Re && he.push(ge), v(De, h.Dangling) && he.push(" ", s(U, Z, true)), Re || he.push(ge), he;
        }
        function ue(U, Z, se) {
        ...
        function z(U, Z) {
          if (S(U.originalText, Z))
            return true;
          if (B(Z)) {
            let se = Z, De;
            for (; De = k(se); )
              if (se = De, S(U.originalText, se))
                return true;
          }
          return false;
        }
        ...
        function g(w, F, S) {
          let N = w.getValue();
          return l([u(a, w.map(S, "decorators")), E(N, F) ? n : a]);
        }
        function c(w, F, S) {
          return [u(n, w.map(S, "declaration", "decorators")), n];
        }
        function D(w, F, S) {
          ...
          return [y(w) ? n : P ? i : "", u(a, w.map(S, "decorators")), a];
        }
        function E(w, F) {
          return w.decorators.some((S) => s(F.originalText, d(S)));
        }
        function _(w) {
        ...
        function $(b, B, k) {
          ...
          let q = M.id && c(M.id, D.Trailing) || M.typeParameters && c(M.typeParameters, D.Trailing) || M.superClass && c(M.superClass) || t(M.extends) || t(M.mixins) || t(M.implements), J = [], L = [];
          ...
          if (L.push(o(b, B, k, "mixins"), o(b, B, k, "implements")), q) {
            let Q;
            v(M) ? Q = [...J, y(L)] : Q = y([...J, L]), R.push(d(Q, { id: f(M) }));
          } else
            R.push(...J, ...L);
        ...
        function v(b) {
          return b.typeParameters && !c(b.typeParameters, D.Trailing | D.Line) && !m(b);
        }
        function o(b, B, k, M) {
          let R = b.getValue();
          if (!t(R[M]))
          ...
          return [v(R) ? g(" ", i, { groupId: E(R.typeParameters) }) : i, q, q && l, M, d(y([i, u([",", i], b.map(k, M))]))];
        }
        function h(b, B, k) {
          let M = k("superClass");
        ...
        function x(b, B, k) {
          ...
          return t(M.decorators) && R.push(P(b, B, k)), M.accessibility && R.push(M.accessibility + " "), M.declare && R.push("declare "), M.static && R.push("static "), (M.type === "TSAbstractPropertyDefinition" || M.type === "TSAbstractAccessorProperty" || M.abstract) && R.push("abstract "), M.override && R.push("override "), M.readonly && R.push("readonly "), M.variance && R.push(k("variance")), (M.type === "ClassAccessorProperty" || M.type === "AccessorProperty" || M.type === "TSAbstractAccessorProperty") && R.push("accessor "), R.push(N(b, B, k), w(b), S(b), F(b, B, k)), [I(b, B, k, R, " =", "value"), q];
        }
        r.exports = { printClass: $, printClassMethod: C, printClassProperty: x, printHardlineAfterHeritage: T };
      } }), bo = te({ "src/language-js/print/interface.js"(e, r) {
        "use strict";
        ne();
        var { isNonEmptyArray: t } = Ue(), { builders: { join: s, line: a, group: n, indent: u, ifBreak: i } } = qe(), { hasComment: l, identity: p, CommentCheckFlags: d } = Ke(), { getTypeParametersGroupId: y } = jr(), { printTypeScriptModifiers: g } = ct();
        function c(D, E, _) {
          let w = D.getValue(), F = [];
          w.declare && F.push("declare "), w.type === "TSInterfaceDeclaration" && F.push(w.abstract ? "abstract " : "", g(D, E, _)), F.push("interface");
          let S = [], N = [];
          w.type !== "InterfaceTypeAnnotation" && S.push(" ", _("id"), _("typeParameters"));
          let I = w.typeParameters && !l(w.typeParameters, d.Trailing | d.Line);
          return t(w.extends) && N.push(I ? i(" ", a, { groupId: y(w.typeParameters) }) : a, "extends ", (w.extends.length === 1 ? p : u)(s([",", a], D.map(_, "extends")))), w.id && l(w.id, d.Trailing) || t(w.extends) ? I ? F.push(n([...S, u(N)])) : F.push(n(u([...S, ...N]))) : F.push(...S, ...N), F.push(" ", _("body")), n(F);
        }
        r.exports = { printInterface: c };
      } }), To = te({ "src/language-js/print/module.js"(e, r) {
        "use strict";
        ne();
        var { isNonEmptyArray: t } = Ue(), { builders: { softline: s, group: a, indent: n, join: u, line: i, ifBreak: l, hardline: p } } = qe(), { printDanglingComments: d } = et(), { hasComment: y, CommentCheckFlags: g, shouldPrintComma: c, needsHardlineAfterDanglingComment: D, isStringLiteral: E, rawText: _ } = Ke(), { locStart: w, hasSameLoc: F } = ut(), { hasDecoratorsBeforeExport: S, printDecoratorsBeforeExport: N } = nu();
        function I(x, b, B) {
          let k = x.getValue(), M = b.semi ? ";" : "", R = [], { importKind: q } = k;
          return R.push("import"), q && q !== "value" && R.push(" ", q), R.push(m(x, b, B), T(x, b, B), o(x, b, B), M), R;
        }
        function P(x, b, B) {
          let k = x.getValue(), M = [];
          S(k) && M.push(N(x, b, B));
          let { type: R, exportKind: q, declaration: J } = k;
          return M.push("export"), (k.default || R === "ExportDefaultDeclaration") && M.push(" default"), y(k, g.Dangling) && (M.push(" ", d(x, b, true)), D(k) && M.push(p)), J ? M.push(" ", B("declaration")) : M.push(q === "type" ? " type" : "", m(x, b, B), T(x, b, B), o(x, b, B)), f(k, b) && M.push(";"), M;
        }
        function $(x, b, B) {
          let k = x.getValue(), M = b.semi ? ";" : "", R = [], { exportKind: q, exported: J } = k;
          return R.push("export"), q === "type" && R.push(" type"), R.push(" *"), J && R.push(" as ", B("exported")), R.push(T(x, b, B), o(x, b, B), M), R;
        }
        function f(x, b) {
          if (!b.semi)
            return false;
          let { type: B, declaration: k } = x, M = x.default || B === "ExportDefaultDeclaration";
          if (!k)
            return true;
          let { type: R } = k;
        ...
        function T(x, b, B) {
          ...
          if (!k.source)
            return "";
          let M = [];
          return v(k, b) || M.push(" from"), M.push(" ", B("source")), M;
        }
        function m(x, b, B) {
          let k = x.getValue();
          if (v(k, b))
        ...
        function v(x, b) {
          let { type: B, importKind: k, source: M, specifiers: R } = x;
          return B !== "ImportDeclaration" || t(R) || k === "type" ? false : !/{\s*}/.test(b.originalText.slice(w(x), w(M)));
        }
        function o(x, b, B) {
          let k = x.getNode();
          return t(k.assertions) ? [" assert {", b.bracketSpacing ? " " : "", u(", ", x.map(B, "assertions")), b.bracketSpacing ? " " : "", "}"] : "";
        }
        function h(x, b, B) {
          let k = x.getNode(), { type: M } = k, R = [], q = M === "ImportSpecifier" ? k.importKind : k.exportKind;
          q && q !== "value" && R.push(q, " ");
          let J = M.startsWith("Import"), L = J ? "imported" : "local", Q = J ? "local" : "exported", V = k[L], j = k[Q], Y = "", ie = "";
          return M === "ExportNamespaceSpecifier" || M === "ImportNamespaceSpecifier" ? Y = "*" : V && (Y = B(L)), j && !C(k) && (ie = B(Q)), R.push(Y, Y && ie ? " as " : "", ie), R;
        }
        function C(x) {
          if (x.type !== "ImportSpecifier" && x.type !== "ExportSpecifier")
            return false;
          let { local: b, [x.type === "ImportSpecifier" ? "imported" : "exported"]: B } = x;
        ...
        function T(m, v, o) {
          ...
          let j = [], Y = V.map((W) => {
            let K = [...j, n(W.printed)];
            return j = [J, s], (W.node.type === "TSPropertySignature" || W.node.type === "TSMethodSignature" || W.node.type === "TSConstructSignatureDeclaration") && D(W.node, _.PrettierIgnore) && j.shift(), w(W.node, v) && j.push(l), K;
          });
          if (C.inexact) {
            let W;
            if (D(C, _.Dangling)) {
              let K = D(C, _.Line);
              W = [t(m, v, true), K || y(v.originalText, S(p(E(C)))) ? l : s, "..."];
            } else
              W = ["..."];
            Y.push([...j, ...W]);
          }
          let ie = p(C[x]), ee = !(C.inexact || ie && ie.type === "RestElement" || ie && (ie.type === "TSPropertySignature" || ie.type === "TSCallSignatureDeclaration" || ie.type === "TSMethodSignature" || ie.type === "TSConstructSignatureDeclaration") && D(ie, _.PrettierIgnore)), le;
          if (Y.length === 0) {
            if (!D(C, _.Dangling))
              return [L, Q, I(m, v, o)];
            le = n([L, t(m, v), a, Q, N(m), I(m, v, o)]);
          } else
            le = [R && g(C.properties) ? f(M) : "", L, u([v.bracketSpacing ? s : a, ...Y]), i(ee && (J !== "," || c(v)) ? J : ""), v.bracketSpacing ? s : a, Q, N(m), I(m, v, o)];
          return m.match((W) => W.type === "ObjectPattern" && !W.decorators, (W, K, de) => P(W) && (K === "params" || K === "parameters" || K === "this" || K === "rest") && de === 0) || m.match($, (W, K) => K === "typeAnnotation", (W, K) => K === "typeAnnotation", (W, K, de) => P(W) && (K === "params" || K === "parameters" || K === "this" || K === "rest") && de === 0) || !q && m.match((W) => W.type === "ObjectPattern", (W) => W.type === "AssignmentExpression" || W.type === "VariableDeclarator") ? le : n(le, { shouldBreak: q });
        }
        r.exports = { printObject: T };
      } }), md = te({ "src/language-js/print/flow.js"(e, r) {
        "use strict";
        ne();
          ...
          switch (j.type) {
            ...
            case "EnumSymbolBody": {
              ...
              if (j.members.length === 0 && !j.hasUnknownMembers)
                ...
                let ee = j.members.length > 0 ? [u, x(L, Q, "members", V), j.hasUnknownMembers || D(Q) ? "," : ""] : [];
            ...
            case "TypeParameterInstantiation": {
              ...
              if (Q.parser === "flow") {
                let le = E(j), W = _(j), K = Q.originalText.lastIndexOf("/*", le), de = Q.originalText.indexOf("*/", W);
                if (K !== -1 && de !== -1) {
      ...
      } }), dd = te({ "src/language-js/utils/is-ts-keyword-type.js"(e, r) {
        "use strict";
        ne();
        function t(s) {
          let { type: a } = s;
        ...
        "use strict";
        ne();
        var { hasNewlineInRange: t } = Ue(), { isJsxNode: s, getComments: a, isCallExpression: n, isMemberExpression: u, isTSTypeExpression: i } = Ke(), { locStart: l, locEnd: p } = ut(), d = Ot(), { builders: { line: y, softline: g, group: c, indent: D, align: E, ifBreak: _, dedent: w, breakParent: F } } = qe();
        function S(f) {
          let T = [f];
        ...
        function N(f, T, m) {
          let v = f.getValue(), o = v.type === "ConditionalExpression", h = o ? "alternate" : "falseType", C = f.getParentNode(), x = o ? m("test") : [m("checkType"), " ", "extends", " ", m("extendsType")];
          return C.type === v.type && C[h] === v ? E(2, x) : x;
        }
        ...
        function P(f) {
          ...
          return v === T ? false : m[I.get(m.type)] === v;
        }
        function $(f, T, m) {
          let v = f.getValue(), o = v.type === "ConditionalExpression", h = o ? "consequent" : "trueType", C = o ? "alternate" : "falseType", x = o ? ["test"] : ["checkType", "extendsType"], b = v[h], B = v[C], k = [], M = false, R = f.getParentNode(), q = R.type === v.type && x.some((ue) => R[ue] === v), J = R.type === v.type && !q, L, Q, V = 0;
          do
            Q = L || v, L = f.getParentNode(V), V++;
          while (L && L.type === v.type && x.every((ue) => L[ue] !== Q));
          let j = L || R, Y = Q;
          if (o && (s(v[x[0]]) || s(b) || s(B) || S(Y))) {
            M = true, J = true;
            let ue = (z) => [_("("), D([g, z]), g, _(")")], Fe = (z) => z.type === "NullLiteral" || z.type === "Literal" && z.value === null || z.type === "Identifier" && z.name === "undefined";
            k.push(" ? ", Fe(b) ? m(h) : ue(m(h)), " : ", B.type === v.type || Fe(B) ? m(C) : ue(m(C)));
          } else {
            let ue = [y, "? ", b.type === v.type ? _("", "(") : "", E(2, m(h)), b.type === v.type ? _("", ")") : "", y, ": ", B.type === v.type ? m(C) : E(2, m(C))];
            k.push(R.type !== v.type || R[C] === v || q ? ue : T.useTabs ? w(D(ue)) : E(Math.max(0, T.tabWidth - 2), ue));
          }
          let ee = [...x.map((ue) => a(v[ue])), a(b), a(B)].flat().some((ue) => d(ue) && t(T.originalText, l(ue), p(ue))), le = (ue) => R === j ? c(ue, { shouldBreak: ee }) : ee ? [ue, F] : ue, W = !M && (u(R) || R.type === "NGPipeExpression" && R.left === v) && !R.computed, K = P(f), de = le([N(f, T, m), J ? k : D(k), o && W && !K ? g : ""]);
          return q || K ? c([D([g, de]), g]) : de;
        }
        r.exports = { printTernary: $ };
      } }), No = te({ "src/language-js/print/statement.js"(e, r) {
        "use strict";
        ne();
        var { builders: { hardline: t } } = qe(), s = qt(), { getLeftSidePathName: a, hasNakedLeftSide: n, isJsxNode: u, isTheOnlyJsxElementInMarkdown: i, hasComment: l, CommentCheckFlags: p, isNextLineEmpty: d } = Ke(), { shouldPrintParamsWithoutParens: y } = qr();
        function g(N, I, P, $) {
          let f = N.getValue(), T = [], m = f.type === "ClassBody", v = c(f[$]);
          return N.each((o, h, C) => {
            let x = o.getValue();
            if (x.type === "EmptyStatement")
              return;
            let b = P();
            !I.semi && !m && !i(I, o) && D(o, I) ? l(x, p.Leading) ? T.push(P([], { needsSemi: true })) : T.push(";", b) : T.push(b), !I.semi && m && F(x) && S(x, C[h + 1]) && T.push(";"), x !== v && (T.push(t), d(x, I) && T.push(t));
          }, $), T;
        }
        function c(N) {
        ...
        function D(N, I) {
          return N.getNode().type !== "ExpressionStatement" ? false : N.call(($) => E($, I), "expression");
        }
        function E(N, I) {
          let P = N.getValue();
          switch (P.type) {
          ...
          return s(N, I) ? true : n(P) ? N.call(($) => E($, I), ...a(N, P)) : false;
        }
        function _(N, I, P) {
          return g(N, I, P, "body");
        }
        ...
        function S(N, I) {
          let { type: P, name: $ } = N.key;
          if (!N.computed && P === "Identifier" && ($ === "static" || $ === "get" || $ === "set" || $ === "accessor") && !N.value && !N.typeAnnotation)
            return true;
        ...
        "use strict";
        ne();
        var { printDanglingComments: t } = et(), { isNonEmptyArray: s } = Ue(), { builders: { hardline: a, indent: n } } = qe(), { hasComment: u, CommentCheckFlags: i, isNextLineEmpty: l } = Ke(), { printHardlineAfterHeritage: p } = nr(), { printBody: d } = No();
        function y(c, D, E) {
          let _ = c.getValue(), w = [];
          if (_.type === "StaticBlock" && w.push("static "), _.type === "ClassBody" && s(_.body)) {
            let S = c.getParentNode();
            w.push(p(S));
          }
          w.push("{");
          let F = g(c, D, E);
          if (F)
            ...
            let S = c.getParentNode(), N = c.getParentNode(1);
        ...
        function g(c, D, E) {
          let _ = c.getValue(), w = s(_.directives), F = _.body.some((I) => I.type !== "EmptyStatement"), S = u(_, i.Dangling);
          if (!w && !F && !S)
            return "";
          let N = [];
          if (w && c.each((I, P, $) => {
            N.push(E()), (P < $.length - 1 || F || S) && (N.push(a), l(I.getValue(), D) && N.push(a));
          }, "directives"), F && N.push(d(c, D, E)), S && N.push(t(c, D, true)), _.type === "Program") {
      ...
      } }), gd = te({ "src/language-js/print/typescript.js"(e, r) {
        "use strict";
        ne();
        ...
        function ie(ee, le, W) {
          ...
          switch (K.type) {
            ...
            case "TSAsExpression": {
              ...
              return E(z) && z.callee === K || _(z) && z.object === K ? l([p([i, ...ue]), i]) : ue;
            }
            case "TSArrayType":
              return [W("elementType"), "[]"];
            case "TSPropertySignature":
              return K.readonly && ue.push("readonly "), ue.push(b(ee, le, W), N(ee)), K.typeAnnotation && ue.push(": ", W("typeAnnotation")), K.initializer && ue.push(" = ", W("initializer")), ue;
            ...
            case "TSIndexSignature": {
              let Fe = ee.getParentNode(), z = K.parameters.length > 1 ? y(D(le) ? "," : "") : "", U = l([p([i, a([", ", i], ee.map(W, "parameters"))]), z, i]);
            ...
            case "TSNonNullExpression":
              return [W("expression"), "!"];
            case "TSImportType":
              return [K.isTypeOf ? "typeof " : "", "import(", W(K.parameter ? "parameter" : "argument"), ")", K.qualifier ? [".", W("qualifier")] : "", x(ee, le, W, "typeParameters")];
            case "TSLiteralType":
              return W("literal");
            ...
            case "TSConstructorType": {
              if (K.type === "TSConstructorType" && K.abstract && ue.push("abstract "), K.type !== "TSCallSignatureDeclaration" && ue.push("new "), ue.push(l($(ee, W, le, false, true))), K.returnType || K.typeAnnotation) {
            ...
            case "TSMappedType": {
              let Fe = s(le.originalText, F(K), S(K));
              return l(["{", p([le.bracketSpacing ? n : i, K.readonly ? [c(K.readonly, "readonly"), " "] : "", I(ee, le, W), W("typeParameter"), K.optional ? c(K.optional, "?") : "", K.typeAnnotation ? ": " : "", W("typeAnnotation"), y(de)]), t(ee, le, true), le.bracketSpacing ? n : i, "}"], { shouldBreak: Fe });
            }
            case "TSMethodSignature": {
              let Fe = K.kind && K.kind !== "method" ? `${K.kind} ` : "";
              ue.push(K.accessibility ? [K.accessibility, " "] : "", Fe, K.export ? "export " : "", K.static ? "static " : "", K.readonly ? "readonly " : "", K.abstract ? "abstract " : "", K.declare ? "declare " : "", K.computed ? "[" : "", W("key"), K.computed ? "]" : "", N(ee));
              let z = $(ee, W, le, false, true), U = K.returnType ? "returnType" : "typeAnnotation", Z = K[U], se = Z ? W(U) : "", De = f(K, se);
              return ue.push(De ? l(z) : z), Z && ue.push(": ", l(se)), l(ue);
            }
            case "TSNamespaceExportDeclaration":
              return ue.push("export as namespace ", W("id")), le.semi && ue.push(";"), l(ue);
            case "TSEnumDeclaration":
              return K.declare && ue.push("declare "), K.modifiers && ue.push(I(ee, le, W)), K.const && ue.push("const "), ue.push("enum ", W("id"), " "), K.members.length === 0 ? ue.push(l(["{", t(ee, le), i, "}"])) : ue.push(l(["{", p([u, m(ee, le, "members", W), D(le, "es5") ? "," : ""]), t(ee, le, true), u, "}"])), ue;
            case "TSEnumMember":
              return K.computed ? ue.push("[", W("id"), "]") : ue.push(W("id")), K.initializer && ue.push(" = ", W("initializer")), ue;
            case "TSImportEqualsDeclaration":
              return K.isExport && ue.push("export "), ue.push("import "), K.importKind && K.importKind !== "value" && ue.push(K.importKind, " "), ue.push(W("id"), " = ", W("moduleReference")), le.semi && ue.push(";"), l(ue);
            ...
            case "TSModuleDeclaration": {
              ...
              if (U)
                ...
                K.declare && ue.push("declare "), ue.push(I(ee, le, W));
                let se = le.originalText.slice(F(K), F(K.id));
            ...
            case "TSTypeReference":
              return [W("typeName"), x(ee, le, W, "typeParameters")];
      ...
      } }), yd = te({ "src/language-js/print/comment.js"(e, r) {
        "use strict";
        ne();
        var { hasNewline: t } = Ue(), { builders: { join: s, hardline: a }, utils: { replaceTextEndOfLine: n } } = qe(), { isLineComment: u } = Ke(), { locStart: i, locEnd: l } = ut(), p = Ot();
        function d(c, D) {
          let E = c.getValue();
          if (u(E))
...
`);
      ...
      } }), hd = te({ "src/language-js/print/literal.js"(e, r) {
        "use strict";
        ne();
        ...
        function G(Ee, Be, ve, ze) {
          ...
          if (Se === "ClassMethod" || Se === "ClassPrivateMethod" || Se === "ClassProperty" || Se === "ClassAccessorProperty" || Se === "AccessorProperty" || Se === "TSAbstractAccessorProperty" || Se === "PropertyDefinition" || Se === "TSAbstractPropertyDefinition" || Se === "ClassPrivateProperty" || Se === "MethodDefinition" || Se === "TSAbstractMethodDefinition" || Se === "TSDeclareMethod")
            return be;
          let Ie = [be], Oe = A(Ee, Be, ve), Je = Ye.type === "ClassExpression" && Oe;
          if (Oe && (Ie = [...Oe, be], !Je))
            return l(Ie);
          if (!E(Ee, Be))
        ...
        function re(Ee, Be, ve, ze) {
          let be = Ee.getValue(), Ye = Be.semi ? ";" : "";
          if (!be)
            return "";
          if (typeof be == "string")
            return be;
          for (let Ie of [fe, x, B, k, R, q]) {
            let Oe = Ie(Ee, Be, ve);
            if (typeof Oe < "u")
              return Oe;
          }
          ...
          switch (be.type) {
            ...
            case "ExpressionStatement": {
              if (Be.parser === "__vue_event_binding" || Be.parser === "__vue_ts_event_binding") {
                let Oe = Ee.getParentNode();
                if (Oe.type === "Program" && Oe.body.length === 1 && Oe.body[0] === be)
                  return [ve("expression"), b(be.expression) ? ";" : ""];
              }
              let Ie = t(Ee, Be, true, (Oe) => {
                let { marker: Je } = Oe;
                return Je === v;
              });
              return [ve("expression"), N(Be, Ee) ? "" : Ye, Ie ? [" ", Ie] : ""];
            }
            case "ParenthesizedExpression":
              return !F(be.expression) && (be.expression.type === "ObjectExpression" || be.expression.type === "ArrayExpression") ? ["(", ve("expression"), ")"] : l(["(", p([i, ve("expression")]), i, ")"]);
            case "AssignmentExpression":
              return oe(Ee, Be, ve);
            ...
            case "BindExpression":
              return be.object && Se.push(ve("object")), Se.push(l(p([i, L(Ee, Be, ve)]))), Se;
            case "Identifier":
              return [be.name, J(Ee), Y(Ee), Q(Ee, Be, ve)];
            ...
            case "ObjectProperty":
            case "Property":
              return be.method || be.kind === "get" || be.kind === "set" ? we(Ee, Be, ve) : De(Ee, Be, ve);
            case "ObjectMethod":
              return we(Ee, Be, ve);
            case "Decorator":
            ...
            case "UnaryExpression":
              return Se.push(be.operator), /[a-z]$/.test(be.operator) && Se.push(" "), F(be.argument) ? Se.push(l(["(", p([i, ve("argument")]), i, ")"])) : Se.push(ve("argument")), Se;
            case "UpdateExpression":
              return Se.push(ve("argument"), be.operator), be.prefix && Se.reverse(), Se;
            case "ConditionalExpression":
              return de(Ee, Be, ve);
            case "VariableDeclaration": {
              let Ie = Ee.map(ve, "declarations"), Oe = Ee.getParentNode(), Je = Oe.type === "ForStatement" || Oe.type === "ForInStatement" || Oe.type === "ForOfStatement", Te = be.declarations.some((Me) => Me.init), je;
              return Ie.length === 1 && !F(be.declarations[0]) ? je = Ie[0] : Ie.length > 0 && (je = p(Ie[0])), Se = [be.declare ? "declare " : "", be.kind, je ? [" ", je] : "", p(Ie.slice(1).map((Me) => [",", Te && !Je ? u : n, Me]))], Je && Oe.body !== be || Se.push(Ye), l(Se);
            }
            case "WithStatement":
            ...
            case "IfStatement": {
              ...
              if (Se.push(Oe), be.alternate) {
                let Je = F(be.consequent, S.Trailing | S.Line) || $(be), Te = be.consequent.type === "BlockStatement" && !Je;
                Se.push(Te ? " " : u), F(be, S.Dangling) && Se.push(t(Ee, Be, true), Je ? u : " "), Se.push("else", l(V(be.alternate, ve("alternate"), be.alternate.type === "IfStatement")));
              }
              return Se;
            }
            case "ForStatement": {
              let Ie = V(be.body, ve("body")), Oe = t(Ee, Be, true), Je = Oe ? [Oe, i] : "";
            ...
            case "CatchClause":
              if (be.param) {
                let Ie = F(be.param, (Je) => !C(Je) || Je.leading && s(Be.originalText, h(Je)) || Je.trailing && s(Be.originalText, o(Je), { backwards: true })), Oe = ve("param");
                return ["catch ", Ie ? ["(", p([i, Oe]), i, ") "] : ["(", Oe, ") "], ve("body")];
              }
              return ["catch ", ve("body")];
            case "SwitchStatement":
              return [l(["switch (", p([i, ve("discriminant")]), i, ")"]), " {", be.cases.length > 0 ? p([u, a(u, Ee.map((Ie, Oe, Je) => {
                let Te = Ie.getValue();
                return [ve(), Oe !== Je.length - 1 && P(Te, Be) ? u : ""];
              }, "cases"))]) : "", u, "}"];
            case "SwitchCase": {
              be.test ? Se.push("case ", ve("test"), ":") : Se.push("default:"), F(be, S.Dangling) && Se.push(" ", t(Ee, Be, true));
        ...
        function ye(Ee) {
          return Ee.type && !C(Ee) && !I(Ee) && Ee.type !== "EmptyStatement" && Ee.type !== "TemplateElement" && Ee.type !== "Import" && Ee.type !== "TSEmptyBodyFunctionExpression";
        }
        r.exports = { preprocess: _, print: G, embed: y, insertPragma: c, massageAstNode: g, hasPrettierIgnore(Ee) {
          return f(Ee) || M(Ee);
        }, willPrintOwnComments: D.willPrintOwnComments, canAttachComment: ye, printComment: Ce, isBlockComment: C, handleComments: { avoidAstMutation: true, ownLine: D.handleOwnLineComment, endOfLine: D.handleEndOfLineComment, remaining: D.handleRemainingComment }, getCommentChildNodes: D.getCommentChildNodes };
      } }), Cd = te({ "src/language-js/printer-estree-json.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), Ed = te({ "src/language-js/options.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), Fd = te({ "src/language-js/parse/parsers.js"() {
        ne();
      ...
      } }), Ad = te({ "node_modules/linguist-languages/data/TypeScript.json"(e, r) {
      ...
      } }), Sd = te({ "node_modules/linguist-languages/data/TSX.json"(e, r) {
      ...
      } }), xd = te({ "node_modules/linguist-languages/data/JSON with Comments.json"(e, r) {
      ...
      } }), bd = te({ "node_modules/linguist-languages/data/JSON5.json"(e, r) {
      ...
      } }), Td = te({ "src/language-js/index.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), Bd = te({ "src/language-css/clean.js"(e, r) {
        "use strict";
        ne();
        ...
        r.exports = a;
      } }), Nd = te({ "src/language-css/embed.js"(e, r) {
        "use strict";
        ne();
        ...
        r.exports = s;
      } }), wd = te({ "src/language-css/pragma.js"(e, r) {
        "use strict";
        ne();
        var t = Co(), s = _o();
        function a(u) {
...
` : "") + t.insertPragma(l);
      ...
      } }), _d = te({ "src/language-css/utils/index.js"(e, r) {
        "use strict";
        ne();
        ...
        function s(z, U) {
          let Z = Array.isArray(U) ? U : [U], se = -1, De;
          for (; De = z.getParentNode(++se); )
            if (Z.includes(De.type))
              return se;
          return -1;
        }
        function a(z, U) {
        ...
        function J(z) {
          ...
          if (!q(Z) && !(se && q(se)))
            return false;
          let De = a(z, "css-decl");
          return !!(De != null && (U = De.prop) !== null && U !== void 0 && U.startsWith("$") || q(se) || se.type === "value-func");
        }
        function L(z) {
        ...
        function ue(z, U) {
          var Z, se;
          if (((Z = z.open) === null || Z === void 0 ? void 0 : Z.value) !== "(" || ((se = z.close) === null || se === void 0 ? void 0 : se.value) !== ")" || z.groups.some((De) => De.type !== "value-comma_group"))
            return false;
          if (U.type === "value-comma_group") {
            let De = U.groups.indexOf(z) - 1, ge = U.groups[De];
...
`, a) + 1;
      ...
      } }), Id = te({ "src/language-css/loc.js"(e, r) {
        "use strict";
        ne();
          ...
          for (let S = 0; S < c.length; S++) {
            ...
            switch (D) {
              case "initial":
                ...
                if ((N === "u" || N === "U") && c.slice(S, S + 4).toLowerCase() === "url(") {
                  D = "url", S += 3;
                  continue;
                }
                if (N === "*" && c[S - 1] === "/") {
                ...
                if (N === "/" && c[S - 1] === "/") {
                  D = "comment-inline", _ = S - 1;
                  continue;
                }
                continue;
              case "single-quotes":
                if (N === "'" && c[S - 1] !== "\\" && (D = E, E = "initial"), N === `
` || N === "\r")
                  return c;
                continue;
              case "double-quotes":
...
` || N === "\r")
              ...
              case "comment-inline":
                (N === '"' || N === "'" || N === "*") && (w = true), (N === `
` || N === "\r") && (w && F.push([_, S]), D = "initial", w = false);
                continue;
            }
          }
          for (let [S, N] of F)
            c = c.slice(0, S) + c.slice(S, N).replace(/["'*]/g, " ") + c.slice(N);
          return c;
        }
        function y(c) {
      ...
      } }), kd = te({ "src/language-css/utils/is-less-parser.js"(e, r) {
        "use strict";
        ne();
        function t(s) {
        ...
        r.exports = t;
      } }), Ld = te({ "src/language-css/utils/is-scss.js"(e, r) {
        "use strict";
        ne();
        function t(s, a) {
        ...
        r.exports = t;
      } }), Od = te({ "src/language-css/utils/css-units.evaluate.js"(e, r) {
      ...
      } }), jd = te({ "src/language-css/utils/print-unit.js"(e, r) {
        "use strict";
        ne();
        var t = Od();
        function s(a) {
        ...
        function ye(Te, je, Me) {
          ...
          switch (ae.type) {
            case "front-matter":
              return [ae.raw, y];
            case "css-root": {
              let Ve = Ee(Te, je, Me), We = ae.raws.after.trim();
              return We.startsWith(";") && (We = We.slice(1).trim()), [Ve, We ? ` ${We}` : "", N(Ve).length > 0 ? y : ""];
            }
            case "css-comment": {
              let Ve = ae.inline || ae.raws.inline, We = je.originalText.slice(Ae(ae), Ce(ae));
              return Ve ? We.trimEnd() : We;
            }
            case "css-rule":
              return [Me("selector"), ae.important ? " !important" : "", ae.nodes ? [ae.selector && ae.selector.type === "selector-unknown" && H(ae.selector.value) ? d : " ", "{", ae.nodes.length > 0 ? E([y, Ee(Te, je, Me)]) : "", y, "}", M(ae) ? ";" : ""] : ";"];
            case "css-decl": {
              let Ve = Te.getParentNode(), { between: We } = ae.raws, Xe = We.trim(), st = Xe === ":", O = W(ae) ? S(Me("value")) : Me("value");
              return !st && H(Xe) && (O = E([y, _(O)])), [ae.raws.before.replace(/[\s;]/g, ""), Ve.type === "css-atrule" && Ve.variable || o(Te) ? ae.prop : m(ae.prop), Xe.startsWith("//") ? " " : "", Xe, ae.extend ? "" : " ", fe(je) && ae.extend && ae.selector ? ["extend(", Me("selector"), ")"] : "", O, ae.raws.important ? ae.raws.important.replace(/\s*!\s*important/i, " !important") : ae.important ? " !important" : "", ae.raws.scssDefault ? ae.raws.scssDefault.replace(/\s*!default/i, " !default") : ae.scssDefault ? " !default" : "", ae.raws.scssGlobal ? ae.raws.scssGlobal.replace(/\s*!global/i, " !global") : ae.scssGlobal ? " !global" : "", ae.nodes ? [" {", E([g, Ee(Te, je, Me)]), g, "}"] : Z(ae) && !Ve.raws.semicolon && je.originalText[Ce(ae) - 1] !== ";" ? "" : je.__isHTMLStyleAttribute && B(Te, ae) ? w(";") : ";"];
            }
            case "css-atrule": {
              let Ve = Te.getParentNode(), We = U(ae) && !Ve.raws.semicolon && je.originalText[Ce(ae) - 1] !== ";";
              if (fe(je)) {
                if (ae.mixin)
                ...
                if (ae.variable)
                  return ["@", ae.name, ": ", ae.value ? Me("value") : "", ae.raws.between.trim() ? ae.raws.between.trim() + " " : "", ae.nodes ? ["{", E([ae.nodes.length > 0 ? g : "", Ee(Te, je, Me)]), g, "}"] : "", We ? "" : ";"];
              }
              return ["@", z(ae) || ae.name.endsWith(":") ? ae.name : m(ae.name), ae.params ? [z(ae) ? "" : U(ae) ? ae.raws.afterName === "" ? "" : ae.name.endsWith(":") ? " " : /^\s*\n\s*\n/.test(ae.raws.afterName) ? [y, y] : /^\s*\n/.test(ae.raws.afterName) ? y : " " : " ", Me("params")] : "", ae.selector ? E([" ", Me("selector")]) : "", ae.value ? c([" ", Me("value"), k(ae) ? K(ae) ? " " : d : ""]) : ae.name === "else" ? " " : "", ae.nodes ? [k(ae) ? "" : ae.selector && !ae.selector.nodes && typeof ae.selector.value == "string" && H(ae.selector.value) || !ae.selector && typeof ae.params == "string" && H(ae.params) ? d : " ", "{", E([ae.nodes.length > 0 ? g : "", Ee(Te, je, Me)]), g, "}"] : We ? "" : ";"];
            }
            ...
            case "media-unknown":
              return ae.value;
            case "selector-root":
              return c([h(Te, "custom-selector") ? [f(Te, "css-atrule").customSelector, d] : "", p([",", h(Te, ["extend", "custom-selector", "nest"]) ? d : y], Te.map(Me, "nodes"))]);
            case "selector-selector":
              return c(E(Te.map(Me, "nodes")));
            ...
            case "selector-tag": {
              ...
              return [ae.namespace ? [ae.namespace === true ? "" : ae.namespace.trim(), "|"] : "", Xe.type === "selector-nesting" ? ae.value : Oe(x(Te, ae.value) ? ae.value.toLowerCase() : ae.value)];
            }
            case "selector-id":
              return ["#", ae.value];
            case "selector-class":
            ...
            case "selector-combinator": {
              if (ae.value === "+" || ae.value === ">" || ae.value === "~" || ae.value === ">>>") {
                ...
                return [Xe.type === "selector-selector" && Xe.nodes[0] === ae ? "" : d, ae.value, B(Te, ae) ? "" : " "];
              }
            ...
            case "selector-pseudo":
              return [m(ae.value), l(ae.nodes) ? c(["(", E([g, p([",", d], Te.map(Me, "nodes"))]), g, ")"]) : ""];
            case "selector-nesting":
              return ae.value;
            case "selector-unknown": {
              let Ve = f(Te, "css-rule");
              ...
              if (We.type === "value-paren_group" && Xe && Xe.type === "value-func" && Xe.value === "selector") {
                let st = Ce(We.open) + 1, O = Ae(We.close), me = je.originalText.slice(st, O).trim();
                return H(me) ? [F, me] : me;
              }
              return ae.value;
            }
            ...
            case "value-root":
              return Me("group");
            case "value-comment":
              return je.originalText.slice(Ae(ae), Ce(ae));
            case "value-comma_group": {
              let Ve = Te.getParentNode(), We = Te.getParentNode(1), Xe = T(Te), st = Xe && Ve.type === "value-value" && (Xe === "grid" || Xe.startsWith("grid-template")), O = f(Te, "css-atrule"), me = O && k(O), _e = ae.groups.some((at) => ge(at)), He = Te.map(Me, "groups"), Ge = [], it = v(Te, "url"), Qe = false, rt = false;
              for (let at = 0; at < ae.groups.length; ++at) {
                ...
                if (h(Te, "forward") && Le.type === "value-word" && Le.value && Ze !== void 0 && Ze.type === "value-word" && Ze.value === "as" && $e.type === "value-operator" && $e.value === "*" || !$e || Le.type === "value-word" && Le.value.endsWith("-") && ce($e))
                  continue;
                ...
                if (Qe || Ne(Le) || Ne($e) || Le.type === "value-atword" && (Le.value === "" || Le.value.endsWith("[")) || $e.type === "value-word" && $e.value.startsWith("]") || Le.value === "~" || Le.value && Le.value.includes("\\") && $e && $e.type !== "value-comment" || Ze && Ze.value && Ze.value.indexOf("\\") === Ze.value.length - 1 && Le.type === "value-operator" && Le.value === "/" || Le.value === "\\" || se(Le, $e) || he(Le) || we(Le) || ke($e) || we($e) && de($e) || ke(Le) && de($e) || Le.value === "--" && he($e))
                  continue;
                let Rr = j(Le), ou = j($e);
                if ((Rr && he($e) || ou && ke(Le)) && de($e) || !Ze && L(Le) || v(Te, "calc") && (Q(Le) || Q($e) || V(Le) || V($e)) && de($e))
                  continue;
                ...
                if (!(!(J($e) || J(Le)) && !v(Te, "calc") && !qo && (L($e) && !lu || L(Le) && !cu || Q($e) && !lu || Q(Le) && !cu || V($e) || V(Le)) && (de($e) || Rr && (!Ze || Ze && j(Ze)))) && !((je.parser === "scss" || je.parser === "less") && Rr && Le.value === "-" && pe($e) && Ce(Le) === Ae($e.open) && $e.open.value === "(")) {
                  if (ge(Le)) {
                  ...
                  if (!($e && $e.value === "...") && !(ce(Le) && ce($e) && Ce(Le) === Ae($e))) {
                    if (ce(Le) && pe($e) && Ce(Le) === Ae($e.open)) {
                      Ge.push(g);
                      continue;
                    }
                    if (Le.value === "with" && pe($e)) {
                      Ge.push(" ");
                      continue;
                    }
                    (tt = Le.value) !== null && tt !== void 0 && tt.endsWith("#") && $e.value === "{" && pe($e.group) || Ge.push(d);
                  }
                }
              }
              return _e && Ge.push(F), rt && Ge.unshift(y), me ? c(E(Ge)) : C(Te) ? c(D(Ge)) : c(E(D(Ge)));
            }
            case "value-paren_group": {
              ...
              let We = De(Te), Xe = t(ae.groups), st = Xe && Xe.type === "value-comment", O = Fe(ae, Ve), me = X(ae, Ve), _e = me || We && !O, He = me || O, Ge = c([ae.open ? Me("open") : "", E([g, p([d], Te.map((it, Qe) => {
                ...
                if (!at && rt.type === "value-comma_group" && l(rt.groups)) {
                  let Le = t(rt.groups);
                  !Le.source && Le.close && (Le = Le.close), Le.source && i(je.originalText, Le, Ce) && Ze.push(y);
                }
                return Ze;
            ...
            case "value-func":
              return [ae.value, h(Te, "supports") && Pe(ae) ? " " : "", Me("group")];
            case "value-paren":
              return ae.value;
            case "value-number":
            ...
            case "value-colon": {
              ...
              return [ae.value, Xe && typeof Xe.value == "string" && t(Xe.value) === "\\" || v(Te, "url") ? "" : d];
            }
            case "value-comma":
              return [ae.value, " "];
            case "value-string":
        ...
        function Ee(Te, je, Me) {
          let ae = [];
          return Te.each((nt, tt, Ve) => {
            let We = Ve[tt - 1];
            if (We && We.type === "css-comment" && We.text.trim() === "prettier-ignore") {
              let Xe = nt.getValue();
              ae.push(je.originalText.slice(Ae(Xe), Ce(Xe)));
            } else
              ae.push(Me());
            tt !== Ve.length - 1 && (Ve[tt + 1].type === "css-comment" && !n(je.originalText, Ae(Ve[tt + 1]), { backwards: true }) && !u(Ve[tt]) || Ve[tt + 1].type === "css-atrule" && Ve[tt + 1].name === "else" && Ve[tt].type !== "css-comment" ? ae.push(" ") : (ae.push(je.__isHTMLStyleAttribute ? d : y), i(je.originalText, nt.getValue(), Ce) && !u(Ve[tt]) && ae.push(y)));
          }, "nodes"), ae;
        }
      ...
      } }), Md = te({ "src/language-css/options.js"(e, r) {
        "use strict";
        ne();
        var t = Mt();
        r.exports = { singleQuote: t.singleQuote };
      } }), Rd = te({ "src/language-css/parsers.js"() {
        ne();
      } }), $d = te({ "node_modules/linguist-languages/data/CSS.json"(e, r) {
      ...
      } }), Vd = te({ "node_modules/linguist-languages/data/PostCSS.json"(e, r) {
      ...
      } }), Wd = te({ "node_modules/linguist-languages/data/Less.json"(e, r) {
      ...
      } }), Hd = te({ "node_modules/linguist-languages/data/SCSS.json"(e, r) {
      ...
      } }), Gd = te({ "src/language-css/index.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), Ud = te({ "src/language-handlebars/loc.js"(e, r) {
        "use strict";
        ne();
        function t(a) {
      ...
      } }), Jd = te({ "src/language-handlebars/clean.js"(e, r) {
        "use strict";
        ne();
        function t(s, a) {
          if (s.type === "TextNode") {
      ...
      } }), zd = te({ "vendors/html-void-elements.json"(e, r) {
      ...
      } }), Xd = te({ "src/language-handlebars/utils.js"(e, r) {
        "use strict";
        ne();
        var { htmlVoidElements: t } = zd(), s = lt();
        function a(S) {
          let N = S.getValue(), I = S.getParentNode(0);
          return !!(y(S, ["ElementNode"]) && s(I.children) === N || y(S, ["Block"]) && s(I.body) === N);
        }
        function n(S) {
          return S.toUpperCase() === S;
        }
        function u(S) {
          return d(S, ["ElementNode"]) && typeof S.tag == "string" && !S.tag.startsWith(":") && (n(S.tag[0]) || S.tag.includes("."));
        }
        var i = new Set(t);
        function l(S) {
          return i.has(S.tag) || S.selfClosing === true || u(S) && S.children.every((N) => p(N));
        }
        function p(S) {
          return d(S, ["TextNode"]) && !/\S/.test(S.chars);
        }
        function d(S, N) {
          return S && N.includes(S.type);
        }
        function y(S, N) {
        ...
        function D(S, N) {
          var I, P, $, f;
          let T = S.getValue(), m = (I = S.getParentNode(0)) !== null && I !== void 0 ? I : {}, v = (P = ($ = (f = m.children) !== null && f !== void 0 ? f : m.body) !== null && $ !== void 0 ? $ : m.parts) !== null && P !== void 0 ? P : [], o = v.indexOf(T);
          return o !== -1 && v[o + N];
        }
        function E(S) {
          let N = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1;
        ...
        function w(S) {
          return d(S, ["MustacheCommentStatement"]) && typeof S.value == "string" && S.value.trim() === "prettier-ignore";
        }
        function F(S) {
          let N = S.getValue(), I = E(S, 2);
          return w(N) || w(I);
        }
      ...
      } }), Kd = te({ "src/language-handlebars/printer-glimmer.js"(e, r) {
        "use strict";
        ne();
        ...
        function h(H, ce, X) {
          ...
          if (!pe)
            return "";
          if (N(H))
            return ce.originalText.slice(E(pe), _(pe));
          let Ae = ce.singleQuote ? "'" : '"';
          switch (pe.type) {
            case "Block":
            case "Program":
            case "Template":
            ...
            case "ElementNode": {
              let Ce = a(x(H, X)), fe = ce.htmlWhitespaceSensitivity === "ignore" && P(H, ["ElementNode"]) ? d : "";
              if (m(pe))
                return [Ce, fe];
              let A = ["</", pe.tag, ">"];
              return pe.children.length === 0 ? [Ce, i(A), fe] : ce.htmlWhitespaceSensitivity === "ignore" ? [Ce, i(b(H, ce, X)), n, i(A), fe] : [Ce, i(a(b(H, ce, X))), i(A), fe];
            }
            case "BlockStatement": {
              let Ce = H.getParentNode(1);
              return Ce && Ce.inverse && Ce.inverse.body.length === 1 && Ce.inverse.body[0] === pe && Ce.inverse.body[0].path.parts[0] === Ce.path.parts[0] ? [ie(H, X, Ce.inverse.body[0].path.parts[0]), de(H, X, ce), ue(H, X, ce)] : [j(H, X), a([de(H, X, ce), ue(H, X, ce), ee(H, X, ce)])];
            }
            case "ElementModifierStatement":
              return a(["{{", Re(H, X), "}}"]);
            case "MustacheStatement":
              return a([k(pe), Re(H, X), M(pe)]);
            case "SubExpression":
              return a(["(", ke(H, X), d, ")"]);
            case "AttrNode": {
              let Ce = pe.value.type === "TextNode";
              if (Ce && pe.value.chars === "" && E(pe.value) === _(pe.value))
                return pe.name;
              let A = Ce ? c(pe.value.chars, Ae).quote : pe.value.type === "ConcatStatement" ? c(pe.value.parts.filter((re) => re.type === "TextNode").map((re) => re.chars).join(""), Ae).quote : "", G = X("value");
              return [pe.name, "=", A, pe.name === "class" && A ? a(i(G)) : G, A];
            }
            ...
            case "HashPair":
              return [pe.key, "=", X("value")];
            case "TextNode": {
              let Ce = pe.chars.replace(/{{/g, "\\{{"), fe = U(H);
              if (fe) {
                if (fe === "class") {
                  let Ye = Ce.trim().split(/\s+/).join(" "), Se = false, Ie = false;
                  return f(H, ["ConcatStatement"]) && (T(H, ["MustacheStatement"]) && /^\s/.test(Ce) && (Se = true), P(H, ["MustacheStatement"]) && /\s$/.test(Ce) && Ye !== "" && (Ie = true)), [Se ? p : "", Ye, Ie ? p : ""];
                }
                return g(Ce);
              }
              let G = /^[\t\n\f\r ]*$/.test(Ce), re = !S(H), ye = !F(H);
              if (ce.htmlWhitespaceSensitivity !== "ignore") {
                let Ye = /^[\t\n\f\r ]*/, Se = /[\t\n\f\r ]*$/, Ie = ye && f(H, ["Template"]), Oe = re && f(H, ["Template"]);
                if (G) {
                  if (Oe || Ie)
                    return "";
                  let ae = [p], nt = Z(Ce);
                ...
                let [Je] = Ce.match(Ye), [Te] = Ce.match(Se), je = [];
                if (Je) {
                  je = [p];
                  let ae = Z(Je);
                  ae && (je = ge(ae)), Ce = Ce.replace(Ye, "");
                }
                let Me = [];
                if (Te) {
                  if (!Ie) {
                ...
                return [...je, s(Fe(Ce)), ...Me];
              }
              let Ee = Z(Ce), Be = se(Ce), ve = De(Ce);
              if ((re || ye) && G && f(H, ["Block", "ElementNode", "Template"]))
                return "";
              G && Ee ? (Be = Math.min(Ee, o), ve = 0) : (P(H, ["BlockStatement", "ElementNode"]) && (ve = Math.max(ve, 1)), T(H, ["BlockStatement", "ElementNode"]) && (Be = Math.max(Be, 1)));
              let ze = "", be = "";
              return ve === 0 && P(H, ["MustacheStatement"]) && (be = " "), Be === 0 && T(H, ["MustacheStatement"]) && (ze = " "), re && (Be = 0, ze = ""), ye && (ve = 0, be = ""), Ce = Ce.replace(/^[\t\n\f\r ]+/g, ze).replace(/[\t\n\f\r ]+$/, be), [...ge(Be), s(Fe(Ce)), ...ge(ve)];
            }
            case "MustacheCommentStatement": {
              let Ce = E(pe), fe = _(pe), A = ce.originalText.charAt(Ce + 2) === "~", G = ce.originalText.charAt(fe - 3) === "~", re = pe.value.includes("}}") ? "--" : "";
              return ["{{", A ? "~" : "", "!", re, pe.value, re, G ? "~" : "", "}}"];
            }
            case "PathExpression":
              return pe.original;
            case "BooleanLiteral":
            ...
            case "StringLiteral": {
              if (we(H)) {
                let Ce = ce.singleQuote ? '"' : "'";
                return he(pe.value, Ce);
              }
              return he(pe.value, Ae);
            }
            case "NumberLiteral":
              return String(pe.value);
            ...
            case "NullLiteral":
              return "null";
            default:
              throw new Error("unknown glimmer type: " + JSON.stringify(pe.type));
          }
        }
        function C(H, ce) {
          return E(H) - E(ce);
        ...
        function x(H, ce) {
          let X = H.getValue(), pe = ["attributes", "modifiers", "comments"].filter((Ce) => D(X[Ce])), Ae = pe.flatMap((Ce) => X[Ce]).sort(C);
          for (let Ce of pe)
            H.each((fe) => {
              let A = Ae.indexOf(fe.getValue());
              Ae.splice(A, 1, [p, ce()]);
            }, Ce);
          return D(X.blockParams) && Ae.push(p, oe(X)), ["<", X.tag, i(Ae), B(X)];
        }
        function b(H, ce, X) {
          let Ae = H.getValue().children.every((Ce) => v(Ce));
          return ce.htmlWhitespaceSensitivity === "ignore" && Ae ? "" : H.map((Ce, fe) => {
            let A = X();
            return fe === 0 && ce.htmlWhitespaceSensitivity === "ignore" ? [d, A] : A;
          }, "children");
        }
        function B(H) {
        ...
        function k(H) {
          let ce = H.escaped === false ? "{{{" : "{{", X = H.strip && H.strip.open ? "~" : "";
          return [ce, X];
        }
        function M(H) {
          let ce = H.escaped === false ? "}}}" : "}}";
          return [H.strip && H.strip.close ? "~" : "", ce];
        }
        function R(H) {
          let ce = k(H), X = H.openStrip.open ? "~" : "";
          return [ce, X, "#"];
        }
        function q(H) {
          let ce = M(H);
          return [H.openStrip.close ? "~" : "", ce];
        }
        function J(H) {
          let ce = k(H), X = H.closeStrip.open ? "~" : "";
          return [ce, X, "/"];
        }
        function L(H) {
          let ce = M(H);
          return [H.closeStrip.close ? "~" : "", ce];
        }
        function Q(H) {
          let ce = k(H), X = H.inverseStrip.open ? "~" : "";
          return [ce, X];
        }
        function V(H) {
          let ce = M(H);
          return [H.inverseStrip.close ? "~" : "", ce];
        }
        function j(H, ce) {
          let X = H.getValue(), pe = R(X), Ae = q(X), Ce = [Ne(H, ce)], fe = Pe(H, ce);
          if (fe && Ce.push(p, fe), D(X.program.blockParams)) {
            let A = oe(X.program);
            Ce.push(p, A);
          }
          return a([pe, i(Ce), d, Ae]);
        }
        function Y(H, ce) {
          return [ce.htmlWhitespaceSensitivity === "ignore" ? n : "", Q(H), "else", V(H)];
        }
        function ie(H, ce, X) {
          let pe = H.getValue(), Ae = [];
          D(pe.program.blockParams) && (Ae = [p, oe(pe.program)]);
          let Ce = H.getParentNode(1);
          return a([Q(Ce), i(a([a(["else", p, X]), p, Pe(H, ce)])), i(Ae), d, V(Ce)]);
        }
        function ee(H, ce, X) {
          let pe = H.getValue();
          return X.htmlWhitespaceSensitivity === "ignore" ? [le(pe) ? d : n, J(pe), ce("path"), L(pe)] : [J(pe), ce("path"), L(pe)];
        }
        function le(H) {
          return $(H, ["BlockStatement"]) && H.program.body.every((ce) => v(ce));
        }
        function W(H) {
        ...
        function ue(H, ce, X) {
          let pe = H.getValue(), Ae = ce("inverse"), Ce = X.htmlWhitespaceSensitivity === "ignore" ? [n, Ae] : Ae;
          return W(pe) ? Ce : K(pe) ? [Y(pe, X), i(Ce)] : "";
        }
        function Fe(H) {
          return y(l(p, z(H)));
        }
...
`).length - 1;
        ...
        function he(H, ce) {
          let { quote: X, regex: pe } = c(H, ce);
          return [X, H.replace(pe, `\\${X}`), X];
        }
        function we(H) {
          let ce = 0, X = H.getParentNode(ce);
          for (; X && $(X, ["SubExpression"]); )
            ce++, X = H.getParentNode(ce);
          return !!(X && $(H.getParentNode(ce + 1), ["ConcatStatement"]) && $(H.getParentNode(ce + 2), ["AttrNode"]));
        }
        function ke(H, ce) {
          let X = Ne(H, ce), pe = Pe(H, ce);
          return pe ? i([X, p, a(pe)]) : X;
        }
        function Re(H, ce) {
          let X = Ne(H, ce), pe = Pe(H, ce);
          return pe ? [i([X, p, pe]), d] : X;
        }
        function Ne(H, ce) {
          return ce("path");
        }
        function Pe(H, ce) {
          ...
          return pe.length === 0 ? "" : l(p, pe);
        }
        function oe(H) {
          return ["as |", H.blockParams.join(" "), "|"];
        }
        r.exports = { print: h, massageAstNode: w };
      } }), Yd = te({ "src/language-handlebars/parsers.js"() {
        ne();
      } }), Qd = te({ "node_modules/linguist-languages/data/Handlebars.json"(e, r) {
      ...
      } }), Zd = te({ "src/language-handlebars/index.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), eg = te({ "src/language-graphql/pragma.js"(e, r) {
        "use strict";
        ne();
        function t(a) {
          return /^\s*#[^\S\n]*@(?:format|prettier)\s*(?:\n|$)/.test(a);
...
` + a;
      ...
      } }), tg = te({ "src/language-graphql/loc.js"(e, r) {
        "use strict";
        ne();
        function t(a) {
        ...
        r.exports = { locStart: t, locEnd: s };
      } }), rg = te({ "src/language-graphql/printer-graphql.js"(e, r) {
        "use strict";
        ne();
        var { builders: { join: t, hardline: s, line: a, softline: n, group: u, indent: i, ifBreak: l } } = qe(), { isNextLineEmpty: p, isNonEmptyArray: d } = Ue(), { insertPragma: y } = eg(), { locStart: g, locEnd: c } = tg();
        function D(P, $, f) {
          let T = P.getValue();
          if (!T)
            return "";
          ...
          switch (T.kind) {
            case "Document": {
              let m = [];
              return P.each((v, o, h) => {
                m.push(f()), o !== h.length - 1 && (m.push(s), p($.originalText, v.getValue(), c) && m.push(s));
              }, "definitions"), [...m, s];
            }
            case "OperationDefinition": {
              let m = $.originalText[g(T)] !== "{", v = Boolean(T.name);
              return [m ? T.operation : "", m && v ? [" ", f("name")] : "", m && !v && d(T.variableDefinitions) ? " " : "", d(T.variableDefinitions) ? u(["(", i([n, t([l("", ", "), n], P.map(f, "variableDefinitions"))]), n, ")"]) : "", E(P, f, T), T.selectionSet ? !m && !v ? "" : " " : "", f("selectionSet")];
            }
            case "FragmentDefinition":
              return ["fragment ", f("name"), d(T.variableDefinitions) ? u(["(", i([n, t([l("", ", "), n], P.map(f, "variableDefinitions"))]), n, ")"]) : "", " on ", f("typeCondition"), E(P, f, T), " ", f("selectionSet")];
            case "SelectionSet":
              return ["{", i([s, t(s, _(P, $, f, "selections"))]), s, "}"];
            case "Field":
              return u([T.alias ? [f("alias"), ": "] : "", f("name"), T.arguments.length > 0 ? u(["(", i([n, t([l("", ", "), n], _(P, $, f, "arguments"))]), n, ")"]) : "", E(P, f, T), T.selectionSet ? " " : "", f("selectionSet")]);
            case "Name":
              return T.value;
            case "StringValue": {
              if (T.block) {
...
`);
            ...
            case "ObjectValue":
              return u(["{", $.bracketSpacing && T.fields.length > 0 ? " " : "", i([n, t([l("", ", "), n], P.map(f, "fields"))]), n, l("", $.bracketSpacing && T.fields.length > 0 ? " " : ""), "}"]);
            case "ObjectField":
            case "Argument":
              return [f("name"), ": ", f("value")];
            case "Directive":
              return ["@", f("name"), T.arguments.length > 0 ? u(["(", i([n, t([l("", ", "), n], _(P, $, f, "arguments"))]), n, ")"]) : ""];
            case "NamedType":
              return f("name");
            case "VariableDefinition":
              return [f("variable"), ": ", f("type"), T.defaultValue ? [" = ", f("defaultValue")] : "", E(P, f, T)];
            case "ObjectTypeExtension":
            case "ObjectTypeDefinition":
              return [f("description"), T.description ? s : "", T.kind === "ObjectTypeExtension" ? "extend " : "", "type ", f("name"), T.interfaces.length > 0 ? [" implements ", ...S(P, $, f)] : "", E(P, f, T), T.fields.length > 0 ? [" {", i([s, t(s, _(P, $, f, "fields"))]), s, "}"] : ""];
            case "FieldDefinition":
              return [f("description"), T.description ? s : "", f("name"), T.arguments.length > 0 ? u(["(", i([n, t([l("", ", "), n], _(P, $, f, "arguments"))]), n, ")"]) : "", ": ", f("type"), E(P, f, T)];
            case "DirectiveDefinition":
              return [f("description"), T.description ? s : "", "directive ", "@", f("name"), T.arguments.length > 0 ? u(["(", i([n, t([l("", ", "), n], _(P, $, f, "arguments"))]), n, ")"]) : "", T.repeatable ? " repeatable" : "", " on ", t(" | ", P.map(f, "locations"))];
            case "EnumTypeExtension":
            case "EnumTypeDefinition":
              return [f("description"), T.description ? s : "", T.kind === "EnumTypeExtension" ? "extend " : "", "enum ", f("name"), E(P, f, T), T.values.length > 0 ? [" {", i([s, t(s, _(P, $, f, "values"))]), s, "}"] : ""];
            case "EnumValueDefinition":
              return [f("description"), T.description ? s : "", f("name"), E(P, f, T)];
            case "InputValueDefinition":
              return [f("description"), T.description ? T.description.block ? s : a : "", f("name"), ": ", f("type"), T.defaultValue ? [" = ", f("defaultValue")] : "", E(P, f, T)];
            case "InputObjectTypeExtension":
            case "InputObjectTypeDefinition":
              return [f("description"), T.description ? s : "", T.kind === "InputObjectTypeExtension" ? "extend " : "", "input ", f("name"), E(P, f, T), T.fields.length > 0 ? [" {", i([s, t(s, _(P, $, f, "fields"))]), s, "}"] : ""];
            case "SchemaExtension":
              return ["extend schema", E(P, f, T), ...T.operationTypes.length > 0 ? [" {", i([s, t(s, _(P, $, f, "operationTypes"))]), s, "}"] : []];
            case "SchemaDefinition":
              return [f("description"), T.description ? s : "", "schema", E(P, f, T), " {", T.operationTypes.length > 0 ? i([s, t(s, _(P, $, f, "operationTypes"))]) : "", s, "}"];
            case "OperationTypeDefinition":
              return [f("operation"), ": ", f("type")];
            case "InterfaceTypeExtension":
            case "InterfaceTypeDefinition":
              return [f("description"), T.description ? s : "", T.kind === "InterfaceTypeExtension" ? "extend " : "", "interface ", f("name"), T.interfaces.length > 0 ? [" implements ", ...S(P, $, f)] : "", E(P, f, T), T.fields.length > 0 ? [" {", i([s, t(s, _(P, $, f, "fields"))]), s, "}"] : ""];
            case "FragmentSpread":
              return ["...", f("name"), E(P, f, T)];
            case "InlineFragment":
              return ["...", T.typeCondition ? [" on ", f("typeCondition")] : "", E(P, f, T), " ", f("selectionSet")];
            case "UnionTypeExtension":
            case "UnionTypeDefinition":
              return u([f("description"), T.description ? s : "", u([T.kind === "UnionTypeExtension" ? "extend " : "", "union ", f("name"), E(P, f, T), T.types.length > 0 ? [" =", l("", " "), i([l([a, "  "]), t([a, "| "], P.map(f, "types"))])] : ""])]);
            case "ScalarTypeExtension":
            case "ScalarTypeDefinition":
              return [f("description"), T.description ? s : "", T.kind === "ScalarTypeExtension" ? "extend " : "", "scalar ", f("name"), E(P, f, T)];
            case "NonNullType":
              return [f("type"), "!"];
            case "ListType":
              return ["[", f("type"), "]"];
        ...
        function E(P, $, f) {
          ...
          return f.kind === "FragmentDefinition" || f.kind === "OperationDefinition" ? u([a, T]) : [" ", u(i([n, T]))];
        }
        function _(P, $, f, T) {
          return P.map((m, v, o) => {
            let h = f();
            return v < o.length - 1 && p($.originalText, m.getValue(), c) ? [h, s] : h;
          }, T);
        }
        function w(P) {
        ...
        function S(P, $, f) {
          let T = P.getNode(), m = [], { interfaces: v } = T, o = P.map((h) => f(h), "interfaces");
          for (let h = 0; h < v.length; h++) {
            let C = v[h];
            m.push(o[h]);
            let x = v[h + 1];
            if (x) {
              let b = $.originalText.slice(C.loc.end, x.loc.start), B = b.includes("#"), k = b.replace(/#.*/g, "").trim();
              m.push(k === "," ? "," : " &", B ? a : " ");
            }
          }
          return m;
...
`) && ($.value = $.value.trim());
        ...
        function I(P) {
          var $;
          let f = P.getValue();
          return f == null || ($ = f.comments) === null || $ === void 0 ? void 0 : $.some((T) => T.value.trim() === "prettier-ignore");
        }
        r.exports = { print: D, massageAstNode: N, hasPrettierIgnore: I, insertPragma: y, printComment: F, canAttachComment: w };
      } }), ng = te({ "src/language-graphql/options.js"(e, r) {
        "use strict";
        ne();
        var t = Mt();
        r.exports = { bracketSpacing: t.bracketSpacing };
      } }), ug = te({ "src/language-graphql/parsers.js"() {
        ne();
      } }), sg = te({ "node_modules/linguist-languages/data/GraphQL.json"(e, r) {
      ...
      } }), ig = te({ "src/language-graphql/index.js"(e, r) {
        "use strict";
        ne();
        ...
        r.exports = { locStart: t, locEnd: s };
      } }), ag = te({ "src/language-markdown/constants.evaluate.js"(e, r) {
        ...
        function g(F, S) {
          let N = "non-cjk", I = "cj-letter", P = "k-letter", $ = "cjk-punctuation", f = [], T = (S.proseWrap === "preserve" ? F : F.replace(new RegExp(`(${n})
(${n})`, "g"), "$1$2")).split(/([\t\n ]+)/);
          for (let [v, o] of T.entries()) {
            if (v % 2 === 1) {
              f.push({ type: "whitespace", value: /\n/.test(o) ? `
` : " " });
              continue;
            }
            if ((v === 0 || v === T.length - 1) && o === "")
              continue;
            let h = o.split(new RegExp(`(${n})`));
            for (let [C, x] of h.entries())
              if (!((C === 0 || C === h.length - 1) && x === "")) {
                if (C % 2 === 0) {
                  x !== "" && m({ type: "word", value: x, kind: N, hasLeadingPunctuation: y.test(x[0]), hasTrailingPunctuation: y.test(t(x)) });
                  continue;
                }
                m(y.test(x) ? { type: "word", value: x, kind: $, hasLeadingPunctuation: true, hasTrailingPunctuation: true } : { type: "word", value: x, kind: d.test(x) ? P : I, hasLeadingPunctuation: false, hasTrailingPunctuation: false });
              }
          }
          return f;
          function m(v) {
            let o = t(f);
            o && o.type === "word" && (o.kind === N && v.kind === I && !o.hasTrailingPunctuation || o.kind === I && v.kind === N && !v.hasLeadingPunctuation ? f.push({ type: "whitespace", value: " " }) : !h(N, $) && ![o.value, v.value].some((C) => /\u3000/.test(C)) && f.push({ type: "whitespace", value: "" })), f.push(v);
            function h(C, x) {
              return o.kind === C && v.kind === x || o.kind === x && v.kind === C;
            }
          }
        }
        function c(F, S) {
          let [, N, I, P] = S.slice(F.position.start.offset, F.position.end.offset).match(/^\s*(\d+)(\.|\))(\s*)/);
          return { numberText: N, marker: I, leadingSpaces: P };
        }
        function D(F, S) {
          if (!F.ordered || F.children.length < 2)
            return false;
          let N = Number(c(F.children[0], S.originalText).numberText), I = Number(c(F.children[1], S.originalText).numberText);
          if (N === 0 && F.children.length > 2) {
            let P = Number(c(F.children[2], S.originalText).numberText);
            return I === 1 && P === 1;
          }
          return I === 1;
        }
        function E(F, S) {
          let { value: N } = F;
          return F.position.end.offset === S.length && N.endsWith(`
`) && S.endsWith(`
`) ? N.slice(0, -1) : N;
        }
        function _(F, S) {
          return function N(I, P, $) {
            let f = Object.assign({}, S(I, P, $));
            return f.children && (f.children = f.children.map((T, m) => N(T, m, [f, ...$]))), f;
          }(F, null, []);
        }
        function w(F) {
      ...
      } }), og = te({ "src/language-markdown/embed.js"(e, r) {
        "use strict";
        ne();
        ...
        function p(d, y, g, c) {
          ...
          if (D.type === "code" && D.lang !== null) {
            ...
            if (E) {
              ...
              let S = g(l(D, c.originalText), F, { stripTrailingHardline: true });
              return n([w, D.lang, D.meta ? " " + D.meta : "", a, u(S), a, w]);
            }
          }
          switch (D.type) {
            case "front-matter":
...
${u.content}`;
      ...
      } }), lg = te({ "src/language-markdown/print-preprocess.js"(e, r) {
        "use strict";
        ne();
        ...
        function p(w, F) {
          return a(w, (S) => S.type !== "inlineCode" || F.proseWrap === "preserve" ? S : Object.assign(Object.assign({}, S), {}, { value: S.value.replace(/\s+/g, " ") }));
        }
        function d(w, F) {
          return a(w, (S) => S.type !== "text" || S.value === "*" || S.value === "_" || !u.test(S.value) || S.position.end.offset - S.position.start.offset === S.value.length ? S : Object.assign(Object.assign({}, S), {}, { value: F.originalText.slice(S.position.start.offset, S.position.end.offset) }));
        }
        function y(w) {
          return g(w, (F, S) => F.type === "importExport" && S.type === "importExport", (F, S) => ({ type: "importExport", value: F.value + `

` + S.value, position: { start: F.position.start, end: S.position.end } }));
        }
        function g(w, F, S) {
          return a(w, (N) => {
            if (!N.children)
              return N;
            let I = N.children.reduce((P, $) => {
              let f = t(P);
              return f && F(f, $) ? P.splice(-1, 1, S(f, $)) : P.push($), P;
            }, []);
            return Object.assign(Object.assign({}, N), {}, { children: I });
          });
        }
        function c(w) {
          return g(w, (F, S) => F.type === "text" && S.type === "text", (F, S) => ({ type: "text", value: F.value + S.value, position: { start: F.position.start, end: S.position.end } }));
        }
        function D(w, F) {
          return a(w, (S, N, I) => {
            let [P] = I;
            if (S.type !== "text")
              return S;
            let { value: $ } = S;
            return P.type === "paragraph" && (N === 0 && ($ = $.trimStart()), N === P.children.length - 1 && ($ = $.trimEnd())), { type: "sentence", position: S.position, children: n($, F) };
          });
        }
        function E(w, F) {
          return a(w, (S, N, I) => {
            if (S.type === "code") {
              let P = /^\n?(?: {4,}|\t)/.test(F.originalText.slice(S.position.start.offset, S.position.end.offset));
              if (S.isIndented = P, P)
                for (let $ = 0; $ < I.length; $++) {
                  let f = I[$];
        ...
        function _(w, F) {
          ...
          function N(I) {
            ...
            let m = S($);
            return T !== m ? false : T % F.tabWidth === 0 ? true : s($, F.originalText).leadingSpaces.length > 1;
          }
        }
        r.exports = i;
      } }), cg = te({ "src/language-markdown/clean.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), pg = te({ "src/language-markdown/printer-markdown.js"(e, r) {
        "use strict";
        ne();
        var t = Po(), { getLast: s, getMinNotPresentContinuousCount: a, getMaxContinuousCount: n, getStringWidth: u, isNonEmptyArray: i } = Ue(), { builders: { breakParent: l, join: p, line: d, literalline: y, markAsRoot: g, hardline: c, softline: D, ifBreak: E, fill: _, align: w, indent: F, group: S, hardlineWithoutBreakParent: N }, utils: { normalizeDoc: I, replaceTextEndOfLine: P }, printer: { printDocToString: $ } } = qe(), f = og(), { insertPragma: T } = ko(), { locStart: m, locEnd: v } = Io(), o = lg(), h = cg(), { getFencedCodeBlockValue: C, hasGitDiffFriendlyOrderedList: x, splitText: b, punctuationPattern: B, INLINE_NODE_TYPES: k, INLINE_NODE_WRAPPER_TYPES: M, isAutolink: R } = iu(), q = /* @__PURE__ */ new Set(["importExport"]), J = ["heading", "tableCell", "link", "wikiLink"], L = /* @__PURE__ */ new Set(["listItem", "definition", "footnoteDefinition"]);
        function Q(oe, H, ce) {
          let X = oe.getValue();
          if (ge(oe))
            return b(H.originalText.slice(X.position.start.offset, X.position.end.offset), H).map((pe) => pe.type === "word" ? pe.value : pe.value === "" ? "" : W(oe, pe.value, H));
          switch (X.type) {
            case "front-matter":
              return H.originalText.slice(X.position.start.offset, X.position.end.offset);
            case "root":
              return X.children.length === 0 ? "" : [I(de(oe, H, ce)), q.has(z(X).type) ? "" : c];
            case "paragraph":
              return ue(oe, H, ce, { postprocessor: _ });
            case "sentence":
              return ue(oe, H, ce);
            case "word": {
              let pe = X.value.replace(/\*/g, "\\$&").replace(new RegExp([`(^|${B})(_+)`, `(_+)(${B}|$)`].join("|"), "g"), (fe, A, G, re, ye) => (G ? `${A}${G}` : `${re}${ye}`).replace(/_/g, "\\_")), Ae = (fe, A, G) => fe.type === "sentence" && G === 0, Ce = (fe, A, G) => R(fe.children[G - 1]);
              return pe !== X.value && (oe.match(void 0, Ae, Ce) || oe.match(void 0, Ae, (fe, A, G) => fe.type === "emphasis" && G === 0, Ce)) && (pe = pe.replace(/^(\\?[*_])+/, (fe) => fe.replace(/\\/g, ""))), pe;
            }
            case "whitespace": {
              let pe = oe.getParentNode(), Ae = pe.children.indexOf(X), Ce = pe.children[Ae + 1], fe = Ce && /^>|^(?:[*+-]|#{1,6}|\d+[).])$/.test(Ce.value) ? "never" : H.proseWrap;
              return W(oe, X.value, { proseWrap: fe });
            }
            case "emphasis": {
              let pe;
              if (R(X.children[0]))
                pe = H.originalText[X.position.start.offset];
              else {
                let Ae = oe.getParentNode(), Ce = Ae.children.indexOf(X), fe = Ae.children[Ce - 1], A = Ae.children[Ce + 1];
                pe = fe && fe.type === "sentence" && fe.children.length > 0 && s(fe.children).type === "word" && !s(fe.children).hasTrailingPunctuation || A && A.type === "sentence" && A.children.length > 0 && A.children[0].type === "word" && !A.children[0].hasLeadingPunctuation || le(oe, "emphasis") ? "*" : "_";
              }
              return [pe, ue(oe, H, ce), pe];
            }
            case "strong":
              return ["**", ue(oe, H, ce), "**"];
            case "delete":
              return ["~~", ue(oe, H, ce), "~~"];
            case "inlineCode": {
              let pe = a(X.value, "`"), Ae = "`".repeat(pe || 1), Ce = pe && !/^\s/.test(X.value) ? " " : "";
              return [Ae, Ce, X.value, Ce, Ae];
            }
            case "wikiLink": {
              let pe = "";
              return H.proseWrap === "preserve" ? pe = X.value : pe = X.value.replace(/[\t\n]+/g, " "), ["[[", pe, "]]"];
            }
            case "link":
              switch (H.originalText[X.position.start.offset]) {
                case "<": {
                  let pe = "mailto:";
                  return ["<", X.url.startsWith(pe) && H.originalText.slice(X.position.start.offset + 1, X.position.start.offset + 1 + pe.length) !== pe ? X.url.slice(pe.length) : X.url, ">"];
                }
                case "[":
                  return ["[", ue(oe, H, ce), "](", he(X.url, ")"), we(X.title, H), ")"];
                default:
                  return H.originalText.slice(X.position.start.offset, X.position.end.offset);
              }
            case "image":
            ...
            case "blockquote":
              return ["> ", w("> ", ue(oe, H, ce))];
            case "heading":
              return ["#".repeat(X.depth) + " ", ue(oe, H, ce)];
            case "code": {
              if (X.isIndented) {
                let Ce = " ".repeat(4);
                return w(Ce, [Ce, ...P(X.value, c)]);
              }
              let pe = H.__inJsTemplate ? "~" : "`", Ae = pe.repeat(Math.max(3, n(X.value, pe) + 1));
              return [Ae, X.lang || "", X.meta ? " " + X.meta : "", c, ...P(C(X, H.originalText), c), c, Ae];
            }
            case "html": {
              let pe = oe.getParentNode(), Ae = pe.type === "root" && s(pe.children) === X ? X.value.trimEnd() : X.value, Ce = /^<!--.*-->$/s.test(Ae);
              return P(Ae, Ce ? c : g(y));
            }
            case "list": {
              let pe = Y(X, oe.getParentNode()), Ae = x(X, H);
              return ue(oe, H, ce, { processor: (Ce, fe) => {
                let A = re(), G = Ce.getValue();
                if (G.children.length === 2 && G.children[1].type === "html" && G.children[0].position.start.column !== G.children[1].position.start.column)
                  return [A, V(Ce, H, ce, A)];
                return [A, w(" ".repeat(A.length), V(Ce, H, ce, A))];
                function re() {
                  let ye = X.ordered ? (fe === 0 ? X.start : Ae ? 1 : X.start + fe) + (pe % 2 === 0 ? ". " : ") ") : pe % 2 === 0 ? "- " : "* ";
            ...
            case "thematicBreak": {
              let pe = ee(oe, "list");
              return pe === -1 ? "---" : Y(oe.getParentNode(pe), oe.getParentNode(pe + 1)) % 2 === 0 ? "***" : "---";
            }
            case "linkReference":
              return ["[", ue(oe, H, ce), "]", X.referenceType === "full" ? Ne(X) : X.referenceType === "collapsed" ? "[]" : ""];
            case "imageReference":
            ...
            case "definition": {
              let pe = H.proseWrap === "always" ? d : " ";
              return S([Ne(X), ":", F([pe, he(X.url), X.title === null ? "" : [pe, we(X.title, H, false)]])]);
            }
            case "footnote":
              return ["[^", ue(oe, H, ce), "]"];
            ...
            case "footnoteDefinition": {
              let pe = oe.getParentNode().children[oe.getName() + 1], Ae = X.children.length === 1 && X.children[0].type === "paragraph" && (H.proseWrap === "never" || H.proseWrap === "preserve" && X.children[0].position.start.line === X.children[0].position.end.line);
              return [Pe(X), ": ", Ae ? ue(oe, H, ce) : S([w(" ".repeat(4), ue(oe, H, ce, { processor: (Ce, fe) => fe === 0 ? S([D, ce()]) : ce() })), pe && pe.type === "footnoteDefinition" ? D : ""])];
            }
            case "table":
              return K(oe, H, ce);
            case "tableCell":
            ...
            case "inlineMath":
              return H.originalText.slice(m(X), v(X));
            case "tableRow":
            case "listItem":
            default:
        ...
        function V(oe, H, ce, X) {
          let pe = oe.getValue(), Ae = pe.checked === null ? "" : pe.checked ? "[x] " : "[ ] ";
          return [Ae, ue(oe, H, ce, { processor: (Ce, fe) => {
            if (fe === 0 && Ce.getValue().type !== "list")
              return w(" ".repeat(Ae.length), ce());
        ...
        function j(oe, H) {
          let ce = X();
          return oe + " ".repeat(ce >= 4 ? 0 : ce);
          function X() {
            let pe = oe.length % H.tabWidth;
            return pe === 0 ? 0 : H.tabWidth - pe;
          }
        }
        function Y(oe, H) {
          return ie(oe, H, (ce) => ce.ordered === oe.ordered);
        }
        function ie(oe, H, ce) {
          let X = -1;
          for (let pe of H.children)
            if (pe.type === oe.type && ce(pe) ? X++ : X = -1, pe === oe)
              return X;
        }
        function ee(oe, H) {
          let ce = Array.isArray(H) ? H : [H], X = -1, pe;
          for (; pe = oe.getParentNode(++X); )
            if (ce.includes(pe.type))
              return X;
          return -1;
        }
        function le(oe, H) {
        ...
        function W(oe, H, ce) {
          if (ce.proseWrap === "preserve" && H === `
`)
            return c;
          let X = ce.proseWrap === "always" && !le(oe, J);
          return H !== "" ? X ? d : " " : X ? D : "";
        }
        function K(oe, H, ce) {
          let X = oe.getValue(), pe = [], Ae = oe.map((ye) => ye.map((Ee, Be) => {
            let ve = $(ce(), H).formatted, ze = u(ve);
            return pe[Be] = Math.max(pe[Be] || 3, ze), { text: ve, width: ze };
          }, "children"), "children"), Ce = A(false);
          if (H.proseWrap !== "never")
            return [l, Ce];
          let fe = A(true);
          return [l, S(E(fe, Ce))];
          function A(ye) {
            let Ee = [re(Ae[0], ye), G(ye)];
            return Ae.length > 1 && Ee.push(p(N, Ae.slice(1).map((Be) => re(Be, ye)))), p(N, Ee);
          }
          function G(ye) {
            return `| ${pe.map((Be, ve) => {
          ...
          function re(ye, Ee) {
            return `| ${ye.map((ve, ze) => {
              ...
              if (Ee)
                return be;
              let Se = pe[ze] - Ye, Ie = X.align[ze], Oe = 0;
        ...
        function de(oe, H, ce) {
          let X = [], pe = null, { children: Ae } = oe.getValue();
          for (let [Ce, fe] of Ae.entries())
            switch (U(fe)) {
              case "start":
                pe === null && (pe = { index: Ce, offset: fe.position.end.offset });
                break;
              case "end":
                pe !== null && (X.push({ start: pe, end: { index: Ce, offset: fe.position.start.offset } }), pe = null);
                break;
              default:
                break;
            }
          return ue(oe, H, ce, { processor: (Ce, fe) => {
            if (X.length > 0) {
              ...
              if (A.start.index < fe && fe < A.end.index)
                return false;
              if (fe === A.end.index)
        ...
        function ue(oe, H, ce) {
          let X = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, { postprocessor: pe } = X, Ae = X.processor || (() => ce()), Ce = oe.getValue(), fe = [], A;
          return oe.each((G, re) => {
            let ye = G.getValue(), Ee = Ae(G, re);
            if (Ee !== false) {
              let Be = { parts: fe, prevNode: A, parentNode: Ce, options: H };
              Z(ye, Be) && (fe.push(c), A && q.has(A.type) || (se(ye, Be) || De(ye, Be)) && fe.push(c), De(ye, Be) && fe.push(c)), fe.push(Ee), A = ye;
            }
          }, "children"), pe ? pe(fe) : fe;
        }
        function Fe(oe) {
          if (oe.type === "html")
            return oe.value;
        ...
        function U(oe) {
          ...
          if (oe.type === "html")
            ...
            let ce;
            oe.type === "esComment" ? ce = oe : oe.type === "paragraph" && oe.children.length === 1 && oe.children[0].type === "esComment" && (ce = oe.children[0]), ce && (H = ce.value.match(/^prettier-ignore(?:-(start|end))?$/));
          }
          return H ? H[1] || "next" : false;
        }
        function Z(oe, H) {
          let ce = H.parts.length === 0, X = k.includes(oe.type), pe = oe.type === "html" && M.includes(H.parentNode.type);
          return !ce && !X && !pe;
        }
        function se(oe, H) {
          var ce, X, pe;
          let Ce = (H.prevNode && H.prevNode.type) === oe.type && L.has(oe.type), fe = H.parentNode.type === "listItem" && !H.parentNode.loose, A = ((ce = H.prevNode) === null || ce === void 0 ? void 0 : ce.type) === "listItem" && H.prevNode.loose, G = U(H.prevNode) === "next", re = oe.type === "html" && ((X = H.prevNode) === null || X === void 0 ? void 0 : X.type) === "html" && H.prevNode.position.end.line + 1 === oe.position.start.line, ye = oe.type === "html" && H.parentNode.type === "listItem" && ((pe = H.prevNode) === null || pe === void 0 ? void 0 : pe.type) === "paragraph" && H.prevNode.position.end.line + 1 === oe.position.start.line;
          return A || !(Ce || fe || G || re || ye);
        }
        function De(oe, H) {
          let ce = H.prevNode && H.prevNode.type === "list", X = oe.type === "code" && oe.isIndented;
          return ce && X;
        }
        function ge(oe) {
          let H = le(oe, ["linkReference", "imageReference"]);
          return H && (H.type !== "linkReference" || H.referenceType !== "full");
        }
        function he(oe) {
          let H = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : [], ce = [" ", ...Array.isArray(H) ? H : [H]];
          return new RegExp(ce.map((X) => `\\${X}`).join("|")).test(oe) ? `<${oe}>` : oe;
        }
        function we(oe, H) {
          let ce = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
          if (!oe)
            return "";
          if (ce)
          ...
          if (oe = oe.replace(/\\(["')])/g, "$1"), oe.includes('"') && oe.includes("'") && !oe.includes(")"))
            return `(${oe})`;
          let X = oe.split("'").length - 1, pe = oe.split('"').length - 1, Ae = X > pe ? '"' : pe > X || H.singleQuote ? "'" : '"';
          return oe = oe.replace(/\\/, "\\\\"), oe = oe.replace(new RegExp(`(${Ae})`, "g"), "\\$1"), `${Ae}${oe}${Ae}`;
        }
        function ke(oe, H, ce) {
          return oe < H ? H : oe > ce ? ce : oe;
        }
        function Re(oe) {
          let H = Number(oe.getName());
          if (H === 0)
            return false;
          let ce = oe.getParentNode().children[H - 1];
          return U(ce) === "next";
        }
        function Ne(oe) {
          return `[${t(oe.label)}]`;
        ...
        r.exports = { preprocess: o, print: Q, embed: f, massageAstNode: h, hasPrettierIgnore: Re, insertPragma: T };
      } }), fg = te({ "src/language-markdown/options.js"(e, r) {
        "use strict";
        ne();
        var t = Mt();
        r.exports = { proseWrap: t.proseWrap, singleQuote: t.singleQuote };
      } }), Dg = te({ "src/language-markdown/parsers.js"() {
        ne();
      ...
      } }), mg = te({ "src/language-markdown/index.js"(e, r) {
        "use strict";
        ne();
        ...
        r.exports = { languages: u, options: a, printers: i, parsers: n };
      } }), dg = te({ "src/language-html/clean.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), gg = te({ "src/language-html/constants.evaluate.js"(e, r) {
      ...
      } }), yg = te({ "src/language-html/utils/is-unknown-namespace.js"(e, r) {
        "use strict";
        ne();
        function t(s) {
        ...
        "use strict";
        ne();
        var { inferParserByLanguage: t, isFrontMatterNode: s } = Ue(), { builders: { line: a, hardline: n, join: u }, utils: { getDocParts: i, replaceTextEndOfLine: l } } = qe(), { CSS_DISPLAY_TAGS: p, CSS_DISPLAY_DEFAULT: d, CSS_WHITE_SPACE_TAGS: y, CSS_WHITE_SPACE_DEFAULT: g } = gg(), c = yg(), D = /* @__PURE__ */ new Set(["	", `
`, "\f", "\r", " "]), E = (A) => A.replace(/^[\t\n\f\r ]+/, ""), _ = (A) => A.replace(/[\t\n\f\r ]+$/, ""), w = (A) => E(_(A)), F = (A) => A.replace(/^[\t\f\r ]*\n/g, ""), S = (A) => F(_(A)), N = (A) => A.split(/[\t\n\f\r ]+/), I = (A) => A.match(/^[\t\n\f\r ]*/)[0], P = (A) => {
        ...
        function C(A) {
          return o(A) || A.type === "interpolation" || x(A);
        }
        function x(A) {
        ...
        function K(A, G) {
          if (A.name === "script" && !A.attrMap.src)
            return !A.attrMap.lang && !A.attrMap.type ? "babel" : le(A);
          if (A.name === "style")
            return W(A, G);
          if (G && X(A, G))
            return le(A) || !("src" in A.attrMap) && t(A.attrMap.lang, G);
        }
        function de(A) {
        ...
        function De(A, G) {
          ...
          for (let ye = A.stack.length - 1; ye >= 0; ye--) {
            let Ee = A.stack[ye];
            Ee && typeof Ee == "object" && !Array.isArray(Ee) && G(Ee) && re++;
          }
          return re;
        }
        function ge(A, G) {
...
`);
        ...
        function H(A, G) {
          return ce(A, G) && !oe.has(A.fullName);
        }
        function ce(A, G) {
          return G.parser === "vue" && A.type === "element" && A.parent.type === "root" && A.fullName.toLowerCase() !== "html";
        }
        function X(A, G) {
          return ce(A, G) && (H(A, G) || A.attrMap.lang && A.attrMap.lang !== "html");
        }
        function pe(A) {
          let G = A.fullName;
        ...
        e.isOctalDigit = u;
      } }), vg = te({ "node_modules/angular-html-parser/lib/compiler/src/aot/static_symbol.js"(e) {
        "use strict";
        ne(), Object.defineProperty(e, "__esModule", { value: true });
        var r = class {
          constructor(s, a, n) {
      ...
      } }), Cg = te({ "node_modules/angular-html-parser/lib/compiler/src/util.js"(e) {
        "use strict";
        ne(), Object.defineProperty(e, "__esModule", { value: true });
        var r = /-+([a-z0-9])/g;
        function t(o) {
          return o.replace(r, function() {
            for (var h = arguments.length, C = new Array(h), x = 0; x < h; x++)
              C[x] = arguments[x];
        ...
        function n(o, h, C) {
          let x = o.indexOf(h);
          return x == -1 ? C : [o.slice(0, x).trim(), o.slice(x + 1).trim()];
        }
        function u(o, h, C) {
        ...
        var p = class {
          ...
          visitStringMap(o, h) {
            let C = {};
            return Object.keys(o).forEach((x) => {
              C[x] = u(o[x], this, h);
            }), C;
          }
          visitPrimitive(o, h) {
        ...
        function S(o) {
          let h = "";
          for (let C = 0; C < o.length; C++) {
            let x = o.charCodeAt(C);
            if (x >= 55296 && x <= 56319 && o.length > C + 1) {
              let b = o.charCodeAt(C + 1);
              b >= 56320 && b <= 57343 && (C++, x = (x - 55296 << 10) + b - 56320 + 65536);
            }
            x <= 127 ? h += String.fromCharCode(x) : x <= 2047 ? h += String.fromCharCode(x >> 6 & 31 | 192, x & 63 | 128) : x <= 65535 ? h += String.fromCharCode(x >> 12 | 224, x >> 6 & 63 | 128, x & 63 | 128) : x <= 2097151 && (h += String.fromCharCode(x >> 18 & 7 | 240, x >> 12 & 63 | 128, x >> 6 & 63 | 128, x & 63 | 128));
          }
          return h;
        }
        e.utf8Encode = S;
...
`);
        ...
        e.Version = $;
        var f = typeof window < "u" && window, T = typeof self < "u" && typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && self, m = typeof globalThis < "u" && globalThis, v = m || f || T;
        e.global = v;
      } }), Eg = te({ "node_modules/angular-html-parser/lib/compiler/src/compile_metadata.js"(e) {
        "use strict";
        ne(), Object.defineProperty(e, "__esModule", { value: true });
        var r = vg(), t = Cg(), s = /^(?:(?:\[([^\]]+)\])|(?:\(([^\)]+)\)))|(\@[-\w]+)$/;
        function a(C) {
        ...
        function u(C) {
          if (!C || !C.reference)
            return null;
          let x = C.reference;
          if (x instanceof r.StaticSymbol)
            return x.name;
          if (x.__anonymousType)
            return x.__anonymousType;
          let b = t.stringify(x);
          return b.indexOf("(") >= 0 ? (b = `anonymous_${n++}`, x.__anonymousType = b) : b = a(b), b;
        }
        e.identifierName = u;
        function i(C) {
          let x = C.reference;
          return x instanceof r.StaticSymbol ? x.filePath : `./${t.stringify(x)}`;
        }
        e.identifierModuleUrl = i;
        function l(C, x) {
          return `View_${u({ reference: C })}_${x}`;
        }
        e.viewClassName = l;
        function p(C) {
        ...
        var E = class {
          constructor() {
            let { moduleUrl: C, styles: x, styleUrls: b } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            this.moduleUrl = C || null, this.styles = P(x), this.styleUrls = P(b);
          }
        };
        e.CompileStylesheetMetadata = E;
        var _ = class {
          constructor(C) {
            let { encapsulation: x, template: b, templateUrl: B, htmlAst: k, styles: M, styleUrls: R, externalStylesheets: q, animations: J, ngContentSelectors: L, interpolation: Q, isInline: V, preserveWhitespaces: j } = C;
            if (this.encapsulation = x, this.template = b, this.templateUrl = B, this.htmlAst = k, this.styles = P(M), this.styleUrls = P(R), this.externalStylesheets = P(q), this.animations = J ? f(J) : [], this.ngContentSelectors = L || [], Q && Q.length != 2)
              throw new Error("'interpolation' should have a start and an end symbol.");
        ...
        var w = class {
          static create(C) {
            let { isHost: x, type: b, isComponent: B, selector: k, exportAs: M, changeDetection: R, inputs: q, outputs: J, host: L, providers: Q, viewProviders: V, queries: j, guards: Y, viewQueries: ie, entryComponents: ee, template: le, componentViewType: W, rendererType: K, componentFactory: de } = C, ue = {}, Fe = {}, z = {};
            L != null && Object.keys(L).forEach((se) => {
              let De = L[se], ge = se.match(s);
              ge === null ? z[se] = De : ge[1] != null ? Fe[ge[1]] = De : ge[2] != null && (ue[ge[2]] = De);
            });
            let U = {};
            q == null ? void 0 : q.forEach((se) => {
              let De = t.splitAtColon(se, [se, se]);
              U[De[0]] = De[1];
            });
            let Z = {};
            return J == null ? void 0 : J.forEach((se) => {
              let De = t.splitAtColon(se, [se, se]);
              Z[De[0]] = De[1];
            }), new w({ isHost: x, type: b, isComponent: !!B, selector: k, exportAs: M, changeDetection: R, inputs: U, outputs: Z, hostListeners: ue, hostProperties: Fe, hostAttributes: z, providers: Q, viewProviders: V, queries: j, guards: Y, viewQueries: ie, entryComponents: ee, template: le, componentViewType: W, rendererType: K, componentFactory: de });
          }
          constructor(C) {
            let { isHost: x, type: b, isComponent: B, selector: k, exportAs: M, changeDetection: R, inputs: q, outputs: J, hostListeners: L, hostProperties: Q, hostAttributes: V, providers: j, viewProviders: Y, queries: ie, guards: ee, viewQueries: le, entryComponents: W, template: K, componentViewType: de, rendererType: ue, componentFactory: Fe } = C;
            this.isHost = !!x, this.type = b, this.isComponent = B, this.selector = k, this.exportAs = M, this.changeDetection = R, this.inputs = q, this.outputs = J, this.hostListeners = L, this.hostProperties = Q, this.hostAttributes = V, this.providers = P(j), this.viewProviders = P(Y), this.queries = P(ie), this.guards = ee, this.viewQueries = P(le), this.entryComponents = P(W), this.template = K, this.componentViewType = de, this.rendererType = ue, this.componentFactory = Fe;
          }
          toSummary() {
        ...
        var F = class {
          constructor(C) {
            let { type: x, name: b, pure: B } = C;
            this.type = x, this.name = b, this.pure = !!B;
          }
          toSummary() {
        ...
        var N = class {
          constructor(C) {
            let { type: x, providers: b, declaredDirectives: B, exportedDirectives: k, declaredPipes: M, exportedPipes: R, entryComponents: q, bootstrapComponents: J, importedModules: L, exportedModules: Q, schemas: V, transitiveModule: j, id: Y } = C;
            this.type = x || null, this.declaredDirectives = P(B), this.exportedDirectives = P(k), this.declaredPipes = P(M), this.exportedPipes = P(R), this.providers = P(b), this.entryComponents = P(q), this.bootstrapComponents = P(J), this.importedModules = P(L), this.exportedModules = P(Q), this.schemas = P(V), this.id = Y || null, this.transitiveModule = j || null;
          }
          toSummary() {
        ...
        var I = class {
          ...
          addProvider(C, x) {
            this.providers.push({ provider: C, module: x });
          }
          addDirective(C) {
        ...
        var $ = class {
          constructor(C, x) {
            let { useClass: b, useValue: B, useExisting: k, useFactory: M, deps: R, multi: q } = x;
            this.token = C, this.useClass = b || null, this.useValue = B, this.useExisting = k, this.useFactory = M || null, this.dependencies = R || null, this.multi = !!q;
          }
        };
        e.ProviderMeta = $;
        function f(C) {
          return C.reduce((x, b) => {
            let B = Array.isArray(b) ? f(b) : b;
            return x.concat(B);
          }, []);
        }
        e.flatten = f;
        ...
        function m(C, x, b) {
          let B;
          return b.isInline ? x.type.reference instanceof r.StaticSymbol ? B = `${x.type.reference.filePath}.${x.type.reference.name}.html` : B = `${u(C)}/${u(x.type)}.html` : B = b.templateUrl, x.type.reference instanceof r.StaticSymbol ? B : T(B);
        }
        e.templateSourceUrl = m;
        function v(C, x) {
          let b = C.moduleUrl.split(/\/\\/g), B = b[b.length - 1];
          return T(`css/${x}${B}.ngstyle.js`);
        }
        e.sharedStylesheetJitUrl = v;
        function o(C) {
          return T(`${u(C.type)}/module.ngfactory.js`);
        }
        e.ngModuleJitUrl = o;
        function h(C, x) {
          return T(`${u(C)}/${u(x.type)}.ngfactory.js`);
        }
        e.templateJitUrl = h;
      } }), Fg = te({ "node_modules/angular-html-parser/lib/compiler/src/parse_util.js"(e) {
        "use strict";
        ne(), Object.defineProperty(e, "__esModule", { value: true });
...
` && ++_ == y)); )
      ...
      } }), Ag = te({ "src/language-html/print-preprocess.js"(e, r) {
        "use strict";
        ne();
        var { ParseSourceSpan: t } = Fg(), { htmlTrim: s, getLeadingAndTrailingHtmlWhitespace: a, hasHtmlWhitespace: n, canHaveInterpolation: u, getNodeCssStyleDisplay: i, isDanglingSpaceSensitiveNode: l, isIndentationSensitiveNode: p, isLeadingSpaceSensitiveNode: d, isTrailingSpaceSensitiveNode: y, isWhitespaceSensitiveNode: g, isVueScriptTag: c } = Rt(), D = [_, w, S, I, P, T, $, f, m, N, v];
        function E(o, h) {
          for (let C of D)
            C(o, h);
          return o;
...
`) {
        ...
        function F(o, h, C) {
          o.walk((x) => {
            if (x.children)
              for (let b = 0; b < x.children.length; b++) {
                let B = x.children[b];
                if (B.type !== "text" && !h(B))
                  continue;
                B.type !== "text" && (B.type = "text", B.value = C(B));
                let k = B.prev;
                !k || k.type !== "text" || (k.value += B.value, k.sourceSpan = new t(k.sourceSpan.start, B.sourceSpan.end), x.removeChild(B), b--);
              }
          });
        }
        function S(o) {
          ...
          o.walk((C) => {
            if (C.children)
              for (let x = 0; x < C.children.length; x++) {
                ...
                B.value += `<${b.rawName}>` + b.firstChild.value + `</${b.rawName}>` + k.value, B.sourceSpan = new t(B.sourceSpan.start, k.sourceSpan.end), B.isTrailingSpaceSensitive = k.isTrailingSpaceSensitive, B.hasTrailingSpaces = k.hasTrailingSpaces, C.removeChild(b), x--, C.removeChild(k);
              }
          });
        }
        function I(o, h) {
          ...
          o.walk((x) => {
            if (u(x))
              for (let b of x.children) {
                if (b.type !== "text")
                  continue;
                let B = b.sourceSpan.start, k = null, M = b.value.split(C);
                for (let R = 0; R < M.length; R++, B = k) {
                  let q = M[R];
                  if (R % 2 === 0) {
                    k = B.moveBy(q.length), q.length > 0 && x.insertChildBefore(b, { type: "text", value: q, sourceSpan: new t(B, k) });
                    continue;
                  }
                  k = B.moveBy(q.length + 4), x.insertChildBefore(b, { type: "interpolation", sourceSpan: new t(B, k), children: q.length === 0 ? [] : [{ type: "text", value: q, sourceSpan: new t(B.moveBy(2), k.moveBy(-2)) }] });
                }
                x.removeChild(b);
              }
          });
          ...
          o.walk((h) => {
            ...
            if (!C)
              for (let b = 0; b < h.children.length; b++) {
                ...
                M ? (B.value = M, B.sourceSpan = new t(B.sourceSpan.start.moveBy(k.length), B.sourceSpan.end.moveBy(-R.length)), k && (q && (q.hasTrailingSpaces = true), B.hasLeadingSpaces = true), R && (B.hasTrailingSpaces = true, J && (J.hasLeadingSpaces = true))) : (h.removeChild(B), b--, (k || R) && (q && (q.hasTrailingSpaces = true), J && (J.hasLeadingSpaces = true)));
              }
            h.isWhitespaceSensitive = C, h.isIndentationSensitive = x;
          });
        }
        function $(o) {
          o.walk((h) => {
        ...
        function m(o, h) {
          o.walk((C) => {
            ...
            if (x) {
              ...
              for (let b = 0; b < x.length; b++) {
                let B = x[b];
                B.isLeadingSpaceSensitive = (b === 0 || B.prev.isTrailingSpaceSensitive) && B.isLeadingSpaceSensitive, B.isTrailingSpaceSensitive = (b === x.length - 1 || B.next.isLeadingSpaceSensitive) && B.isTrailingSpaceSensitive;
              }
            }
          });
        }
        function v(o, h) {
          if (h.parser === "vue") {
            let C = o.children.find((b) => c(b, h));
            if (!C)
              return;
            let { lang: x } = C.attrMap;
            (x === "ts" || x === "typescript") && (h.__should_parse_vue_template_with_ts = true);
          }
        }
        r.exports = E;
      } }), Sg = te({ "src/language-html/pragma.js"(e, r) {
        "use strict";
        ne();
        function t(a) {
...
` + a.replace(/^\s*\n/, "");
        ...
        "use strict";
        ne();
        var t = Zt(), { isNonEmptyArray: s } = Ue(), { builders: { indent: a, join: n, line: u, softline: i, hardline: l }, utils: { replaceTextEndOfLine: p } } = qe(), { locStart: d, locEnd: y } = au(), { isTextLikeNode: g, getLastDescendant: c, isPreLikeNode: D, hasPrettierIgnore: E, shouldPreserveContent: _, isVueSfcBlock: w } = Rt();
        function F(L, Q) {
          return [L.isSelfClosing ? "" : S(L, Q), N(L, Q)];
        }
        function S(L, Q) {
          return L.lastChild && o(L.lastChild) ? "" : [I(L, Q), $(L, Q)];
        }
        function N(L, Q) {
          return (L.next ? m(L.next) : v(L.parent)) ? "" : [f(L, Q), P(L, Q)];
        }
        function I(L, Q) {
          return v(L) ? f(L.lastChild, Q) : "";
        }
        function P(L, Q) {
          return o(L) ? $(L.parent, Q) : h(L) ? q(L.next) : "";
        }
        function $(L, Q) {
        ...
        function b(L, Q, V) {
          ...
          let Y = j.prev && j.prev.type === "comment" && C(j.prev.value), ie = typeof Y == "boolean" ? () => Y : Array.isArray(Y) ? (ue) => Y.includes(ue.rawName) : () => false, ee = L.map((ue) => {
            let Fe = ue.getValue();
            return ie(Fe) ? p(Q.originalText.slice(d(Fe), y(Fe))) : V();
          }, "attrs"), le = j.type === "element" && j.fullName === "script" && j.attrs.length === 1 && j.attrs[0].fullName === "src" && j.children.length === 0, K = Q.singleAttributePerLine && j.attrs.length > 1 && !w(j, Q) ? l : u, de = [a([le ? " " : u, n(K, ee)])];
          return j.firstChild && x(j.firstChild) || j.isSelfClosing && v(j.parent) || le ? de.push(j.isSelfClosing ? " " : "") : de.push(Q.bracketSameLine ? j.isSelfClosing ? " " : "" : j.isSelfClosing ? u : i), de;
        }
        function B(L) {
          return L.firstChild && x(L.firstChild) ? "" : J(L);
        }
        function k(L, Q, V) {
          let j = L.getValue();
        ...
        function M(L, Q) {
          return L.prev && h(L.prev) ? "" : [R(L, Q), q(L)];
        }
        function R(L, Q) {
          return x(L) ? J(L.parent) : m(L) ? f(L.prev, Q) : "";
        }
        function q(L) {
          switch (L.type) {
            case "ieConditionalComment":
        ...
        r.exports = { printClosingTag: F, printClosingTagStart: S, printClosingTagStartMarker: $, printClosingTagEndMarker: f, printClosingTagSuffix: P, printClosingTagEnd: N, needsToBorrowLastChildClosingTagEndMarker: v, needsToBorrowParentClosingTagStartMarker: o, needsToBorrowPrevClosingTagEndMarker: m, printOpeningTag: k, printOpeningTagStart: M, printOpeningTagPrefix: R, printOpeningTagStartMarker: q, printOpeningTagEndMarker: J, needsToBorrowNextOpeningTagStartMarker: h, needsToBorrowParentOpeningTagEndMarker: x };
      } }), xg = te({ "node_modules/parse-srcset/src/parse-srcset.js"(e, r) {
        ne(), function(t, s) {
...
` || $ === "\f" || $ === "\r";
            ...
            function u($) {
              var f, T = $.exec(t.substring(S));
              if (T)
                return f = T[0], S += f.length, f;
            }
            for (var i = t.length, l = /^[ \t\n\r\u000c]+/, p = /^[, \t\n\r\u000c]+/, d = /^[^ \t\n\r\u000c]+/, y = /[,]+$/, g = /^\d+$/, c = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/, D, E, _, w, F, S = 0, N = []; ; ) {
              if (u(p), S >= i)
                return N;
            ...
            function I() {
              for (u(l), _ = "", w = "in descriptor"; ; ) {
                if (F = t.charAt(S), w === "in descriptor")
                  if (n(F))
            ...
            function P() {
              var $ = false, f, T, m, v, o = {}, h, C, x, b, B;
              for (v = 0; v < E.length; v++)
                h = E[v], C = h[h.length - 1], x = h.substring(0, h.length - 1), b = parseInt(x, 10), B = parseFloat(x), g.test(x) && C === "w" ? ((f || T) && ($ = true), b === 0 ? $ = true : f = b) : c.test(x) && C === "x" ? ((f || T || m) && ($ = true), B < 0 ? $ = true : T = B) : g.test(x) && C === "h" ? ((m || T) && ($ = true), b === 0 ? $ = true : m = b) : $ = true;
              $ ? a && a.error && a.error("Invalid srcset descriptor found in '" + t + "' at '" + h + "'.") : (o.url = D, f && (o.w = f), T && (o.d = T), m && (o.h = m), N.push(o));
            }
          };
        });
      } }), bg = te({ "src/language-html/syntax-attribute.js"(e, r) {
        "use strict";
        ne();
        var t = xg(), { builders: { ifBreak: s, join: a, line: n } } = qe();
        function u(l) {
          ...
          let c = d ? "w" : y ? "h" : "d", D = d ? "w" : y ? "h" : "x", E = (I) => Math.max(...I), _ = p.map((I) => I.url), w = E(_.map((I) => I.length)), F = p.map((I) => I[c]).map((I) => I ? I.toString() : ""), S = F.map((I) => {
            let P = I.indexOf(".");
          ...
          return a([",", n], _.map((I, P) => {
            let $ = [I], f = F[P];
            if (f) {
              let T = w - I.length + 1, m = N - S[P], v = " ".repeat(T + m);
              $.push(s(v, " "), f + D);
            }
            return $;
          }));
      ...
      } }), Tg = te({ "src/language-html/syntax-vue.js"(e, r) {
        "use strict";
        ne();
        ...
        function b(k, M, R) {
          let q = (ee) => new RegExp(ee.join("|")).test(k.fullName), J = () => v(k.value), L = false, Q = (ee, le) => {
            ...
            return s([n([l, ee]), le ? l : ""]);
          }, Y = (ee) => L ? V(ee) : j(ee), ie = (ee, le) => M(ee, Object.assign({ __onHtmlBindingRoot: Q, __embeddedInHtml: true }, le));
          ...
          if (R.parser === "angular") {
            let ee = (z, U) => ie(z, Object.assign(Object.assign({}, U), {}, { trailingComma: "none" })), le = ["^\\*"], W = ["^\\(.+\\)$", "^on-"], K = ["^\\[.+\\]$", "^bind(on)?-", "^ng-(if|show|hide|class|style)$"], de = ["^i18n(-.+)?$"];
            if (q(W))
          ...
          switch (J.type) {
            case "element": {
              ...
              if (!J.isSelfClosing && $(J, q)) {
                ...
                if (!L)
                  return;
                let Q = x(J, q), V = /^\s*$/.test(Q), j = "";
                return V || (j = R(T(Q), { parser: L, __embeddedInHtml: true }, { stripTrailingHardline: true }), V = j === ""), [E(J, q), s(_(k, q, M)), V ? "" : a, j, V ? "" : a, g(J, q), c(J, q)];
              }
              break;
            }
            case "text": {
              if (P(J.parent)) {
                ...
                if (L) {
                  ...
                  return [t, E(J, q), R(Q, V, { stripTrailingHardline: true }), c(J, q)];
                }
              } else if (J.parent.type === "interpolation") {
                let L = { __isInHtmlInterpolation: true, __embeddedInHtml: true };
                return q.parser === "angular" ? (L.parser = "__ng_interpolation", L.trailingComma = "none") : q.parser === "vue" ? L.parser = q.__should_parse_vue_template_with_ts ? "__vue_ts_expression" : "__vue_expression" : L.parser = "__js_expression", [n([u, R(J.value, L, { stripTrailingHardline: true })]), J.parent.next && D(J.parent.next) ? " " : u];
              }
              break;
            }
            case "attribute": {
        ...
        "use strict";
        ne();
        var { builders: { breakParent: t, group: s, ifBreak: a, line: n, softline: u, hardline: i }, utils: { replaceTextEndOfLine: l } } = qe(), { locStart: p, locEnd: d } = au(), { forceBreakChildren: y, forceNextEmptyLine: g, isTextLikeNode: c, hasPrettierIgnore: D, preferHardlineAsLeadingSpaces: E } = Rt(), { printOpeningTagPrefix: _, needsToBorrowNextOpeningTagStartMarker: w, printOpeningTagStartMarker: F, needsToBorrowPrevClosingTagEndMarker: S, printClosingTagEndMarker: N, printClosingTagSuffix: I, needsToBorrowParentClosingTagStartMarker: P } = ur();
        function $(m, v, o) {
          let h = m.getValue();
          return D(h) ? [_(h, v), ...l(v.originalText.slice(p(h) + (h.prev && w(h.prev) ? F(h).length : 0), d(h) - (h.next && S(h.next) ? N(h, v).length : 0))), I(h, v)] : o();
        }
        function f(m, v) {
          return c(m) && c(v) ? m.isTrailingSpaceSensitive ? m.hasTrailingSpaces ? E(v) ? i : n : "" : E(v) ? i : u : w(m) && (D(v) || v.firstChild || v.isSelfClosing || v.type === "element" && v.attrs.length > 0) || m.type === "element" && m.isSelfClosing && S(v) ? "" : !v.isLeadingSpaceSensitive || E(v) || S(v) && m.lastChild && P(m.lastChild) && m.lastChild.lastChild && P(m.lastChild.lastChild) ? i : v.hasLeadingSpaces ? n : u;
        }
        function T(m, v, o) {
          let h = m.getValue();
          if (y(h))
            return [t, ...m.map((x) => {
              let b = x.getValue(), B = b.prev ? f(b.prev, b) : "";
              return [B ? [B, g(b.prev) ? i : ""] : "", $(x, v, o)];
            }, "children")];
          ...
          return m.map((x, b) => {
            ...
            if (c(B)) {
              if (B.prev && c(B.prev)) {
                let Q = f(B.prev, B);
                if (Q)
                  return g(B.prev) ? [i, i, $(x, v, o)] : [Q, $(x, v, o)];
              }
              return $(x, v, o);
            }
            let k = [], M = [], R = [], q = [], J = B.prev ? f(B.prev, B) : "", L = B.next ? f(B, B.next) : "";
            return J && (g(B.prev) ? k.push(i, i) : J === i ? k.push(i) : c(B.prev) ? M.push(J) : M.push(a("", u, { groupId: C[b - 1] }))), L && (g(B) ? c(B.next) && q.push(i, i) : L === i ? c(B.next) && q.push(i) : R.push(L)), [...k, s([...M, s([$(x, v, o), ...R], { id: C[b] })]), ...q];
          }, "children");
        }
        r.exports = { printChildren: T };
      } }), Ng = te({ "src/language-html/print/element.js"(e, r) {
        "use strict";
        ne();
        var { builders: { breakParent: t, dedentToRoot: s, group: a, ifBreak: n, indentIfBreak: u, indent: i, line: l, softline: p }, utils: { replaceTextEndOfLine: d } } = qe(), y = Lo(), { shouldPreserveContent: g, isScriptLikeTag: c, isVueCustomBlock: D, countParents: E, forceBreakContent: _ } = Rt(), { printOpeningTagPrefix: w, printOpeningTag: F, printClosingTagSuffix: S, printClosingTag: N, needsToBorrowPrevClosingTagEndMarker: I, needsToBorrowLastChildClosingTagEndMarker: P } = ur(), { printChildren: $ } = Oo();
        function f(T, m, v) {
          let o = T.getValue();
          if (g(o, m))
            return [w(o, m), a(F(T, m, v)), ...d(y(o, m)), ...N(o, m), S(o, m)];
          let h = o.children.length === 1 && o.firstChild.type === "interpolation" && o.firstChild.isLeadingSpaceSensitive && !o.firstChild.hasLeadingSpaces && o.lastChild.isTrailingSpaceSensitive && !o.lastChild.hasTrailingSpaces, C = Symbol("element-attr-group-id"), x = (M) => a([a(F(T, m, v), { id: C }), M, N(o, m)]), b = (M) => h ? u(M, { groupId: C }) : (c(o) || D(o, m)) && o.parent.type === "root" && m.parser === "vue" && !m.vueIndentScriptAndStyle ? M : i(M), B = () => h ? n(p, "", { groupId: C }) : o.firstChild.hasLeadingSpaces && o.firstChild.isLeadingSpaceSensitive ? l : o.firstChild.type === "text" && o.isWhitespaceSensitive && o.isIndentationSensitive ? s(p) : p, k = () => (o.next ? I(o.next) : P(o.parent)) ? o.lastChild.hasTrailingSpaces && o.lastChild.isTrailingSpaceSensitive ? " " : "" : h ? n(p, "", { groupId: C }) : o.lastChild.hasTrailingSpaces && o.lastChild.isTrailingSpaceSensitive ? l : (o.lastChild.type === "comment" || o.lastChild.type === "text" && o.isWhitespaceSensitive && o.isIndentationSensitive) && new RegExp(`\\n[\\t ]{${m.tabWidth * E(T, (R) => R.parent && R.parent.type !== "root")}}$`).test(o.lastChild.value) ? "" : p;
          return o.children.length === 0 ? x(o.hasDanglingSpaces && o.isDanglingSpaceSensitive ? l : "") : x([_(o) ? t : "", b([B(), $(T, m, v)]), k()]);
        }
        r.exports = { printElement: f };
      } }), wg = te({ "src/language-html/printer-html.js"(e, r) {
        "use strict";
        ne();
        var { builders: { fill: t, group: s, hardline: a, literalline: n }, utils: { cleanDoc: u, getDocParts: i, isConcat: l, replaceTextEndOfLine: p } } = qe(), d = dg(), { countChars: y, unescapeQuoteEntities: g, getTextValueParts: c } = Rt(), D = Ag(), { insertPragma: E } = Sg(), { locStart: _, locEnd: w } = au(), F = Bg(), { printClosingTagSuffix: S, printClosingTagEnd: N, printOpeningTagPrefix: I, printOpeningTagStart: P } = ur(), { printElement: $ } = Ng(), { printChildren: f } = Oo();
        function T(m, v, o) {
          let h = m.getValue();
          switch (h.type) {
            case "front-matter":
            ...
            case "text": {
              if (h.parent.type === "interpolation") {
                let x = /\n[^\S\n]*$/, b = x.test(h.value), B = b ? h.value.replace(x, "") : h.value;
                return [...p(B), b ? a : ""];
              }
              let C = u([I(h, v), ...c(h), S(h, v)]);
              return l(C) || C.type === "fill" ? t(i(C)) : C;
            }
            case "docType":
              return [s([P(h, v), " ", h.value.replace(/^html\b/i, "html").replace(/\s+/g, " ")]), N(h, v)];
            case "comment":
              return [I(h, v), ...p(v.originalText.slice(_(h), w(h)), n), S(h, v)];
            case "attribute": {
              if (h.value === null)
                return h.rawName;
              let C = g(h.value), x = y(C, "'"), b = y(C, '"'), B = x < b ? "'" : '"';
              return [h.rawName, "=", B, ...p(B === '"' ? C.replace(/"/g, "&quot;") : C.replace(/'/g, "&apos;")), B];
            }
            default:
              throw new Error(`Unexpected node type ${h.type}`);
          }
        }
        r.exports = { preprocess: D, print: T, insertPragma: E, massageAstNode: d, embed: F };
      } }), _g = te({ "src/language-html/options.js"(e, r) {
        "use strict";
        ne();
        var t = Mt(), s = "HTML";
      ...
      } }), Pg = te({ "src/language-html/parsers.js"() {
        ne();
      ...
      } }), Lg = te({ "src/language-yaml/pragma.js"(e, r) {
        "use strict";
        ne();
        function t(n) {
...
${n}`;
      ...
      } }), Og = te({ "src/language-yaml/loc.js"(e, r) {
        "use strict";
        ne();
        function t(a) {
          return a.position.start.offset;
        ...
        r.exports = { locStart: t, locEnd: s };
      } }), jg = te({ "src/language-yaml/embed.js"(e, r) {
        "use strict";
        ne();
        function t(s, a, n, u) {
        ...
        function u(f, T, m) {
          return T("children" in f ? Object.assign(Object.assign({}, f), {}, { children: f.children.map((v) => u(v, T, f)) }) : f, m);
        }
        function i(f, T, m) {
          Object.defineProperty(f, T, { get: m, enumerable: false });
        }
        function l(f, T) {
          let m = 0, v = T.length;
...
` && m++, m === 1 && /\S/.test(h))
        ...
        function g(f) {
          ...
          if (T.type === "documentBody") {
            let m = f.getParentNode();
            return S(m.head) && y(t(m.head.endComments));
          }
        ...
        function N(f) {
          ...
          for (let v of f.split(/( +)/))
            v !== " " ? m === " " ? T.push(v) : T.push((T.pop() || "") + v) : m === void 0 && T.unshift(""), m = v;
...
`).map((o, h, C) => h === 0 && h === C.length - 1 ? o : h !== 0 && h !== C.length - 1 ? o.trim() : h === 0 ? o.trimEnd() : o.trimStart());
        ...
        function P(f, T) {
          let { parentIndent: m, isLastDescendant: v, options: o } = T, h = f.position.start.line === f.position.end.line ? "" : o.originalText.slice(f.position.start.offset, f.position.end.offset).match(/^[^\n]*\n(.*)$/s)[1], C;
          if (f.indent === null) {
            let B = h.match(/^(?<leadingSpace> *)[^\n\r ]/m);
            C = B ? B.groups.leadingSpace.length : Number.POSITIVE_INFINITY;
          } else
            C = f.indent - 1 + m;
          let x = h.split(`
`).map((B) => B.slice(C));
          if (o.proseWrap === "preserve" || f.type === "blockLiteral")
            return b(x.map((B) => B.length === 0 ? [] : [B]));
          return b(x.map((B) => B.length === 0 ? [] : N(B)).reduce((B, k, M) => M !== 0 && x[M - 1].length > 0 && k.length > 0 && !/^\s/.test(k[0]) && !/^\s|\s$/.test(t(B)) ? [...B.slice(0, -1), [...t(B), ...k]] : [...B, k], []).map((B) => B.reduce((k, M) => k.length > 0 && /\s$/.test(t(k)) ? [...k.slice(0, -1), t(k) + " " + M] : [...k, M], [])).map((B) => o.proseWrap === "never" ? [B.join(" ")] : B));
          function b(B) {
            if (f.chomping === "keep")
            ...
            for (let M = B.length - 1; M >= 0 && B[M].length === 0; M--)
              k++;
            return k === 0 ? B : k >= 2 && !v ? B.slice(0, -(k - 1)) : B.slice(0, -k);
          }
        }
        function $(f) {
          if (!f)
      ...
      } }), Mg = te({ "src/language-yaml/print/flow-mapping-sequence.js"(e, r) {
        "use strict";
        ne();
        var { builders: { ifBreak: t, line: s, softline: a, hardline: n, join: u } } = qe(), { isEmptyNode: i, getLast: l, hasEndComments: p } = $t(), { printNextEmptyLine: d, alignWithSpaces: y } = Mr();
        function g(D, E, _) {
          let w = D.getValue(), F = w.type === "flowMapping", S = F ? "{" : "[", N = F ? "}" : "]", I = a;
          F && w.children.length > 0 && _.bracketSpacing && (I = s);
          let P = l(w.children), $ = P && P.type === "flowMappingItem" && i(P.key) && i(P.value);
          return [S, y(_.tabWidth, [I, c(D, E, _), _.trailingComma === "none" ? "" : t(","), p(w) ? [n, u(n, D.map(E, "endComments"))] : ""]), $ ? "" : I, N];
        }
        function c(D, E, _) {
          let w = D.getValue();
          return D.map((S, N) => [E(), N === w.children.length - 1 ? "" : [",", s, w.children[N].position.start.line !== w.children[N + 1].position.start.line ? d(S, _.originalText) : ""]], "children");
        }
        r.exports = { printFlowMapping: g, printFlowSequence: g };
      } }), Rg = te({ "src/language-yaml/print/mapping-item.js"(e, r) {
        "use strict";
        ne();
        var { builders: { conditionalGroup: t, group: s, hardline: a, ifBreak: n, join: u, line: i } } = qe(), { hasLeadingComments: l, hasMiddleComments: p, hasTrailingComment: d, hasEndComments: y, isNode: g, isEmptyNode: c, isInlineNode: D } = $t(), { alignWithSpaces: E } = Mr();
        function _(N, I, P, $, f) {
          let { key: T, value: m } = N, v = c(T), o = c(m);
          if (v && o)
            return ": ";
          let h = $("key"), C = F(N) ? " " : "";
          if (o)
            return N.type === "flowMappingItem" && I.type === "flowMapping" ? h : N.type === "mappingItem" && w(T.content, f) && !d(T.content) && (!I.tag || I.tag.value !== "tag:yaml.org,2002:set") ? [h, C, ":"] : ["? ", E(2, h)];
          let x = $("value");
          if (v)
            return [": ", E(2, x)];
          if (l(m) || !D(T.content))
            return ["? ", E(2, h), a, u("", P.map($, "value", "leadingComments").map((q) => [q, a])), ": ", E(2, x)];
          if (S(T.content) && !l(T.content) && !p(T.content) && !d(T.content) && !y(T) && !l(m.content) && !p(m.content) && !y(m) && w(m.content, f))
            return [h, C, ": ", x];
          let b = Symbol("mappingKey"), B = s([n("? "), s(E(2, h), { id: b })]), k = [a, ": ", E(2, x)], M = [C, ":"];
          l(m.content) || y(m) && m.content && !g(m.content, ["mapping", "sequence"]) || I.type === "mapping" && d(T.content) && D(m.content) || g(m.content, ["mapping", "sequence"]) && m.content.tag === null && m.content.anchor === null ? M.push(a) : m.content && M.push(i), M.push(x);
          let R = E(f.tabWidth, M);
          return w(T.content, f) && !l(T.content) && !p(T.content) && !y(T) ? t([[h, R]]) : t([[B, n(k, R, { groupId: b })]]);
        }
        function w(N, I) {
          if (!N)
            return true;
...
`);
        ...
        r.exports = _;
      } }), $g = te({ "src/language-yaml/print/block.js"(e, r) {
        "use strict";
        ne();
        var { builders: { dedent: t, dedentToRoot: s, fill: a, hardline: n, join: u, line: i, literalline: l, markAsRoot: p }, utils: { getDocParts: d } } = qe(), { getAncestorCount: y, getBlockValueLineContents: g, hasIndicatorComment: c, isLastDescendantNode: D, isNode: E } = $t(), { alignWithSpaces: _ } = Mr();
        function w(F, S, N) {
          let I = F.getValue(), P = y(F, (v) => E(v, ["sequence", "mapping"])), $ = D(F), f = [I.type === "blockFolded" ? ">" : "|"];
          I.indent !== null && f.push(I.indent.toString()), I.chomping !== "clip" && f.push(I.chomping === "keep" ? "+" : "-"), c(I) && f.push(" ", S("indicatorComment"));
          let T = g(I, { parentIndent: P, isLastDescendant: $, options: N }), m = [];
          for (let [v, o] of T.entries())
            v === 0 && m.push(n), m.push(a(d(u(i, o)))), v !== T.length - 1 ? m.push(o.length === 0 ? n : p(l)) : I.chomping === "keep" && $ && m.push(s(o.length === 0 ? n : l));
          return I.indent === null ? f.push(t(_(N.tabWidth, m))) : f.push(s(_(I.indent - 1 + P, m))), f;
        }
        r.exports = w;
      } }), Vg = te({ "src/language-yaml/printer-yaml.js"(e, r) {
        "use strict";
        ne();
        ...
        function M(j, Y, ie) {
          let ee = j.getValue(), le = [];
          ee.type !== "mappingValue" && S(ee) && le.push([u(n, j.map(ie, "leadingComments")), n]);
          let { tag: W, anchor: K } = ee;
          W && le.push(ie("tag")), W && K && le.push(" "), K && le.push(ie("anchor"));
          let de = "";
          T(ee, ["mapping", "sequence", "comment", "directive", "mappingItem", "sequenceItem"]) && !f(j) && (de = h(j, Y.originalText)), (W || K) && (T(ee, ["sequence", "mapping"]) && !N(ee) ? le.push(n) : le.push(" ")), N(ee) && le.push([ee.middleComments.length === 1 ? "" : n, u(n, j.map(ie, "middleComments")), n]);
          let ue = j.getParentNode();
          return $(j) ? le.push(y(Y.originalText.slice(ee.position.start.offset, ee.position.end.offset).trimEnd(), p)) : le.push(a(R(ee, ue, j, Y, ie))), I(ee) && !T(ee, ["document", "documentHead"]) && le.push(l([ee.type === "mappingValue" && !ee.content ? "" : " ", ue.type === "mappingKey" && j.getParentNode(2).type === "mapping" && m(ee) ? "" : t, ie("trailingComment")])), C(ee) && le.push(o(ee.type === "sequenceItem" ? 2 : 0, [n, u(n, j.map((Fe) => [g(Y.originalText, Fe.getValue(), E) ? n : "", ie()], "endComments"))])), le.push(de), le;
        }
        function R(j, Y, ie, ee, le) {
          switch (j.type) {
            case "root": {
              let { children: W } = j, K = [];
              ie.each((ue, Fe) => {
                let z = W[Fe], U = W[Fe + 1];
                Fe !== 0 && K.push(n), K.push(le()), J(z, U) ? (K.push(n, "..."), I(z) && K.push(" ", le("trailingComment"))) : U && !I(U.head) && K.push(n, "---");
              }, "children");
              let de = F(j);
            ...
            case "document": {
              ...
              return L(j, W, Y, ee) === "head" && ((j.head.children.length > 0 || j.head.endComments.length > 0) && K.push(le("head")), I(j.head) ? K.push(["---", " ", le(["head", "trailingComment"])]) : K.push("---")), q(j) && K.push(le("body")), u(n, K);
            }
            case "documentHead":
              return u(n, [...ie.map(le, "children"), ...ie.map(le, "endComments")]);
            case "documentBody": {
              ...
              return [u(n, ie.map(le, "children")), de, u(n, ie.map(le, "endComments"))];
            }
            case "directive":
            ...
            case "mapping":
            case "sequence":
              return u(n, ie.map(le, "children"));
            case "sequenceItem":
              return ["- ", o(2, j.content ? le("content") : "")];
            case "mappingKey":
            case "mappingValue":
              return j.content ? le("content") : "";
            case "mappingItem":
            case "flowMappingItem":
              return B(j, Y, ie, le, ee);
            case "flowMapping":
              return x(ie, le, ee);
            case "flowSequence":
              return b(ie, le, ee);
        ...
        function Q(j, Y, ie) {
          let ee = w(j, Y, ie);
          return u(n, ee.map((le) => s(d(u(i, le)))));
        }
        function V(j, Y) {
          if (T(Y))
      ...
      } }), Wg = te({ "src/language-yaml/options.js"(e, r) {
        "use strict";
        ne();
        var t = Mt();
        r.exports = { bracketSpacing: t.bracketSpacing, singleQuote: t.singleQuote, proseWrap: t.proseWrap };
      } }), Hg = te({ "src/language-yaml/parsers.js"() {
        ne();
      } }), Gg = te({ "node_modules/linguist-languages/data/YAML.json"(e, r) {
      ...
      } }), Ug = te({ "src/language-yaml/index.js"(e, r) {
        "use strict";
        ne();
      ...
      } }), Jg = te({ "src/languages.js"(e, r) {
        "use strict";
        ne(), r.exports = [Td(), Gd(), Zd(), ig(), mg(), kg(), Ug()];
      } });
      ne();
      var { version: zg } = Ia(), Lt = Gm(), { getSupportInfo: Xg } = Xn(), Kg = Um(), Yg = Jg(), Qg = qe();
      function Nt(e) {
...
//# sourceMappingURL=formatter-GCLXO5IP-ZRIFQTNS.js.map
