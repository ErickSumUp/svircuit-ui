...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-ZSWRAKUX.js";
import {
  ActionBar
} from "./chunk-JP46S7VW.js";
import "./chunk-2DEZ3CNH.js";
import "./chunk-X53JRCZD.js";
import "./chunk-5VZK47UO.js";
import "./chunk-IPBN2ETL.js";
import {
  require_react_dom
} from "./chunk-2765ILV7.js";
import {
  index_modern_default
} from "./chunk-G6R5X4QX.js";
import {
  curriedDarken$1,
  curriedLighten$1,
  curriedOpacify$1,
  ...
  rgba
} from "./chunk-XYKHEW7T.js";
import {
  require_uniq
} from "./chunk-33LHS3NU.js";
import {
  require_cloneDeep
} from "./chunk-ONTBKEY6.js";
import {
  DocsContext,
  Preview,
  composeConfigs,
  ...
  filterArgTypes,
  prepareMeta
} from "./chunk-BJ3JU4R7.js";
import "./chunk-BO3R2ZPC.js";
import "./chunk-V27W47CK.js";
import {
  require_mapValues
} from "./chunk-AE6N56OT.js";
import "./chunk-6QZZJTN4.js";
import "./chunk-NEVMD4ST.js";
import {
  require_pickBy
} from "./chunk-NGQPZQN3.js";
import "./chunk-FIRYA5OZ.js";
import "./chunk-2MACJKT7.js";
import "./chunk-LOVFDPCE.js";
import "./chunk-T6HA5TZH.js";
import "./chunk-TLQQMZGS.js";
import "./chunk-HSNDHKNH.js";
...
import "./chunk-ZI7T7YNG.js";
import "./chunk-6JUMOWIJ.js";
import "./chunk-WLRUY46R.js";
...
// node_modules/@storybook/addon-docs/dist/chunk-MA2MUXQN.mjs
...
// node_modules/@storybook/blocks/node_modules/@storybook/core-events/dist/index.mjs
...
// node_modules/@storybook/blocks/node_modules/@storybook/channels/dist/index.mjs
...
var EmptyBlock = (props) => import_react2.default.createElement(Wrapper, { ...props, className: "docblock-emptyblock" });
...
var Source = ({ isLoading, error, language, code, dark, format: format2, ...rest }) => {
  ...
  let syntaxHighlighter = import_react.default.createElement(StyledSyntaxHighlighter, { bordered: true, copyable: true, format: format2, language, className: "docblock-source", ...rest }, code);
  if (typeof dark > "u")
...
var UNSTYLED_SELECTORS = [".sb-unstyled", ".sbdocs-preview", ".sbdocs-pre", ".sb-story", ".docblock-source", ".docblock-argstable", ".sbdocs-title", ".sbdocs-subtitle", ".docblock-icongallery", ".docblock-emptyblock", ".docblock-typeset", ".docblock-colorpalette"].join(", ");
var toGlobalSelector = (element) => `& :where(${element}:not(${UNSTYLED_SELECTORS}, :where(${UNSTYLED_SELECTORS}) ${element}))`;
var breakpoint = 600;
var Title = emotion_styled_browser_esm_default.h1(withReset, ({ theme }) => ({ color: theme.color.defaultText, fontSize: theme.typography.size.m3, fontWeight: theme.typography.weight.bold, lineHeight: "32px", [`@media (min-width: ${breakpoint}px)`]: { fontSize: theme.typography.size.l1, lineHeight: "36px", marginBottom: ".5rem" } }));
...
var InlineStory = (props) => {
  let storyRef = (0, import_react7.useRef)(), [showLoader, setShowLoader] = (0, import_react7.useState)(true), { story, height, autoplay, forceInitialArgs, renderStoryToElement } = props;
  (0, import_react7.useEffect)(() => {
    if (!(story && storyRef.current))
      return () => {
      };
    let element = storyRef.current, cleanup = renderStoryToElement(story, element, { autoplay, forceInitialArgs });
...
var Story = (props) => {
  let { inline } = props;
  return import_react7.default.createElement("div", { id: storyBlockIdFromId(props), className: "sb-story" }, inline ? import_react7.default.createElement(InlineStory, { ...props }) : import_react7.default.createElement(IFrameStory, { ...props }));
};
...
var PreviewContainer = emotion_styled_browser_esm_default.div(({ theme, withSource, isExpanded }) => ({ position: "relative", overflow: "hidden", margin: "25px 0 40px", ...getBlockBackgroundStyle(theme), borderBottomLeftRadius: withSource && isExpanded && 0, borderBottomRightRadius: withSource && isExpanded && 0, borderBottomWidth: isExpanded && 0 }), ({ withToolbar }) => withToolbar && { paddingTop: 40 });
...
var Preview2 = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react4.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react4.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react4.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react4.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-JFJC37NM.js");
...
var StyledPreview = emotion_styled_browser_esm_default(Preview2)(() => ({ ".docs-story": { paddingTop: 32, paddingBottom: 40 } }));
...
var ArgJsDoc = ({ tags }) => {
  ...
  return !hasDisplayableParams && !hasDisplayableReturns ? null : import_react11.default.createElement(Table, null, import_react11.default.createElement("tbody", null, hasDisplayableParams && params.map((x) => import_react11.default.createElement("tr", { key: x.name }, import_react11.default.createElement("td", null, import_react11.default.createElement("code", null, x.name), hasDisplayableDeprecated && import_react11.default.createElement("div", null, import_react11.default.createElement("span", null, "Deprecated"), " ", tags.deprecated)), import_react11.default.createElement("td", null, x.description))), hasDisplayableReturns && import_react11.default.createElement("tr", { key: "returns" }, import_react11.default.createElement("td", null, import_react11.default.createElement("code", null, "Returns")), import_react11.default.createElement("td", null, tags.returns.description))));
};
...
var CheckboxControl = ({ name, options, value: value2, onChange, isInline }) => {
  if (!options)
    return logger.warn(`Checkbox with no options: ${name}`), import_react19.default.createElement(import_react19.default.Fragment, null, "-");
...
var RadioControl = ({ name, options, value: value2, onChange, isInline }) => {
  if (!options)
    return logger.warn(`Radio with no options: ${name}`), import_react20.default.createElement(import_react20.default.Fragment, null, "-");
...
var SelectControl = (props) => {
  ...
  return options ? props.isMulti ? import_react21.default.createElement(MultiSelect, { ...props }) : import_react21.default.createElement(SingleSelect, { ...props }) : (logger.warn(`Select with no options: ${name}`), import_react21.default.createElement(import_react21.default.Fragment, null, "-"));
};
...
var RangeControl = ({ name, value: value2, onChange, min = 0, max = 100, step = 1, onBlur, onFocus }) => {
  ...
  return import_react25.default.createElement(RangeWrapper, null, import_react25.default.createElement(RangeLabel, null, min), import_react25.default.createElement(RangeInput, { id: getControlId(name), type: "range", onChange: handleChange, name, value: value2, min, max, step, onFocus, onBlur }), import_react25.default.createElement(RangeLabel, null, `${hasValue ? value2.toFixed(numberOFDecimalsPlaces) : "--"}`, " / ", max));
};
...
var LazyColorControl = (0, import_react14.lazy)(() => import("./Color-3YIJY6X7-UPL56REK.js"));
...
var Subsection = emotion_styled_browser_esm_default.td(({ theme }) => ({ position: "relative", fontWeight: theme.typography.weight.bold, fontSize: theme.typography.size.s2 - 1, background: theme.background.content }));
var StyledTd2 = emotion_styled_browser_esm_default.td(({ theme }) => ({ position: "relative" }));
var StyledTr = emotion_styled_browser_esm_default.tr(({ theme }) => ({ "&:hover > td": { backgroundColor: `${theme.background.hoverable} !important`, boxShadow: `${theme.color.mediumlight} 0 - 1px 0 0 inset`, cursor: "row-resize" } }));
...
var ColorPalette = ({ children, ...props }) => import_react32.default.createElement(ResetWrapper, null, import_react32.default.createElement(List, { ...props, className: "docblock-colorpalette" }, import_react32.default.createElement(ListHeading, null, import_react32.default.createElement(ListName, null, "Name"), import_react32.default.createElement(ListSwatches, null, "Swatches")), children));
...
var IconGallery = ({ children, ...props }) => import_react33.default.createElement(ResetWrapper, null, import_react33.default.createElement(List2, { ...props, className: "docblock-icongallery" }, children));
...
var DocsContext2 = scope ? scope.__DOCS_CONTEXT__ : (0, import_react37.createContext)(null);
var useOf = (moduleExportOrType, validTypes) => {
  let context = (0, import_react36.useContext)(DocsContext2), resolved = context.resolveOf(moduleExportOrType, validTypes);
...
var ArgTypes = (props) => {
  var _a;
  let { of } = props, resolved = useOf(of || "meta"), { argTypes, parameters } = getArgTypesFromResolved(resolved, props), argTypesParameters = ((_a = parameters.docs) == null ? void 0 : _a.argTypes) || {}, include = props.include ?? argTypesParameters.include, exclude = props.exclude ?? argTypesParameters.exclude, sort = props.sort ?? argTypesParameters.sort, filteredArgTypes = filterArgTypes(argTypes, include, exclude);
...
var useArgs = (storyId, context) => {
  ...
  let updateArgs = (0, import_react38.useCallback)((updatedArgs) => context.channel.emit(UPDATE_STORY_ARGS, { storyId, updatedArgs }), [storyId]), resetArgs = (0, import_react38.useCallback)((argNames) => context.channel.emit(RESET_STORY_ARGS, { storyId, argNames }), [storyId]);
...
var extractComponentArgTypes2 = (component, context, include, exclude) => {
...
var addComponentTabs = (tabs, components22, context, include, exclude, sort) => ({ ...tabs, ...(0, import_mapValues2.default)(components22, (comp) => ({ rows: extractComponentArgTypes2(comp, context, include, exclude), sort })) });
var StoryTable = (props) => {
  let context = (0, import_react38.useContext)(DocsContext2), { story: storyName, component, subcomponents, showComponent, include, exclude, sort } = props;
  try {
    let storyId;
    switch (storyName) {
      case PRIMARY_STORY: {
    ...
    let argTypes = filterArgTypes(story.argTypes, include, exclude), mainLabel = getComponentName(component) || "Story", tabs = { [mainLabel]: { rows: argTypes, args, globals, updateArgs, resetArgs } }, storyHasArgsWithControls = argTypes && Object.values(argTypes).find((v) => !!(v == null ? void 0 : v.control));
...
var ComponentsTable = (props) => {
  let context = (0, import_react38.useContext)(DocsContext2), { components: components22, include, exclude, sort } = props, tabs = addComponentTabs({}, components22, context, include, exclude);
  return import_react38.default.createElement(TabbedArgsTable, { tabs, sort });
};
var ArgsTable2 = (props) => {
  ...
  `);
  let context = (0, import_react38.useContext)(DocsContext2), { parameters: { controls }, subcomponents } = context.storyById(), { include, exclude, components: components22, sort: sortProp } = props, { story: storyName } = props, sort = sortProp || (controls == null ? void 0 : controls.sort), main = getComponent(props, context);
  if (storyName)
  ...
  if (!components22 && !subcomponents) {
    let mainProps;
    try {
      mainProps = { rows: extractComponentArgTypes2(main, context, include, exclude) };
    } catch (err) {
  ...
  if (components22)
    return import_react38.default.createElement(ComponentsTable, { ...props, components: components22, sort });
  let mainLabel = getComponentName(main);
  return import_react38.default.createElement(ComponentsTable, { ...props, components: { [mainLabel]: main, ...subcomponents }, sort });
};
...
var getStorySource = (storyId, sourceContext) => {
  ...
  return (sources == null ? void 0 : sources[storyId]) || { code: "" };
};
var getSnippet = (snippet, story, typeFromProps) => {
  var _a, _b;
  let { __isArgsStory: isArgsStory } = story.parameters, sourceParameters = ((_a = story.parameters.docs) == null ? void 0 : _a.source) || {}, type = typeFromProps || sourceParameters.type || SourceType.AUTO;
  ...
  return ((_b = sourceParameters.transformSource) == null ? void 0 : _b.call(sourceParameters, code, story)) || code;
};
var useSourceProps = (props, docsContext, sourceContext) => {
  var _a, _b, _c;
  let storyIds = props.ids || (props.id ? [props.id] : []), storiesFromIds = useStories(storyIds, docsContext);
  if (!storiesFromIds.every(Boolean))
    return { error: "Oh no! The source is not available.", state: "none" };
  let stories = storiesFromIds;
  if (props.of)
    stories = [docsContext.resolveOf(props.of, ["story"]).story];
  ...
  code || (code = stories.map((story, index) => {
    var _a2, _b2;
    let source = getStorySource(story.id, sourceContext);
    return index === 0 && (format2 = source.format ?? ((_b2 = (_a2 = story.parameters.docs) == null ? void 0 : _a2.source) == null ? void 0 : _b2.format) ?? false), getSnippet(source.code, story, props.type);
  }).join(`
...
var Source2 = (props) => {
  props.id && deprecate(esm_default`The \`id\` prop on Source is deprecated, please use the \`of\` prop instead to reference a story. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#source-block
  `), props.ids && deprecate(esm_default`The \`ids\` prop on Source is deprecated, please use the \`of\` prop instead to reference a story. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#source-block
  `);
  let sourceContext = (0, import_react42.useContext)(SourceContext), docsContext = (0, import_react42.useContext)(DocsContext2), { state, ...sourceProps } = useSourceProps(props, docsContext, sourceContext);
  return import_react42.default.createElement(Source, { ...sourceProps });
};
var getStoryId2 = (props, context) => {
  let { id, of, meta, story } = props;
  if (id)
    return deprecate(esm_default`Referencing stories by \`id\` is deprecated, please use \`of\` instead. 
    
      Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#story-block'`), id;
  let { name } = props;
  return name ? (deprecate(esm_default`Referencing stories by \`name\` is deprecated, please use \`of\` instead. 
    
      Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#story-block'`), context.storyIdByName(name)) : (story && deprecate(esm_default`The \`story\` prop is deprecated, please export your stories from CSF files and reference them with \`of={}\`.
...
var getStoryProps = (props, story, context) => {
  ...
  typeof inlineStories < "u" && deprecate(esm_default`The \`docs.inlineStories\` parameter is deprecated, use \`docs.story.inline\` instead. 
    
      Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#autodocs-changes'
    `);
  let inline = props.inline ?? storyParameters.inline ?? inlineStories ?? false;
  if (typeof iframeHeight < "u" && deprecate(esm_default`The \`docs.iframeHeight\` parameter is deprecated, use \`docs.story.iframeHeight\` instead. 
...
var Story2 = (props = { __forceInitialArgs: false, __primary: false }) => {
  let context = (0, import_react43.useContext)(DocsContext2), storyId = getStoryId2(props, context), story = useStory(storyId, context);
  if (!story)
    return import_react43.default.createElement(StorySkeleton, null);
  let storyProps = getStoryProps(props, story, context);
  return storyProps ? import_react43.default.createElement(Story, { ...storyProps }) : null;
};
...
var Canvas = (props) => {
  ...
  let docsContext = (0, import_react40.useContext)(DocsContext2), sourceContext = (0, import_react40.useContext)(SourceContext), { children, of, source } = props, { isLoading, previewProps } = useDeprecatedPreviewProps(props, docsContext, sourceContext), story, sourceProps, hookError;
  try {
  ...
  if (hookError)
    throw hookError;
  if (props.withSource && deprecate(esm_default`Setting source state with \`withSource\` is deprecated, please use \`sourceState\` with 'hidden', 'shown' or 'none' instead. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
    `), props.mdxSource && deprecate(esm_default`Setting source code with \`mdxSource\` is deprecated, please use source={{code: '...'}} instead. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
    `), (props.isColumn !== void 0 || props.columns !== void 0) && deprecate(esm_default`\`isColumn\` and \`columns\` props are deprecated as the Canvas block now only supports showing a single story. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
    `), children)
    return deprecate(esm_default`Passing children to Canvas is deprecated, please use the \`of\` prop instead to reference a story. 
    
    Please refer to the migration guide: https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#canvas-block
  `), isLoading ? import_react40.default.createElement(PreviewSkeleton, null) : import_react40.default.createElement(Preview2, { ...previewProps }, children);
  ...
  return import_react40.default.createElement(Preview2, { withSource: sourceState === "none" ? void 0 : sourceProps, isExpanded: sourceState === "shown", withToolbar, additionalActions, className, layout }, import_react40.default.createElement(Story2, { of: of || story.moduleExport, meta: props.meta, ...props.story }));
};
var useArgs2 = (story, context) => {
  let storyContext = context.getStoryContext(story), { id: storyId } = story, [args, setArgs] = (0, import_react44.useState)(storyContext.args);
  ...
  let updateArgs = (0, import_react44.useCallback)((updatedArgs) => context.channel.emit(UPDATE_STORY_ARGS, { storyId, updatedArgs }), [storyId, context.channel]), resetArgs = (0, import_react44.useCallback)((argNames) => context.channel.emit(RESET_STORY_ARGS, { storyId, argNames }), [storyId, context.channel]);
  return [args, updateArgs, resetArgs];
};
var useGlobals2 = (story, context) => {
  let storyContext = context.getStoryContext(story), [globals, setGlobals] = (0, import_react44.useState)(storyContext.globals);
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = import_react47.default.useContext(DocsContext2);
  return import_react47.default.createElement(DocsContext2.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({ className, children, ...rest }) => {
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react47.default.createElement(Code, null, children);
  let language = className && className.split("-");
  return import_react47.default.createElement(Source, { language: language && language[1] || "plaintext", format: false, code: children, ...rest });
};
...
var AnchorInPage = ({ hash, children }) => {
  let context = (0, import_react47.useContext)(DocsContext2);
  return import_react47.default.createElement(A, { href: hash, target: "_self", onClick: (event) => {
    let id = hash.substring(1);
    document2.getElementById(id) && navigate(context, hash);
  } }, children);
};
var AnchorMdx = (props) => {
  let { href, target, children, ...rest } = props, context = (0, import_react47.useContext)(DocsContext2);
  if (href) {
    if (href.startsWith("#"))
      return import_react47.default.createElement(AnchorInPage, { hash: href }, children);
    if (target !== "_blank" && !href.startsWith("https://"))
      return import_react47.default.createElement(A, { href, onClick: (event) => {
        event.preventDefault(), navigate(context, event.currentTarget.getAttribute("href"));
      }, target, ...rest }, children);
  }
  return import_react47.default.createElement(A, { ...props });
};
var SUPPORTED_MDX_HEADERS = ["h1", "h2", "h3", "h4", "h5", "h6"];
var OcticonHeaders = SUPPORTED_MDX_HEADERS.reduce((acc, headerType) => ({ ...acc, [headerType]: emotion_styled_browser_esm_default(headerType)({ "& svg": { visibility: "hidden" }, "&:hover svg": { visibility: "visible" } }) }), {});
var OcticonAnchor = emotion_styled_browser_esm_default.a(() => ({ float: "left", paddingRight: "4px", marginLeft: "-20px", color: "inherit" }));
var HeaderWithOcticonAnchor = ({ as, id, children, ...rest }) => {
  let context = (0, import_react47.useContext)(DocsContext2), OcticonHeader = OcticonHeaders[as], hash = `#${id}`;
  return import_react47.default.createElement(OcticonHeader, { id, ...rest }, import_react47.default.createElement(OcticonAnchor, { "aria-hidden": "true", href: hash, tabIndex: -1, target: "_self", onClick: (event) => {
    document2.getElementById(id) && navigate(context, hash);
  } }, import_react47.default.createElement("svg", { viewBox: "0 0 16 16", version: "1.1", width: "16", height: "16", "aria-hidden": "true", fill: "currentColor" }, import_react47.default.createElement("path", { fillRule: "evenodd", d: "M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z" }))), children);
};
var HeaderMdx = (props) => {
  let { as, id, children, ...rest } = props;
  if (id)
    return import_react47.default.createElement(HeaderWithOcticonAnchor, { as, id, ...rest }, children);
  let Component4 = as, { as: omittedAs, ...withoutAs } = props;
  return import_react47.default.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce((acc, headerType) => ({ ...acc, [headerType]: (props) => import_react47.default.createElement(HeaderMdx, { as: headerType, ...props }) }), {});
var Markdown2 = (props) => {
  var _a;
  if (!props.children)
    return null;
  if (typeof props.children != "string")
    throw new Error(esm_default`The Markdown block only accepts children as a single string, but children were of type: '${typeof props.children}'
      ...
      `);
  return import_react46.default.createElement(index_modern_default, { ...props, options: { forceBlock: true, overrides: { code: CodeOrSourceMdx, a: AnchorMdx, ...HeadersMdx, ...(_a = props == null ? void 0 : props.options) == null ? void 0 : _a.overrides }, ...props == null ? void 0 : props.options } });
};
...
var DescriptionContainer = (props) => {
  let { of, type, markdown: markdownProp, children } = props, context = (0, import_react45.useContext)(DocsContext2), resolvedOf = useOf(of || "meta"), markdown;
  return type || markdownProp || children ? markdown = getDescriptionFromDeprecatedProps(props, context) : markdown = getDescriptionFromResolvedOf(resolvedOf), type && deprecate(`Manually specifying description type is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), markdownProp && deprecate(`The 'markdown' prop on the Description block is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), children && deprecate(`The 'children' prop on the Description block is deprecated. See ${DEPRECATION_MIGRATION_LINK}`), markdown ? import_react45.default.createElement(Markdown2, null, markdown) : null;
};
var { document: document3, window: globalWindow3 } = scope;
var DocsContainer = ({ context, theme, children }) => ((0, import_react49.useEffect)(() => {
  let url;
  try {
...
}), import_react49.default.createElement(DocsContext2.Provider, { value: context }, import_react49.default.createElement(SourceContainer, { channel: context.channel }, import_react49.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react49.default.createElement(DocsWrapper, { className: "sbdocs sbdocs-wrapper" }, import_react49.default.createElement(DocsContent, { className: "sbdocs sbdocs-content" }, children))))));
...
var Title2 = ({ children }) => {
  let context = (0, import_react51.useContext)(DocsContext2), text = children;
  return text || (text = extractTitle(context.storyById().title)), text ? import_react51.default.createElement(Title, { className: "sbdocs-title" }, text) : null;
};
var Subtitle2 = ({ children }) => {
  let docsContext = (0, import_react52.useContext)(DocsContext2), { parameters } = docsContext.storyById(), text = children;
  return text || (text = parameters == null ? void 0 : parameters.componentSubtitle), text ? import_react52.default.createElement(Subtitle, { className: "sbdocs-subtitle" }, text) : null;
};
var Subheading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react55.default.createElement(H3, null, children);
  let tagID = children.toLowerCase().replace(/[^a-z0-9]/gi, "-");
  return import_react55.default.createElement(HeaderMdx, { as: "h3", id: tagID }, children);
};
var DocsStory = ({ of, expanded = true, withToolbar: withToolbarProp = false, __forceInitialArgs = false, __primary = false }) => {
  ...
  return import_react54.default.createElement(Anchor, { storyId: story.id }, expanded && import_react54.default.createElement(import_react54.default.Fragment, null, import_react54.default.createElement(Subheading, null, story.name), import_react54.default.createElement(DescriptionContainer, { of })), import_react54.default.createElement(Canvas, { of, withToolbar, story: { __forceInitialArgs, __primary } }));
};
var Primary = ({ name }) => {
  let docsContext = (0, import_react53.useContext)(DocsContext2);
  name && deprecate(esm_default`\`name\` prop is deprecated on the Primary block.
    The Primary block should only be used to render the primary story, which is automatically found.
    `);
  let storyId = name && docsContext.storyIdByName(name), story = docsContext.storyById(storyId);
  return story ? import_react53.default.createElement(DocsStory, { of: story.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
var Heading = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react57.default.createElement(H2, null, children);
  let tagID = children.toLowerCase().replace(/[^a-z0-9]/gi, "-");
  return import_react57.default.createElement(HeaderMdx, { as: "h2", id: tagID }, children);
};
var Stories = ({ title, includePrimary = true }) => {
  let { componentStories } = (0, import_react56.useContext)(DocsContext2), stories = componentStories().filter((story) => {
    var _a, _b;
    return !((_b = (_a = story.parameters) == null ? void 0 : _a.docs) == null ? void 0 : _b.disable);
  });
  return includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : import_react56.default.createElement(import_react56.default.Fragment, null, import_react56.default.createElement(Heading, null, title), stories.map((story) => story && import_react56.default.createElement(DocsStory, { key: story.id, of: story.moduleExport, expanded: true, __forceInitialArgs: true })));
};
Stories.defaultProps = { title: "Stories" };
var DocsPage = () => import_react50.default.createElement(import_react50.default.Fragment, null, import_react50.default.createElement(Title2, null), import_react50.default.createElement(Subtitle2, null), import_react50.default.createElement(DescriptionContainer, null), import_react50.default.createElement(Primary, null), import_react50.default.createElement(Controls3, null), import_react50.default.createElement(Stories, null));
var Docs = ({ docsParameter, context }) => {
  let Container = docsParameter.container || DocsContainer, Page = docsParameter.page || DocsPage;
  return import_react48.default.createElement(Container, { context, theme: docsParameter.theme }, import_react48.default.createElement(Page, null));
};
...
var ExternalPreview = class extends Preview {
  constructor(projectAnnotations) {
    ...
    this.initialize({ getStoryIndex: () => this.storyIndex, importFn: (path) => Promise.resolve(this.moduleExportsByImportPath[path]), getProjectAnnotations: () => composeConfigs([{ parameters: { docs: { story: { inline: true } } } }, this.projectAnnotations]) });
  }
};
function usePreview(projectAnnotations) {
  let previewRef = (0, import_react58.useRef)();
...
var ExternalDocs = ({ projectAnnotationsList, children }) => {
  var _a;
  let projectAnnotations = composeConfigs(projectAnnotationsList), preview2 = usePreview(projectAnnotations), docsParameter = { ...(_a = projectAnnotations.parameters) == null ? void 0 : _a.docs, page: () => children };
  return import_react58.default.createElement(Docs, { docsParameter, context: preview2.docsContext() });
};
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react59.default.createElement(DocsContext2.Provider, { value: preview.docsContext() }, import_react59.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = (0, import_react60.useContext)(DocsContext2);
  of && context.referenceMeta(of, true);
  try {
    let primary = context.storyById();
    return import_react60.default.createElement(Anchor, { storyId: primary.id });
  } catch {
    return null;
  }
};
var Unstyled = (props) => import_react61.default.createElement("div", { ...props, className: "sb-unstyled" });
var Wrapper8 = ({ children }) => import_react62.default.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
...
var DocsRenderer = class {
  constructor() {
    this.render = (context, docsParameter, element, callback) => {
      ...
      import("./react-M4MYXMUD.js").then(({ MDXProvider }) => {
        import_react_dom.default.render(import_react63.default.createElement(MDXProvider, { components }, import_react63.default.createElement(Docs, { key: Math.random(), context, docsParameter })), element, callback);
      });
