...
<Canvas layout='centered' withToolbar={true} of={ButtonStories.Base} />
<Controls/>
...
<DocsStory withToolbar={true} of={ButtonStories.Variants} />
...
<DocsStory of={ButtonStories.Destructive} />
